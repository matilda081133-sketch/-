...
export const metadata: Metadata = {
  ...
  description: 'Примеры дел специалистов ЮК «Де-Юре»: исходные ситуации, работа юристов и полученные результаты. Кейсы обезличены с соблюдением конфиденциальности. 📞 +7 (4742) 20-15-25.',
  alternates: {

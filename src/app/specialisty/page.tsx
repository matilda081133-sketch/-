...
const specialistListDescriptions: Record<string, string> = {
  'bobkin-arkadiy-evgenevich': 'Более 22 лет работал в следственных подразделениях налоговой полиции\nи МВД, в том числе следователем по особо важным делам и руководителем\nследственной части. В «Де-Юре» определяет стратегию ведения сложных\nуголовных и налоговых дел и контролирует работу команды.',
...
const specialistAreas: Record<string, { name: string; href?: string }[]> = {
  ...
  'konopkin-dmitriy-sergeevich': [
    ...
    { name: 'Уголовное право', href: '/grazhdanam/advokat-po-ugolovnym-delam/' },
    { name: 'Автомобильные споры', href: '/grazhdanam/avtoyurist/' }
  ],

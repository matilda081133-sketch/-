...
export default function VnesudebnoeBankrotstvoMfcClient() {
  ...
  const faqs = [
    ...
    {
      q: 'Что делать, если сумма долга превышает 1 000 000 рублей?',
      a: 'Нет, если общий размер учитываемых обязательств превышает установленный законом лимит в 1 000 000 ₽. В этой ситуации нужно оценить судебное банкротство, переговоры с кредиторами либо другой законный маршрут.'
    },
    {
      q: 'Нужен ли юрист для банкротства через МФЦ?',
      a: 'Закон разрешает подать заявление самостоятельно. Юрист нужен, чтобы подтвердить право на процедуру, восстановить полный список кредиторов, правильно определить суммы долгов и подготовить документы без ошибок, из-за которых МФЦ может вернуть заявление или часть задолженности останется несписанной.'
    }
  ];
  ...
  const steps: ProcessStep[] = [
    ...
    },
    {
      ...
      desc: 'Проверяем публикацию сведений о начале процедуры в ЕФРСБ. Если заявление возвращено, устанавливаем причину, исправляем документы и готовим повторную подачу.'
    },
    {
      num: '07',
  ...
  return (
    <main>
          ...
          <div className="grid grid-4" style={{ gap: '20px', position: 'relative', marginBottom: '40px' }}>
            {[
              ...
              },
              {
                ...
                desc: 'Проверяем имущество, доходы и сделки, чтобы устранить возможные препятствия до подачи заявления и снизить риск прекращения процедуры по требованию кредитора.'
              },
              {
                num: '07',
              ...
              },
              {
                ...
                desc: 'Готовим заявление, полный список кредиторов и комплект документов для принятия обращения МФЦ. Объясняем порядок подачи и дальнейшие действия клиента.'
              }
            ].map((item, idx) => (
      ...
      <ProcessBlock
        ...
        ctaSubtitle="После начала процедуры приостанавливается взыскание указанных в заявлении долгов и прекращается начисление процентов и штрафов по ним. Если основания для прекращения процедуры не возникнут, через шесть месяцев эти обязательства будут списаны в установленном законом объёме."
      ...
      <SpecialistBlock
        ...
        description={[
          <span key="1" style={{ color: 'var(--color-deep-blue)', display: 'block' }}>
            Владимир Начешников проверяет право клиента на внесудебное банкротство, восстанавливает полный список кредиторов и готовит документы для принятия заявления МФЦ. Сопровождает процедуру до прекращения указанных долгов либо предлагает судебный маршрут, если условия МФЦ не соблюдаются.
          </span>,
          <ul key="2" style={{ listStyle: 'none', padding: 0, margin: '16px 0 0 0', display: 'flex', flexDirection: 'column', gap: '12px' }}>
            <li style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', fontSize: '15px', color: 'var(--color-deep-blue)', lineHeight: 1.55 }}>
              ...
              <span>
                Проверяет законное основание для банкротства через МФЦ.
              </span>
            </li>
            <li style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', fontSize: '15px', color: 'var(--color-deep-blue)', lineHeight: 1.55 }}>
              <div style={{ width: '6px', height: '6px', minWidth: '6px', background: 'var(--color-gold)', borderRadius: '50%', flexShrink: 0, marginTop: '8px' }}></div>
              <span>
                Находит кредиторов, правопреемников и актуальные суммы задолженности.
              </span>
            </li>
            <li style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', fontSize: '15px', color: 'var(--color-deep-blue)', lineHeight: 1.55 }}>
              <div style={{ width: '6px', height: '6px', minWidth: '6px', background: 'var(--color-gold)', borderRadius: '50%', flexShrink: 0, marginTop: '8px' }}></div>
              <span>
                Готовит заявление и список кредиторов без пропусков и ошибок.
              </span>
            </li>
            <li style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', fontSize: '15px', color: 'var(--color-deep-blue)', lineHeight: 1.55 }}>
              <div style={{ width: '6px', height: '6px', minWidth: '6px', background: 'var(--color-gold)', borderRadius: '50%', flexShrink: 0, marginTop: '8px' }}></div>
              <span>
                Контролирует возбуждение и завершение процедуры.
              </span>
            </li>
          </ul>,

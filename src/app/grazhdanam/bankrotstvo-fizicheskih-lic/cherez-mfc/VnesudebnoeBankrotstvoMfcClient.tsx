...
export default function VnesudebnoeBankrotstvoMfcClient() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'Если общий размер обязательств превышает 1 000 000 рублей, внесудебный порядок через МФЦ применить нельзя. В этом случае списание долгов возможно только в рамках судебного банкротства гражданина в арбитражном суде. Мы оцениваем состав задолженности, риски оспаривания сделок и подбираем оптимальный вариант судебной процедуры.'
    },
    {
      q: 'Нужен ли юрист для банкротства через МФЦ?',
      a: 'Подать заявление в МФЦ можно самостоятельно, однако ошибка в списке кредиторов, сумме долга или квалификации исполнительных производств может привести к возврату документов или переносу процедуры в суд по инициативе кредиторов. Юрист помогает правильно сформировать реестр, исключить риски оспаривания и защитить интересы должника на всех этапах.'
    }
  ];

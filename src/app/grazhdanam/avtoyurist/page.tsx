...
export const metadata: Metadata = {
  ...
  description: 'Помощь автоюриста в Липецке: ДТП, лишение водительских прав, споры по ОСАГО и КАСКО, взыскание ущерба и оспаривание вины. Разберём документы и предложим порядок действий. 📞 +7 (4742) 20-15-25.',
  alternates: {
    canonical: 'https://dejure-help.ru/grazhdanam/avtoyurist/',
  },
  openGraph: {
    title: 'Автоюрист в Липецке — помощь при ДТП и спорах со страховой | Де-Юре',
    description: 'Юридическая помощь после ДТП, при риске лишения прав и в спорах со страховыми компаниями в Липецке. 📞 +7 (4742) 20-15-25.',
  ...
  const jsonLd = {
    ...
    '@graph': [
      ...
      },
      {
        ...
        description: 'Комплексная защита прав автовладельцев: ДТП, лишение прав, споры со страховыми по ОСАГО и КАСКО, взыскание ущерба с виновников аварии. 📞 +7 (4742) 20-15-25.',
        url: 'https://dejure-help.ru/grazhdanam/avtoyurist/',
        provider: {
          '@id': 'https://dejure-help.ru/#organization'
        },

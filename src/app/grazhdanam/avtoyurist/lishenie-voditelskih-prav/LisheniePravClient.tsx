              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                <li style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                  ...
                  <div>
                    ...
                    <span style={{ fontSize: '13.5px', color: 'var(--color-text-secondary)', lineHeight: 1.5 }}>
                      Записи регистратора, камер навигатора, данные свидетелей и медицинские документы могут быстро стереться.
                    </span>
                  </div>
                </li>
                <li style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <li style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                  ...
                  <div>
                    ...
                    <span style={{ fontSize: '13.5px', color: 'var(--color-text-secondary)', lineHeight: 1.5 }}>
                      Признание вины в протоколе исключает многие доводы защиты. Важно сначала проверить состав и процедуру.
                    </span>
                  </div>
                </li>
                <li style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                ...
                <li style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                  ...
                  <div>
                    ...
                    <span style={{ fontSize: '13.5px', color: 'var(--color-text-secondary)', lineHeight: 1.5 }}>
                      Срок на обжалование постановления — ровно 10 суток с даты вручения. Восстановить пропущенный срок крайне сложно.
                    </span>
                  </div>
                </li>
                <li style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>

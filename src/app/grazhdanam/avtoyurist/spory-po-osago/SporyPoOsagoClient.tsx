  ...
  const relatedServices = [
    {
      ...
      desc: 'Защита при отказе, недоплате, споре по ремонту, угону или полной гибели автомобиля.',
      link: '/grazhdanam/avtoyurist/spory-po-kasko/'
    },
    {
      title: 'Взыскание с виновника ДТП',
      desc: 'Взыскание ущерба сверх страхового лимита ОСАГО или при отсутствии полиса.',

...
export default function OstavlenieMestaDtpClient() {
  ...
  return (
    <main>
        ...
        items={[
          {
            ...
            period: 'разово',
            description: 'Изучение протокола, видеозаписей, схемы и объяснений, правовая квалификация и оценка перспектив.',
            features: [
              'Анализ события ДТП и признаков умысла',
          ...
          },
          {
            ...
            price: 'По согласованию',
            period: 'за стадию',
            description: 'Полное ведение дела: подготовка ходатайств, сбор доказательств, участие в заседаниях.',
            features: [
              'Подготовка правовой позиции и возражений',
              'Истребование видеозаписей и допрос свидетелей',
              'Личное участие адвоката в судебных заседаниях'
            ],
          ...
          },
          {
            ...
            price: 'По согласованию',
            period: 'за инстанцию',
            description: 'Подготовка апелляционной или надзорной жалобы и представление интересов в вышестоящем суде.',
            features: [
              'Анализ мотивировки постановления суда',
              'Составление обоснованной жалобы со ссылками на ВС РФ',
              'Участие в рассмотрении жалобы вышестоящим судом'
            ],
      ...
      <ContactsForm
        superTitle="Связаться с адвокатом"
        ...
        disclaimer="Перезвоним в течение 15 минут в рабочее время. Вечером или в выходной — в ближайший рабочий день."
      />

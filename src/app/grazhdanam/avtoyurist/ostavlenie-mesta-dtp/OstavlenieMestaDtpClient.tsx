...
export default function OstavlenieMestaDtpClient() {
  ...
  return (
    <main>
      ...
      <MilitaryHero
        ...
        primaryCtaSubtext={
          <>
            ...
            <span style={{ display: 'inline-block' }}>записи камер могут храниться ограниченное время. Звоните: <a href="tel:+74742201525" data-analytics="phone_click">+7 (4742) 20-15-25</a></span>
          </>
        }
        trustItems={[
      ...
      {/* ═══ БЛОК 2: НЕ ТЕРЯЙТЕ ДОКАЗАТЕЛЬСТВА И НЕ ФОРМИРУЙТЕ ВЕРСИЮ НАУГАД (ШАБЛОН «СИТУАЦИИ») ═══ */}
        ...
        <div className="container">
          <div style={{ maxWidth: '780px', marginBottom: '48px', textAlign: 'left' }}>
            ...
            <p style={{ fontSize: '16px', color: 'var(--color-text-secondary)', fontWeight: 400, lineHeight: 1.6, margin: 0, textAlign: 'left', textWrap: 'balance' }}>
              Правильная фиксация документов и отказ от поспешных шагов сохраняют доказательственную базу для успешной правовой защиты в ГИБДД и суде.
            </p>
          </div>
          ...
          <div className="grid grid-3" style={{ gap: '28px', marginBottom: '32px' }}>
            {[
              ...
              },
              {
                ...
                btnText: 'Сохранить записи'
              },
              {
                tag: 'Процессуальный статус',
                title: 'Уточните факт вызова в отдел ГИБДД',
                ...
                btnText: 'Уточнить статус'
              },
              {
                tag: 'Подписание документов',
                title: 'Не подписывайте незаполненные бланки',
                ...
                btnText: 'Защитить права'
              },
              {
                tag: 'Консультация',
                title: 'Обсудите факты с профильным адвокатом',
                ...
                btnText: 'Согласовать позицию'
              },
              {
                tag: 'Особые ситуации',
                title: 'Учтите специфику дорожного происшествия',
          ...
          <div style={{
            ...
            <div className="grid grid-4" style={{ gap: '16px', position: 'relative', zIndex: 1 }}>
              ...
              <div style={{ background: 'rgba(255, 255, 255, 0.05)', border: '1px solid rgba(255, 255, 255, 0.1)', padding: '22px 20px', display: 'flex', flexDirection: 'column', gap: '10px' }}>
                ...
                <p style={{ fontSize: '13.5px', color: 'rgba(255, 255, 255, 0.75)', lineHeight: 1.5, margin: 0 }}>
                  Осознавал ли водитель, что стал участником ДТП, и понимал ли, что покидает место происшествия вопреки установленному порядку. Умысел должен подтверждаться совокупностью доказательств.
                </p>
              </div>
            </div>
          </div>

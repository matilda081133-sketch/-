...
export default function AdvokatEkonomicheskieClient() {
  ...
  const faqItems = [
  {
    "q": "Могут ли заключить под стражу по экономическому преступлению?",
    "a": "Для ряда экономических преступлений, совершённых в связи с предпринимательской или иной экономической деятельностью, часть 1.1 статьи 108 УПК РФ ограничивает применение заключения под стражу. Это не безусловный запрет: суд проверяет квалификацию, характер деятельности и наличие предусмотренных законом исключений. Конкретный риск меры пресечения оценивается по материалам дела."
  },
  {
  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "description": "Защитим собственника, руководителя, бухгалтера или другого участника бизнеса при проверке, обыске, допросе, расследовании и в суде. Разберём документы, операции, деловую цель, полномочия и доказательства умысла. Цель защиты — исключить необоснованное уголовное преследование, сохранить активы и добиться наиболее благоприятного решения по делу.",
      ...
      <MilitaryHero
        ...
        subtitle={
          <span style={{ display: 'inline-block', maxWidth: '750px', textWrap: 'balance' }}>
            Защитим собственника, руководителя, бухгалтера или другого участника бизнеса при проверке, обыске, допросе, расследовании и в суде. Разберём документы, операции, деловую цель, полномочия и доказательства умысла. Цель защиты — исключить необоснованное уголовное преследование, сохранить активы и добиться наиболее благоприятного решения по делу.
          </span>
        }

      ...
      <MilitaryHero
        ...
        subtitle={
          <span style={{ display: 'inline-block', maxWidth: '750px', textWrap: 'balance' }}>
            Защитим водителя или представим пострадавшего при ДТП с тяжким вредом здоровью либо гибелью людей. Подключимся на стадии проверки, следствия или суда, проверим нарушение ПДД, причинную связь, экспертизы и доказательства.
          </span>
        }

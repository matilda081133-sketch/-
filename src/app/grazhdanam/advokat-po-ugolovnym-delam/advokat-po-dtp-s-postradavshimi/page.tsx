...
export const metadata: Metadata = {
  ...
  description: 'Защита водителей и представительство потерпевших по ст. 264 УК РФ при ДТП с тяжким вредом здоровью или погибшими в Липецке. Экспертизы, автотехника, суд. 📞 +7 (4742) 20-15-25.',
  alternates: {

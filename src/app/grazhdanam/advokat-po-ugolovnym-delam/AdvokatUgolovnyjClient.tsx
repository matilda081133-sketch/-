    ...
    <div style={{ backgroundColor: 'var(--color-cream)', minHeight: '100vh' }}>
      ...
      <main id="main-content">
        ...
        <MilitaryHero
          ...
          primaryCtaLink="#form"
          primaryCtaAnalytics="click_criminal_hub_hero_cta"
          primaryCtaSubtext={
            <span style={{ display: 'block' }}>
        ...
        <section className="section bg-light" style={{ padding: '80px 0', background: 'var(--gradient-cream)', borderTop: '1px solid var(--color-border)' }}>
          <div className="container">
            <div style={{ maxWidth: '780px', marginBottom: '48px', textAlign: 'left' }}>
              <h2 className="with-accent" style={{ fontFamily: 'var(--font-serif)', fontSize: 'clamp(28px, 4vw, 42px)', color: 'var(--color-deep-blue)', marginBottom: '16px', marginTop: 0, lineHeight: 1.2, textAlign: 'left' }}>
                <span className="hero-title-span-mobile" style={{ display: 'block', whiteSpace: 'nowrap' }}>Помощь зависит</span>{' '}
                <span className="hero-title-span-mobile" style={{ display: 'block', whiteSpace: 'nowrap' }}>не только от статьи,</span>{' '}
            ...
            <div className="grid grid-3" style={{ gap: '24px' }}>
              {statuses.map((st, idx) => (
                ...
                >
                  <div style={{ display: 'inline-block', backgroundColor: 'rgba(23, 55, 94, 0.08)', color: 'var(--color-deep-blue)', padding: '4px 10px', fontSize: '12px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: '14px' }}>
                    {st.role}
                  </div>
        ...
        <section id="services" className="section bg-light" style={{ padding: '80px 0', background: 'var(--gradient-cream)' }}>
          <div className="container">
            ...
            <div className="grid grid-3" style={{ gap: '28px' }}>
              ...
              {/* 11-я карточка в сетке: Не нашли свою ситуацию */}
              <div 
                className="card service-card hover-lift" 
                style={{ 
                  height: '100%', 
        ...
        <section className="section bg-white" style={{ padding: '80px 0', borderBottom: '1px solid var(--color-border)' }}>
          <div className="container">
            <div style={{ maxWidth: '780px', marginBottom: '48px', textAlign: 'left' }}>
              <h2 className="with-accent" style={{ fontFamily: 'var(--font-serif)', fontSize: 'clamp(28px, 4vw, 42px)', color: 'var(--color-deep-blue)', marginBottom: '16px', marginTop: 0, lineHeight: 1.2, textAlign: 'left' }}>
                <span className="hero-title-span-mobile" style={{ display: 'block', whiteSpace: 'nowrap' }}>Подключаемся на любой стадии —</span>{' '}
                <span className="hero-title-span-mobile" style={{ display: 'block', whiteSpace: 'nowrap' }}>задачи на каждом этапе</span>{' '}
                <span className="hero-title-span-mobile" style={{ display: 'block', whiteSpace: 'nowrap' }}>существенно различаются</span>
              </h2>
            </div>
        ...
        <ProcessBlock
          title="Как строится работа по уголовному делу"
        ...
        {/* 11. Стоимость услуг */}
        <PricingBlock
          title="Стоимость помощи по уголовным делам"

...
export const metadata: Metadata = {
  ...
  description: 'Помощь адвоката по уголовным делам в Липецке: проверка, задержание, обыск, допрос, следствие, суд, обжалование, УДО и защита потерпевших. Изучим ситуацию и определим стратегию. 📞 +7 (4742) 20-15-25.',
  alternates: {
    canonical: 'https://dejure-help.ru/grazhdanam/advokat-po-ugolovnym-delam/',
  },
  openGraph: {
    title: 'Адвокат по уголовным делам в Липецке | Де-Юре',
    description: 'Защита подозреваемых и обвиняемых, помощь свидетелям и потерпевшим на всех стадиях уголовного дела. 📞 +7 (4742) 20-15-25.',

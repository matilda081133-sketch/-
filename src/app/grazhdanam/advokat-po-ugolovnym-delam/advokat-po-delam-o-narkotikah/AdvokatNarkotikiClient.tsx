...
export default function AdvokatNarkotikiClient() {
  ...
  },
  {
    ...
    "a": "Закон допускает назначение условного осуждения (ст. 73 УК РФ) по нетяжким частям ст. 228 УК РФ при наличии совокупности смягчающих обстоятельств и данных о личности. По делам о сбыте (ст. 228.1 УК РФ) назначение наказания, не связанного с лишением свободы, возможно только в исключительных случаях при наличии оснований по статье 64 УК РФ. Адвокат законными способами добивается установления всех обстоятельств, влияющих на смягчение наказания, но гарантировать условный срок закон запрещает."
  }
];

...
export default function AdvokatNarkotikiClient() {
  ...
  },
  {
    ...
    "a": "По ст. 228 ч. 1 и ч. 2 УК РФ при грамотной защите и наличии смягчающих обстоятельств условное осуждение (ст. 73 УК РФ) применяется достаточно часто. По тяжким частям ст. 228.1 УК РФ условный срок возможен только через ст. 64 УК РФ."
  }
];

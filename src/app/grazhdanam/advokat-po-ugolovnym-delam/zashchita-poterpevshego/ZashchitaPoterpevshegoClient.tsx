...
export default function ZashchitaPoterpevshegoClient() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      a: "Да. Согласно статье 131 УПК РФ, суммы, выплаченные потерпевшему на покрытие расходов, связанных с выплатой вознаграждения его представителю, относятся к процессуальным издержкам и по приговору суда взыскиваются с осужденного."
    },
    {
    ...
    <main>
      ...
      <MilitaryHero
        ...
        trustItems={[
          ...
          { text: 'Представительство по соглашению ведут профильные адвокаты Дмитрий Конопкин и Олег Гусев' },
          ...
          <div style={{ marginTop: '56px', marginBottom: '48px' }}>
            <div style={{ maxWidth: '840px', marginBottom: '28px' }}>
              ...
              <p style={{ fontSize: '16px', color: 'var(--color-text-secondary)', margin: 0, lineHeight: 1.6 }}>
                Представитель обеспечивает соблюдение прав потерпевшего, не допускает волокиты, контролирует фиксацию вреда и закладывает основу для гарантированного возмещения ущерба.
              </p>
            </div>
      ...
      <SpecialistBlock
        ...
        description={[
          ...
          <p key="adv" style={{ color: 'var(--color-text-secondary)', margin: '14px 0 0 0', fontSize: '14.5px', lineHeight: 1.6 }}>
            Представительство потерпевших на следствии и в суде по соглашению ведут адвокаты Дмитрий Конопкин и Олег Гусев, обеспечивая квалифицированное участие во всех процессуальных действиях.
          </p>
        ]}
          ...
          <div className="grid grid-2" style={{ gap: '60px', alignItems: 'stretch' }}>
            <div style={{ display: 'flex', flexDirection: 'column', height: '100%', justifyContent: 'flex-start' }}>
              ...
              <p style={{ color: 'var(--color-deep-blue)', opacity: 0.9, fontWeight: 500, fontSize: '16px', lineHeight: 1.6, marginBottom: '24px', textWrap: 'balance' }}>
                Укажите, кому нужна помощь (вам, ребёнку, родственнику), орган расследования, текущий статус и ближайшее процессуальное действие. Обращение передадим Аркадию Евгеньевичу Бобкину для первичного правового анализа.
              </p>

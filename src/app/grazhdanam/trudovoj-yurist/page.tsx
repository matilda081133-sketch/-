...
export const metadata: Metadata = {
  ...
  description: 'Помощь трудового юриста в Липецке для работников: незаконное увольнение, сокращение, невыплата зарплаты, производственные травмы. Защита в суде. 📞 +7 (4742) 20-15-25.',
  alternates: {

...
export const metadata: Metadata = {
  ...
  description: 'Помощь юриста при незаконном сокращении штата в Липецке: проверка процедуры, преимущественное право, предложение вакансий, выплата выходного пособия и суд. 📞 +7 (4742) 20-15-25.',
  alternates: {

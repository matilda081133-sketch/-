...
export const metadata: Metadata = {
  ...
  description: 'Помощь юриста по взысканию заработной платы в Липецке: задержка выплат, расчет при увольнении, невыплата премий, компенсация по ст. 236 ТК РФ и суд. 📞 +7 (4742) 20-15-25.',
  alternates: {

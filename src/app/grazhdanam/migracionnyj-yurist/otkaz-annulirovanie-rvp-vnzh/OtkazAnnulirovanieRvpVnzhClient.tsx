      ...
      <section className="section bg-white" style={{ padding: '80px 0' }}>
        <div className="container">
            ...
            {[
          {
                    ...
                    "desc": "Закон даёт 15 дней на выезд из страны. Подача административного иска в суд приостанавливает обязанность покинуть территорию России."
          },
          {
                    "tag": "Отказ в выдаче",
                    "title": [
          ...
          },
          {
                    ...
                    "desc": "Доказываем малозначительность нарушений ПДД, отсутствие общественной опасности и несоразмерность аннулирования статуса."
          },
          {
                    "tag": "Семья в России",
                    "title": [

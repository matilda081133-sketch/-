...
export default function PoluchenieGrazhdanstvaRfClient() {
  ...
  const faqs = [
  {
    "q": "Что изменилось с вступлением в силу нового закона № 138-ФЗ «О гражданстве РФ»?",
    "a": "Закон упразднил упрощённый порядок в старом понимании и ввёл специальные основания приёма в гражданство РФ, сократил перечень требований для близких родственников граждан РФ и установил институт прекращения гражданства."
  },
  {
    "q": "Обязательно ли иметь ВНЖ перед подачей на гражданство РФ?",
    "a": "В большинстве случаев наличие действующего ВНЖ является обязательным условием. Исключения предусмотрены для участников Государственной программы переселения соотечественников и отдельных льготных категорий."
  },
  {
    "q": "Даёт ли брак с гражданином РФ право на получение гражданства?",
    "a": "По новому закону № 138-ФЗ один лишь брак не является основанием: необходимо либо наличие общего ребёнка в браке, либо проживание по ВНЖ в общем порядке."
  },
  {
    "q": "Кто освобождается от подтверждения знания русского языка, истории и основ права?",
    "a": "От сдачи экзамена освобождаются мужчины старше 65 лет, женщины старше 60 лет, инвалиды I группы, недееспособные лица, а также лица, получающие гражданство по отдельным специальным основаниям закона № 138-ФЗ."
  },
  {
    "q": "Обязательна ли процедура принесения Присяги гражданина РФ?",
    "a": "Да, принесение Присяги обязательно для всех дееспособных лиц старше 18 лет. Решение о приёме в гражданство вступает в силу именно с момента принесения Присяги, после чего оформляется паспорт РФ."
  }
];

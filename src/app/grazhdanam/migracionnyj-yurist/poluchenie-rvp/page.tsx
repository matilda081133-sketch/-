...
export const metadata: Metadata = {
  ...
  description: 'Помощь в оформлении разрешения на временное проживание (РВП) в Липецке: по квоте и без квоты (брак, рождение, соотечественники). Сбор документов и подача в МВД. 📞 +7 (4742) 20-15-25.',
  alternates: {
    ...
    images: [
      {
        ...
        height: 630,
        type: 'image/jpeg',
        alt: 'Оформление разрешения на временное проживание (РВП) — ЮК «Де-Юре»',
      },
    ],
  },
  twitter: {

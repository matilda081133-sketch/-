    ...
    <main>
      ...
      <ProcessBlock
        ...
        steps={[
          {
            num: '01',
            title: 'Уточняем основания и цель',
            desc: 'Анализируем миграционную историю, проверяем наличие оснований по ст. 6 закона № 115-ФЗ (по квоте или без квоты) и отсутствие ограничений.'
          },
          {
            num: '02',
            title: 'Формируем комплект документов',
            desc: 'Проверяем паспорт с нотариальным переводом, медицинские заключения, сертификат по русскому языку, подтверждение дохода и оснований.'
          },
          {
            num: '03',
            title: 'Заполняем заявление по регламенту',
            desc: 'Составляем заявление строго по актуальной форме МВД без разночтений и помарок, исключая риски возврата или отказа в приёме.'
          },
          {
            num: '04',
            title: 'Сопровождаем подачу и получение',
            desc: 'Координируем запись и визит в подразделение по вопросам миграции, контролируем регламентные сроки рассмотрения и получение штампа РВП.'
          },
          {
            isBanner: true,

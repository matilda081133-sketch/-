...
export default function PoluchenieRvpClient() {
  ...
  },
  {
    ...
    "a": "Без квоты РВП могут получить: состоящие в браке с гражданином РФ, родившиеся на территории РСФСР/РФ, имеющие родителей или детей — граждан РФ, выпускники российских вузов и участники Госпрограммы."
  },
  {

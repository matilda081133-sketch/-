...
export default function PoluchenieRvpClient() {
  ...
  {
    "category": "РВП без квоты",
    "title": "Оформление РВП по браку с первого обращения без возвратов",
    "problem": "Доверитель дважды получал отказ в приёме документов в миграционном центре из-за неточностей в анкете и переводах.",
    "action": "Провели аудит переводов, скорректировали автобиографические сведения, сформировали эталонный комплект документов.",
    "result": "Заявление принято сотрудником МВД с первого визита, РВП успешно получено в регламентный срок."
  }
];
  const faqs = [
  {
    "q": "Кто может получить РВП без квоты?",
    "a": "Иностранные граждане, состоящие в браке с гражданином РФ, имеющие детей — граждан РФ, родившиеся в РСФСР/РФ, окончившие российский вуз с отличием, военнослужащие по контракту, граждане Казахстана, Молдовы, Украины и некоторые другие категории по ст. 6 115-ФЗ."
  },
  {
    "q": "Сколько действует РВП и можно ли его продлить?",
    "a": "РВП выдаётся сроком на 3 года. Продление РВП законом не предусмотрено: после проживания по РВП не менее 8 месяцев иностранный гражданин имеет право подать заявление на получение вида на жительство (ВНЖ)."
  }
];
      ...
      <section className="section bg-white" style={{ padding: '80px 0' }}>
        <div className="container">
            ...
            {[
          {
                    ...
                    "desc": "Оформляем РВП в упрощённом порядке по браку в регионе регистрации супруга в соответствии с требованиями Федерального закона № 115-ФЗ."
          },
          {
                    "tag": "Красный диплом / ВУЗ",
                    "title": [
                              "Окончание очного отделения",
                              "российского ВУЗа",
                              "с дипломом с отличием"
                    ],
                    "desc": "Подаём документы на РВП по образовательному основанию без необходимости получения правительственной квоты."
          },
          {
                    "tag": "Рождение в РСФСР / РФ",
                    "title": [
                              "Рождение на территории",
                              "РСФСР в прошлом",
                              "или гражданство бывшего СССР"
                    ],
                    "desc": "Истребуем архивные справки, свидетельства о рождении и подтверждаем принадлежность к гражданству СССР."
          },
          {
                    "tag": "Квота на РВП",
                    "title": [
      ...
      <ProcessBlock
        ...
        steps={[
          ...
          },
          {
            ...
            desc: 'Формируем комплект документов, проверяем основания без квоты и по квоте, сопровождаем подачу заявления в подразделение МВД.'
          },
          {
            isBanner: true,

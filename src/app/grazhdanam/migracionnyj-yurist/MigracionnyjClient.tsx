...
export default function MigracionnyjClient() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'С 5 февраля 2025 года (ФЗ от 08.08.2024 № 260-ФЗ) в отношении лиц, включенных в реестр контролируемых лиц, действует режим высылки с серьезными ограничениями прав (запрет на управление ТС, открытие счетов и переводы, регистрацию недвижимости и юрлиц, заключение брака). Юристы «Де-Юре» добиваются исключения из реестра через обжалование оснований внесения.'
    },
    {
      q: 'Что грозит при аннулировании РВП или ВНЖ?',
      a: 'После аннулирования РВП или ВНЖ иностранный гражданин обязан выехать из РФ в течение 15 дней (ранее — 30 дней), либо оспорить решение. При подаче иска в суд депортация автоматически НЕ приостанавливается — юрист обязательно заявляет ходатайство о применении мер предварительной защиты (ст. 85 КАС РФ).'
    },
    {
          ...
          <div className="grid grid-4" style={{ gap: '16px', marginBottom: '32px' }}>
            ...
            >
              <div>
                ...
                <p style={{ color: 'var(--color-deep-blue)', opacity: 0.9, fontSize: '13px', lineHeight: 1.55, margin: 0 }}>
                  Закон отводит 15 дней на выезд (ранее — 30 дней). При подаче иска в суд депортация автоматически НЕ приостанавливается — юрист заявляет ходатайство о применении мер предварительной защиты (ст. 85 КАС РФ) для легального приостановления выезда.
                </p>
              </div>
            </div>
            ...
            >
              <div>
                ...
                <p style={{ color: 'var(--color-deep-blue)', opacity: 0.9, fontSize: '13px', lineHeight: 1.55, margin: 0 }}>
                  С 5 февраля 2025 года (ФЗ от 08.08.2024 № 260-ФЗ) действует режим высылки: запрет на счета, сделки с недвижимостью и авто, регистрацию брака. Требуется срочный правовой аудит и обжалование.
                </p>
              </div>
            </div>
          </div>

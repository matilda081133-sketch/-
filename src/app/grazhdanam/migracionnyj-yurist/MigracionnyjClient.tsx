...
export default function MigracionnyjClient() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'Наличие супруга, детей или родителей — граждан РФ может иметь существенное значение при оценке соразмерности запрета и последствий для семьи. Однако семейные связи не отменяют ограничение автоматически. Необходимо подтвердить реальность отношений, совместное проживание или участие в жизни семьи и сопоставить эти обстоятельства с основанием запрета. Правовая позиция формируется с учётом Конституции РФ и актуальной практики российских судов.'
    },
    {
      q: 'Что делать, если сведения появились в реестре контролируемых лиц?',
      a: 'Включение в реестр контролируемых лиц ограничивает открытие счетов и проведение банковских операций. При этом закон сохраняет возможность получать входящие переводы, оплачивать обязательные платежи и снимать наличные в пределах установленного лимита. Также действуют ограничения на управление транспортом, регистрацию имущества, заключение брака и передвижение. Необходимо установить основание включения и определить, требуется ли исправление сведений, получение законного статуса или обжалование исходного решения.'
    },
    {
      q: 'Что грозит при аннулировании РВП или ВНЖ?',
      a: 'После аннулирования РВП или ВНЖ иностранный гражданин обязан выехать из России в течение 15 дней. Само обращение в суд не приостанавливает действие решения и обязанность выехать. Вместе с административным иском необходимо отдельно заявить о применении мер предварительной защиты. Временно приостановить действие решения может суд, если удовлетворит это заявление.'
    },
    {
      ...
      <MilitaryHero
        ...
        primaryCtaSubtext={
          <span style={{ display: 'block' }}>
            ...
            <span className="hero-title-span-mobile" style={{ display: 'block', whiteSpace: 'nowrap' }}>
              или грозит выдворение, позвоните: <a href="tel:+74742201525" style={{ color: 'var(--color-primary)', fontWeight: 'bold', textDecoration: 'none' }}>+7 (4742) 20-15-25</a>
            </span>
          </span>
        }
        trustItems={[
      ...
      <section style={{ background: 'var(--color-deep-blue)', padding: '64px 0 56px', position: 'relative', overflow: 'hidden' }}>
        <div className="container">
          ...
          <p style={{ color: 'rgba(255,255,255,0.85)', fontSize: '16px', marginBottom: '40px', maxWidth: '850px', lineHeight: 1.6 }}>
            В миграционных делах сроки зависят от вида решения и даты его получения. Пропуск срока обжалования или срока добровольного выезда может привести к вступлению решения в силу, утрате статуса, депортации, режиму высылки или запрету на въезд. Поэтому сначала необходимо определить точный акт и рассчитать срок по документам.
          </p>
          ...
          <div className="grid grid-4" style={{ gap: '16px', marginBottom: '32px' }}>
            ...
            >
              <div>
                ...
                <p style={{ color: 'var(--color-deep-blue)', opacity: 0.9, fontSize: '13px', lineHeight: 1.55, margin: 0 }}>
                  После уведомления об аннулировании РВП или ВНЖ закон отводит 15 дней на выезд. Само обращение в суд не приостанавливает эту обязанность. Необходимо отдельно заявить о применении мер предварительной защиты. Приостановление действует только после принятия соответствующего определения судом.
                </p>
              </div>
            </div>
            ...
            >
              <div>
                ...
                <p style={{ color: 'var(--color-deep-blue)', opacity: 0.9, fontSize: '13px', lineHeight: 1.55, margin: 0 }}>
                  С 5 февраля 2025 года в отношении лиц, включенных в реестр контролируемых лиц, действует режим высылки. Он ограничивает открытие новых счетов и проведение банковских операций, управление транспортом, регистрацию имущества, заключение брака и передвижение. Необходимо установить основание включения и определить законный способ исключения из реестра.
                </p>
              </div>
            </div>
          </div>
          ...
          <div style={{
            ...
            <strong style={{ color: '#FFFFFF' }}>Юридическая справка:</strong> своевременная жалоба на не вступившее в силу постановление по КоАП РФ препятствует его вступлению в силу до рассмотрения жалобы. Подача административного иска по КАС РФ сама по себе не приостанавливает действие оспариваемого решения. При риске срочного исполнения отдельно подаётся заявление о мерах предварительной защиты, решение по которому принимает суд.
          </div>
          ...
          <div className="grid grid-3" style={{ gap: '24px' }}>
            {[
              ...
              },
              {
                ...
                desc: 'Проверим постановление и дату его получения, подготовим жалобу, представим доказательства невиновности или несоразмерности наказания. Основания и порядок освобождения из ЦВСИГ оценим отдельно по судебным актам.',
                btnText: 'Обжаловать выдворение'
              },
              {
              ...
              },
              {
                ...
                desc: 'Установим основание включения в реестр, проверим исходное решение и определим законный маршрут исключения. После появления основания для исключения проконтролируем актуализацию сведений и прекращение ограничений.',
                btnText: 'Исключить из реестра'
              },
              {
              ...
              },
              {
                ...
                desc: 'Проверим применимое основание по закону № 138-ФЗ, выявим противоречия и основания возможного отклонения, подготовим заявление и сопроводим процедуру до решения и Присяги в согласованном объёме.',
                btnText: 'Получить гражданство'
              }
            ].map((item, i) => (
              <div
                key={i}
        ...
        <div className="container">
          <div style={{ maxWidth: '780px', marginBottom: '48px', textAlign: 'left' }}>
            ...
            <p style={{ fontSize: '16px', color: 'var(--color-deep-blue)', opacity: 0.9, fontWeight: 500, margin: 0, lineHeight: 1.6, textAlign: 'left' }}>
              Выберите ситуацию, чтобы узнать основания, сроки обжалования,<br />необходимые документы и как строится юридическая работа.
            </p>
          </div>
          ...
          <div className="grid grid-3" style={{ gap: '28px', marginBottom: '32px' }}>
            {[
              ...
              },
              {
                ...
                desc: 'Оспаривание основания включения, прекращение режима высылки и контроль снятия ограничений по банковским операциям, транспорту и сделкам.',
              ...
              >
                <div style={{ flex: '1 1 500px', minWidth: '280px' }}>
                  ...
                  <p style={{ margin: 0, fontSize: '15px', color: 'rgba(255, 255, 255, 0.85)', lineHeight: 1.6 }}>
                    <span style={{ display: 'inline-block' }}>Опишите ваш миграционный вопрос в форме. Изучим имеющиеся документы</span> <br />

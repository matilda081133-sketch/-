...
export const metadata: Metadata = {
  ...
  description: 'Помощь при включении в реестр контролируемых лиц МВД: установление основания, исправление сведений, обжалование исходного решения и контроль прекращения ограничений. 📞 +7 (4742) 20-15-25.',
  alternates: {

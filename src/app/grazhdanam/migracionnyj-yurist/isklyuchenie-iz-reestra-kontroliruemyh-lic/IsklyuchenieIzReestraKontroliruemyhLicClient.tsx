...
export default function IsklyuchenieIzReestraKontroliruemyhLicClient() {
  ...
  },
  {
    ...
    "a": "В период нахождения в реестре действует режим высылки: запрет на управление транспортными средствами, открытие банковских счетов и переводы средств, регистрацию прав на недвижимость и транспортные средства, регистрацию брака, а также ограничение на выезд из региона пребывания."
  },
  {
        ...
        <div className="container">
          <div style={{ maxWidth: '780px', marginBottom: '40px' }}>
            ...
            <p style={{ fontSize: '16px', color: 'var(--color-deep-blue)', opacity: 0.9, fontWeight: 500, margin: 0, lineHeight: 1.6, textWrap: 'balance' }}>
              С 5 февраля 2025 года (ФЗ от 08.08.2024 № 260-ФЗ) в отношении иностранцев в реестре действует специальный правовой режим высылки. Сведения исключаются из реестра при наступлении предусмотренного законом основания (п. 7 ст. 31.2 закона № 115-ФЗ).
            </p>
          </div>
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                <li style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                  ...
                  <div>
                    ...
                    <span style={{ fontSize: '13.5px', color: 'var(--color-text-secondary)', lineHeight: 1.5 }}>Документы, подтверждающие основания для нахождения в РФ или устранение нарушений.</span>
                  </div>
                </li>
                <li style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--color-primary)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, marginTop: '2px' }}>

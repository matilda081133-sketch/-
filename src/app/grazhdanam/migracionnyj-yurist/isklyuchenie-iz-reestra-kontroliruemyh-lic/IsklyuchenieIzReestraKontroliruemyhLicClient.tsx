...
export default function IsklyuchenieIzReestraKontroliruemyhLicClient() {
  ...
  {
    "category": "Реестр / Разблокировка",
    "title": "Исключение иностранного гражданина из реестра контролируемых лиц МВД",
    ...
    "action": "Собрали справки из университета, подали мотивированное заявление начальнику УВМ УМВД России по Липецкой области.",
    "result": "Запись исключена из реестра в течение 3 рабочих дней, банковские счета полностью разблокированы."
  }
];
  const faqs = [
  {
    "q": "Что такое реестр контролируемых лиц и режим высылки?",
    "a": "Это единая база МВД РФ, в которую вносятся иностранные граждане, находящиеся в России без законных оснований (истекли сроки, аннулированы документы, вынесено решение о выдворении). В отношении них действуют строгие ограничения: запрет на открытие счетов, вождение авто, сделки, регистрацию брака."
  },
  {
    "q": "Как быстро можно исключить сведения из реестра?",
    "a": "В досудебном порядке при устранении причин или подтверждении ошибки исключение занимает от 3 до 7 рабочих дней. В судебном порядке — в рамках регламентного рассмотрения административного иска."
  }
];
        ...
        <div className="container">
            ...
            {[
          {
                    ...
                    "title": [
                              ...
                              "из-за включения в реестр МВД"
                    ],
                    "desc": "Устанавливаем точную причину попадания в реестр контролируемых лиц и подаём срочное заявление в УМВД."
          },
          {
                    "tag": "Запрет на авто",
                    "title": [
                    ...
                    "desc": "Режим высылки запрещает сдавать на права и управлять автомобилем в РФ — устраняем основания ограничения."
          },
          {
                    "tag": "Отказ в браке / ЗАГС",
                    "title": [
                              "Запрет на регистрацию",
                              "брака и юридических действий"
                    ],
                    "desc": "Лица из реестра не могут заключать брак и совершать сделки с недвижимостью — добиваемся исключения."
          },
          {
                    "tag": "Ошибочное включение",
                    "title": [
                              "Документы в порядке,",
                              "но сведения появились в реестре"
                    ],
                    "desc": "Истребуем подтверждения законности пребывания и обжалуем техническую ошибку сотрудника МВД."
          }
].map((item, i) => (

  ...
  return (
    <main>
      ...
      <MilitaryHero
        ...
        trustItems={[
        {
                "text": "Защита при режиме высылки (ФЗ № 260-ФЗ)"
        },
        {
                "text": "Снятие ограничений по банковским операциям после исключения из реестра"
        },
        {
        ...
        <div className="container">
          <div style={{ maxWidth: '780px', marginBottom: '40px' }}>
            ...
            <p style={{ fontSize: '16px', color: 'var(--color-deep-blue)', opacity: 0.9, fontWeight: 500, margin: 0, lineHeight: 1.6, textWrap: 'balance' }}>
              Сведения исключаются из реестра при наступлении одного из оснований, предусмотренных пунктом 7 статьи 31.2 закона № 115-ФЗ: выезде из России, приобретении законного основания для пребывания или проживания, отмене исходного решения, признании его незаконным судом, а также в случае смерти или объявления человека умершим. Если запись основана на ошибочных сведениях, необходимо добиться исправления данных либо отмены или признания незаконным решения, ставшего основанием включения.
            </p>
          </div>
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                <li style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                  ...
                  <div>
                    ...
                    <span style={{ fontSize: '13.5px', color: 'var(--color-text-secondary)', lineHeight: 1.5 }}>Проверяем, какой документ или статус именно в ситуации клиента создает законное основание пребывания: виза, патент, РВП, РВПО, ВНЖ либо иное прямо предусмотренное законом основание. Трудовой договор или семейная связь учитываются только при соблюдении условий соответствующей миграционной процедуры.</span>
                  </div>
                </li>
                <li style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--color-primary)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, marginTop: '2px' }}>
                ...
                <li style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                  ...
                  <div>
                    ...
                    <span style={{ fontSize: '13.5px', color: 'var(--color-text-secondary)', lineHeight: 1.5 }}>Проверяем исключение сведений из реестра и обновление данных в системах МВД, банков и других организаций. Если ограничения продолжают действовать, готовим обращения для их фактического снятия.</span>
                  </div>
                </li>
              </ul>
            </div>
      ...
      <section className="section bg-light" style={{ padding: '64px 0', background: 'var(--gradient-cream)', borderTop: '1px solid var(--color-border)' }}>
        <div className="container">
          ...
          <div className="grid grid-4" style={{ gap: '20px', gridTemplateColumns: 'repeat(4, minmax(0, 1fr))' }}>

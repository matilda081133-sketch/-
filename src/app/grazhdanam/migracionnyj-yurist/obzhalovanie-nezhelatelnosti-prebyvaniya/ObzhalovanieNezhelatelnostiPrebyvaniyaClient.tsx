...
export default function ObzhalovanieNezhelatelnostiPrebyvaniyaClient() {
  ...
  },
  {
    ...
    "action": "Сформировали административный иск по нормам КАС РФ, доказали факт осуществления ухода и нарушение права на уважение семейной жизни (ст. 8 ЕКПЧ, ст. 38 Конституции РФ).",

...
export default function ObzhalovanieNezhelatelnostiPrebyvaniyaClient() {
  ...
  {
    "category": "Минюст / Судимость",
    "title": "Отмена бессрочного решения Минюста РФ о нежелательности пребывания",
    "problem": "Гражданину Молдовы после отбытия наказания Минюст вынес решение о пожизненной нежелательности пребывания. В Липецке проживают супруга и несовершеннолетние дети.",
    "action": "Доказали погашение судимости, безупречное поведение, отсутствие рецидива и нарушение единства семьи.",
    "result": "Решение Минюста РФ признано судом незаконным и отменено, въезд в Россию разрешён."
  },
  {
    "category": "Роспотребнадзор",
    "title": "Отмена решения Роспотребнадзора после прохождения лечения",
    "problem": "Иностранному гражданину ограничили въезд из-за ошибочного медицинского теста.",
    "action": "Провели контрольное освидетельствование в государственном диспансере, подтвердили отсутствие заболеваний и подали иск.",
    "result": "Роспотребнадзор отменил решение о нежелательности в добровольном порядке до вынесения решения суда."
  }
];
  const faqs = [
  {
    "q": "Можно ли отменить решение о нежелательности пребывания, если судимость погашена?",
    "a": "Да. Конституционный Суд РФ и Верховный Суд РФ неоднократно указывали, что само по себе наличие судимости в прошлом не может служить основанием для пожизненного ограничения прав иностранца, если у него есть семья в России и отсутствуют иные риски."
  },
  {
    "q": "Какой суд рассматривает такие иски?",
    "a": "Иски об оспаривании решений федеральных органов (Минюст, ФСБ, Роспотребнадзор) подаются в районный суд по месту нахождения ответчика или по месту жительства административного истца в РФ."
  }
];
      ...
      <section className="section bg-white" style={{ padding: '80px 0' }}>
        <div className="container">
            ...
            {[
          {
                    ...
                    "desc": "Оспариваем распоряжения Минюста России по ст. 25.10 114-ФЗ с учётом погашения судимости, семейных связей и поведения доверителя."
          },
          {
                    "tag": "Роспотребнадзор",
                    "title": [
          ...
          },
          {
                    ...
                    "desc": "Истребуем материалы проверки, проверяем соразмерность мер, обжалуем акт в судах высшей инстанции с ходатайством о защите прав."
          },
          {
          ...
          },
          {
                    ...
                    "desc": "Обосновываем нарушение баланса публичных и частных интересов при разлучении семьи по ст. 8 Европейской конвенции и нормам Конституции РФ."
          },
          {
                    "tag": "Снятие из базы",
                    "title": [
                              "Решение отменено судом,",
                              "но запись не исключена",
                              "из контрольного списка ФСБ"
                    ],
                    "desc": "Направляем судебные акты в Пограничную службу ФСБ РФ и ГУВМ МВД для фактической разблокировки въезда в Российскую Федерацию."
          }
].map((item, i) => (

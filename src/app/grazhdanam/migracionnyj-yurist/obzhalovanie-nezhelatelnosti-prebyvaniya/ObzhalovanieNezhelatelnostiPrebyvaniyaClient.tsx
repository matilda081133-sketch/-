      ...
      <section className="section bg-white" style={{ padding: '80px 0' }}>
        <div className="container">
            ...
            {[
          {
                    ...
                    "desc": "Оспариваем пожизненные и длительные решения Минюста после погашения судимости при наличии семьи в РФ."
          },
          {
                    "tag": "Роспотребнадзор",
                    "title": [
                    ...
                    "desc": "При излечении от заболевания или наличии близких родственников в РФ добиваемся пересмотра и отмены решения."
          },
          {
                    ...
                    "desc": "Истребуем материалы проверки, выявляем необоснованность выводов и защищаем права доверителя в суде."
          },
          {
                    "tag": "Бессрочный запрет",
                    "title": [
                              "Бессрочный пожизненный запрет",
                              "на въезд в Российскую Федерацию"
                    ],
                    "desc": "Доказываем несоразмерность бессрочного ограничения нормам Конституции РФ и международным договорам."
          }
].map((item, i) => (

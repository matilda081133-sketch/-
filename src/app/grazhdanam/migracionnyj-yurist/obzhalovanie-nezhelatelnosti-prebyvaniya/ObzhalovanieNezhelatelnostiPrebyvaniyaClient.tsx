...
export default function ObzhalovanieNezhelatelnostiPrebyvaniyaClient() {
  ...
  {
    "q": "Какой срок на обжалование распоряжения о нежелательности пребывания?",
    "a": "Административное исковое заявление по КАС РФ может быть подано в суд в течение 3 месяцев со дня, когда гражданину стало известно о нарушении его прав (ч. 1 ст. 219 КАС РФ). Пропуск срока возможен к восстановлению при наличии уважительных причин."
  },
  {
    "q": "Что происходит с действием решения во время суда?",
    "a": "Подача административного иска автоматически не приостанавливает действие распоряжения о нежелательности. Юрист одновременно с подачей иска заявляет ходатайство о применении мер предварительной защиты (ст. 85 КАС РФ) для приостановления действия решения и защиты от депортации на время процесса."
  }
];

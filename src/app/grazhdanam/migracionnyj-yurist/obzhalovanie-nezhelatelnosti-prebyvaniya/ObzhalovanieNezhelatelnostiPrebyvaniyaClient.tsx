...
export default function ObzhalovanieNezhelatelnostiPrebyvaniyaClient() {
  ...
  },
  {
    ...
    "a": "Погашение судимости само по себе не отменяет решение о нежелательности пребывания. Оно оценивается вместе с поведением после освобождения, отсутствием новых нарушений, семейными связями, продолжительностью проживания в России и соразмерностью ограничения. Возможность отмены определяется после изучения решения и доказательств."
  },
  {
  ...
  {
    "q": "В какой срок можно обжаловать решение о нежелательности пребывания?",
    "a": "По общему правилу административный иск подается в течение трех месяцев со дня, когда человеку стало известно о нарушении его прав. Точную дату начала срока необходимо определять по уведомлению, дате получения решения и другим документам. Пропущенный срок может быть восстановлен только при наличии уважительных причин."
  },
  {
    "q": "Приостанавливает ли обращение в суд исполнение решения?",
    "a": "Нет. Подача административного иска сама по себе не приостанавливает действие решения. Необходимо отдельно заявить о применении мер предварительной защиты. Приостановить действие решения или запретить его исполнение может суд."
  }
];

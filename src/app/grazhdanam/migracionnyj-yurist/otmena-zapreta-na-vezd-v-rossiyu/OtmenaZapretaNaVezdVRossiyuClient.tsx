...
export default function OtmenaZapretaNaVezdVRossiyuClient() {
  ...
  },
  {
    ...
    "a": "Да. Начать работу можно с дистанционного анализа решения и документов. Адвокат проведёт правовую оценку оснований, направит официальные запросы, подготовит досудебную жалобу или административный иск в суд по нотариальной доверенности либо ордеру. Личное присутствие доверителя в России на период рассмотрения дела не обязательно."
  },
  {
        ...
        <div className="container">
          ...
          <div className="grid grid-3" style={{ gap: '28px' }}>
                        {[
              {
                ...
                desc: "Наличие близких родственников — граждан РФ является значимым обстоятельством при оценке соразмерности запрета, но не гарантирует его отмену. Проверяются основание ограничения, реальность семейных связей, совместное проживание, участие в жизни семьи и характер допущенных нарушений."
              },
              {
                tag: "Штрафы КоАП",
                title: [

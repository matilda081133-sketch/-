...
export default function ObzhalovanieResheniyaODeportaciiClient() {
  ...
  },
  {
    ...
    "a": "Да. Наличие супруга, несовершеннолетних детей или нетрудоспособных родителей — граждан РФ является ключевым основанием для признания депортации несоразмерным вмешательством в семейную жизнь (ст. 8 ЕКПЧ и ст. 38 Конституции РФ)."
  }
];

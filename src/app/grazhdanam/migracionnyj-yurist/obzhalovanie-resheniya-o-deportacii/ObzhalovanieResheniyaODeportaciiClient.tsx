...
export default function ObzhalovanieResheniyaODeportaciiClient() {
  ...
  {
    "category": "Депортация / КАС РФ",
    "title": "Приостановление депортации через меры предварительной защиты суда",
    "problem": "МВД вынесло распоряжение о депортации иностранного гражданина после аннулирования РВП.",
    "action": "Подали административный иск в районный суд с ходатайством по ст. 85 КАС РФ о запрете совершать исполнительные действия по выдворению.",
    "result": "Суд удовлетворил меры защиты, депортация заморожена, доверитель законно ожидает решения суда в Липецке."
  },
  {
    "category": "Семейная защита",
    "title": "Отмена решения о депортации отца троих детей — граждан России",
    "problem": "Органы миграционного контроля приняли решение о принудительной высылке доверителя.",
    "action": "Доказали устойчивую социализацию, воспитание детей и нарушение баланса интересов публичного порядка.",
    "result": "Решение о депортации признано незаконным и полностью аннулировано судом."
  }
];
  const faqs = [
  {
    "q": "Чем депортация отличается от административного выдворения?",
    "a": "Административное выдворение назначается исключительно судьёй в качестве наказания по КоАП РФ. Депортация — это административная процедура, решение о которой принимает орган МВД (например, если иностранец утратил законные основания для нахождения и не выехал добровольно)."
  },
  {
    "q": "Можно ли приостановить депортацию на время суда?",
    "a": "Да. При подаче административного искового заявления по КАС РФ заявляется ходатайство о применении мер предварительной защиты (ст. 85 КАС РФ), обязывающее МВД приостановить исполнение решения до вынесения окончательного решения суда."
  }
];
        ...
        <div className="container">
            ...
            {[
          {
                    ...
                    "title": [
                              ...
                              "о принудительной депортации"
                    ],
                    "desc": "Оцениваем основания решения, сроки на добровольный выезд и готовим административный иск в суд."
          },
          {
                    "tag": "После отбытия наказания",
                    "title": [
                              "Депортация после отбытия",
                              "уголовного наказания в РФ"
                    ],
                    "desc": "Проверяем соразмерность решения, семейные обстоятельства, гражданство и риск пыток в стране исхода."
          },
          {
                    "tag": "Аннулирование статуса",
                    "title": [
                              "Депортация из-за аннулирования",
                              "РВП, ВНЖ или статуса беженца"
                    ],
                    "desc": "Оспариваем как первичное решение об аннулировании, так и производное распоряжение о депортации."
          },
          {
                    "tag": "Приостановление выезда",
                    "title": [
                              "Необходимость срочной",
                              "заморозки исполнения высылки"
                    ],
                    "desc": "Заявляем ходатайство о мерах предварительной защиты для легальной приостановки процедуры депортации."
          }
].map((item, i) => (

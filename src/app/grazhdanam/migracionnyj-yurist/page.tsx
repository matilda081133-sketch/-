...
export const metadata: Metadata = {
  ...
  description: 'Помощь миграционного юриста в Липецке: запрет на въезд, выдворение, депортация, РВП, ВНЖ, гражданство и реестр контролируемых лиц (260-ФЗ). Консультация и защита в суде. 📞 +7 (4742) 20-15-25.',
  alternates: {

...
export default function PoluchenieVidaNaZhitelstvoClient() {
  ...
  },
  {
    ...
    "a": "Родившиеся на территории РСФСР, имеющие родителей или детей — граждан РФ, окончившие российский вуз с отличием, высококвалифицированные специалисты, носители русского языка и граждане Беларуси/Казахстана/Молдовы."
  },
  {

...
export default function PoluchenieVidaNaZhitelstvoClient() {
  ...
  {
    "category": "ВНЖ напрямую",
    "title": "Получение бессрочного ВНЖ по несовершеннолетнему ребёнку — гражданину РФ",
    "problem": "Доверителю отказывали в приёме документов из-за расхождений в транслитерации имён в свидетельстве о рождении.",
    "action": "Истребовали необходимые дубликаты, оформили нотариальное подтверждение тождественности и сформировали пакет документов.",
    "result": "Заявление принято без замечаний, через 4 месяца получен бессрочный вид на жительство в РФ."
  }
];
  const faqs = [
  {
    "q": "Какой срок действия у вида на жительство (ВНЖ)?",
    "a": "С 2019 года вид на жительство в РФ выдаётся бессрочно (за исключением ВНЖ для высококвалифицированных специалистов). Заменять документ требуется только по возрасту (в 14, 20 и 45 лет), как и паспорт гражданина РФ."
  },
  {
    "q": "Какие права даёт ВНЖ иностранному гражданину?",
    "a": "ВНЖ даёт право постоянно проживать и свободно работать в любом регионе России без патента и разрешений, оформлять полис ОМС, получать пенсию и социальные выплаты, а также свободно выезжать и въезжать в РФ."
  }
];
      ...
      <section className="section bg-white" style={{ padding: '80px 0' }}>
        <div className="container">
            ...
            {[
          {
                    ...
                    "desc": "Подаём документы на ВНЖ в общем порядке до истечения срока действия РВП."
          },
          {
                    ...
                    "desc": "Оформляем ВНЖ напрямую без получения РВП по упрощённой процедуре."
          },
          {
                    "tag": "Красный диплом РФ",
                    "title": [
                              "Окончание очного отделения",
                              "российского ВУЗа с отличием"
                    ],
                    "desc": "Выпускники-отличники российских государственных ВУЗов имеют право на ВНЖ без РВП."
          },
          {
                    "tag": "Специалисты / НРЯ",
                    "title": [
                              "Высококвалифицированные специалисты",
                              "и признанные носители языка"
                    ],
                    "desc": "Оформление ВНЖ по трудовым и профессиональным льготным категориям."
          }
].map((item, i) => (
      ...
      <ProcessBlock
        ...
        steps={[
          ...
          },
          {
            ...
            desc: 'Сопровождаем оформление ВНЖ в общем и упрощённом порядке, исключаем риски отказа и контролируем сроки рассмотрения.'
          },
          {
            isBanner: true,

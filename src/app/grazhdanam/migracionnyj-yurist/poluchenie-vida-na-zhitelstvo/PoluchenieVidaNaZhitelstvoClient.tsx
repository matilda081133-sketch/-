      ...
      <section className="section bg-white" style={{ padding: '80px 0' }}>
        <div className="container">
          ...
          },
          {
                    ...
                    "desc": "Оформляем ВНЖ на срок действия разрешения на работу ВКС с полным юридическим сопровождением работодателя."
          },
          {
                    "tag": "Носители языка / РВПО",
                    "title": [
                              "Студенты с РВПО",
                              "или граждане стран ЕАЭС",
                              "и Республики Беларусь"
                    ],
                    "desc": "Сопровождаем прямое получение вида на жительство для граждан Беларуси и выпускников аспирантуры и ординатуры РФ."
          },
          {

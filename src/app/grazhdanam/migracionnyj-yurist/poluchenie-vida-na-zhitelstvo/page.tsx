...
export const metadata: Metadata = {
  ...
  description: 'Юридическая помощь в оформлении вида на жительство (ВНЖ) в Липецке: после РВП и напрямую по семейным, образовательным и профессиональным основаниям. Проверка документов и сопровождение подачи. 📞 +7 (4742) 20-15-25.',
  alternates: {

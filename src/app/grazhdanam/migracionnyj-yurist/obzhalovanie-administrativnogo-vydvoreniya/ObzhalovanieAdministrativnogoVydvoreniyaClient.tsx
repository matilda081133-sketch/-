...
export default function ObzhalovanieAdministrativnogoVydvoreniyaClient() {
  ...
  },
  {
    ...
    "a": "Да. Подача жалобы в установленный 10-дневный срок препятствует вступлению постановления в законную силу, что исключает принудительную высылку до рассмотрения дела вышестоящим судом."
  },
  {

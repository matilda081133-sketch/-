        ...
        <div className="container">
          ...
          <div className="grid grid-3" style={{ gap: '28px' }}>
              ...
              },
              {
                ...
                desc: "Получаем постановление о выдворении и судебный акт о помещении или продлении срока содержания, проверяем их законность и при наличии оснований обжалуем."
              },
              {
                tag: "Семья в РФ",
                title: [

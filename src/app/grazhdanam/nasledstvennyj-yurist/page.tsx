...
export const metadata: Metadata = {
  ...
  description: 'Помощь наследственного юриста в Липецке: оформление у нотариуса, восстановление срока, установление факта принятия, оспаривание завещания и раздел наследства. 📞 +7 (4742) 20-15-25.',
  alternates: {

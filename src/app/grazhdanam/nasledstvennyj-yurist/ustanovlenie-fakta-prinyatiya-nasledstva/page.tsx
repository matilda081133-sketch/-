...
export const metadata: Metadata = {
  ...
  description: 'Помощь в установлении факта принятия наследства через суд в Липецке, если 6-месячный срок у нотариуса пропущен. Сбор доказательств, подготовка иска и признание права собственности. 📞 +7 (4742) 20-15-25.',
  alternates: {

...
export const metadata = {
  ...
  description: 'Юридическое сопровождение покупки и продажи недвижимости в Липецке: проверка объекта и сторон, договор, безопасные расчёты, регистрация и приёмка. 📞 +7 (4742) 20-15-25.',
  alternates: {

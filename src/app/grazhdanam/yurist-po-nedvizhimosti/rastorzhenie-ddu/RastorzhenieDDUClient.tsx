...
export default function RastorzhenieDDUClient() {
  ...
  const processSteps = [
    ...
    },
    {
      ...
      desc: 'Предоставляем подтверждение Росреестра в банк эскроу-агент для разблокирования и возврата средств в порядке, установленном банком.'
    },
    {
      num: '05',
      title: 'Взыскание процентов в суде',
      desc: 'Взыскиваем с застройщика положенные проценты по ст. 9 № 214-ФЗ, подтверждённые убытки и положенный потребительский штраф.'
    }
  ];
  ...
  const pricingTiers = [
    ...
    },
    {
      ...
      features: [
        ...
        { name: 'Взыскание положенных процентов, подтверждённых убытков и потребительского штрафа', value: '✓' },
      ...
      <MilitaryHero
        ...
        subtitle={
          <span style={{ display: 'inline-block', maxWidth: '560px', textWrap: 'balance' }}>
            Расторгнем ДДУ законным способом, вернём деньги со счёта эскроу, урегулируем ипотеку и взыщем с застройщика положенные проценты, убытки и штраф.
          </span>
        }
          ...
          <div className="card service-card cta-banner-card" style={{ 
            ...
            <div style={{ flex: '1 1 300px' }}>
              ...
              <p style={{ margin: '0', fontSize: '15px', color: 'rgba(255,255,255,0.85)', lineHeight: 1.5, maxWidth: '640px' }}>
                Проверим эскроу-счёт и финансовое состояние застройщика, выберем безопасный способ выхода из ДДУ и добьёмся возврата денег.
              </p>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px', paddingBottom: '16px', borderBottom: '1px solid rgba(255, 255, 255, 0.15)', marginBottom: '20px' }}>
              ...
              <div>
                <h3 className="nowrap-desk" style={{ fontSize: 'clamp(20px, 3vw, 28px)', fontFamily: 'var(--font-serif)', color: '#FFFFFF', margin: 0, lineHeight: 1.25 }}>
                  4 способа выйти из ДДУ и вернуть деньги
                </h3>
              </div>
            </div>

...
export const metadata = {
  ...
  openGraph: {
    ...
    description: 'Юридическая помощь при расторжении ДДУ: возврат цены договора со счетов эскроу, взыскание процентов за пользование деньгами, взаимодействие с банком.',

...
export const metadata = {
  ...
  description: 'Взыскание неустойки с застройщика по ДДУ в Липецке: проверим период просрочки, рассчитаем требования, подготовим претензию, иск и исполнение. 📞 +7 (4742) 20-15-25.',
  alternates: {
    canonical: 'https://dejure-help.ru/grazhdanam/yurist-po-nedvizhimosti/vzyskanie-neustojki-po-ddu/'
  },
  openGraph: {
    title: 'Взыскание неустойки по ДДУ в Липецке | Де-Юре',
    description: 'Взыскание неустойки с застройщика по ДДУ в Липецке: точный расчёт по периодам с учётом мораториев, претензия, суд и фактическое исполнение. 📞 +7 (4742) 20-15-25.',

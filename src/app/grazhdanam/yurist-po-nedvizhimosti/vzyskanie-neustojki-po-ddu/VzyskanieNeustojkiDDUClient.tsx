          ...
          <div className="card service-card cta-banner-card" style={{ 
            ...
            <div style={{ flex: '1 1 300px' }}>
              ...
              <p style={{ margin: '0', fontSize: '15px', color: 'rgba(255,255,255,0.85)', lineHeight: 1.5, maxWidth: '640px' }}>
                Не подписывайте документы до консультации с юристом. Подписание дополнительного соглашения может лишить вас права требовать неустойку за перенесённый период.
              </p>
            </div>

      ...
      <MilitaryHero
        ...
        subtitle={
          <span style={{ display: 'inline-block', maxWidth: '640px', textWrap: 'balance' }}>
            Безопасно проведём сделку, оформим право собственности или защитим недвижимость в споре. Проверим документы и риски до передачи денег и доведём дело до нужного результата.
          </span>
        }

...
export const metadata = {
  ...
  description: 'Помощь при недостатках квартиры от застройщика в Липецке: оценим документы и дефекты, подготовим требование, взыщем расходы или уменьшение цены. 📞 +7 (4742) 20-15-25.',
  alternates: {
  ...
  openGraph: {
    ...
    description: 'Взыскание компенсации за строительные дефекты новостройки в Липецке: независимая строительная экспертиза, досудебная претензия и судебное взыскание. 📞 +7 (4742) 20-15-25.',

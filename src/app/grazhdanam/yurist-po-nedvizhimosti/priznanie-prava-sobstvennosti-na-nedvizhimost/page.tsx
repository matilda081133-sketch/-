...
export const metadata = {
  ...
  openGraph: {
    title: 'Признание права собственности на недвижимость в Липецке | Де-Юре',
    description: 'Признание права собственности на квартиры, дома, гаражи и участки через суд в Липецке: приобретательная давность, утеря документов, ликвидация продавца.',

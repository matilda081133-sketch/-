  ...
  const pricingTiers = [
    {
      ...
      features: [
        ...
        { name: 'Судебный иск, компенсация морального вреда и положенный потребительский штраф', value: '✓' },
      ...
      <MilitaryHero
        ...
        subtitle={
          <span style={{ display: 'inline-block', maxWidth: '560px', textWrap: 'balance' }}>
            Проверим ДДУ, рассчитаем все положенные выплаты и добьёмся результата — от претензии до фактического получения денег или исполнения решения.
          </span>
        }
            ...
            <div className="grid grid-2" style={{ gap: '22px', position: 'relative', zIndex: 1 }}>
              {[
                ...
                },
                {
                  ...
                  desc: 'Направление претензии без описи вложений и почтовых квитанций может лишить дольщика права на потребительский штраф и возмещение расходов.'
                }
              ].map((item, idx) => (

...
export const metadata = {
  ...
  description: 'Юрист по спорам с застройщиком в Липецке: просрочка по ДДУ, расторжение договора, недостатки квартиры, претензия, суд и исполнение решения. 📞 +7 (4742) 20-15-25.',
  alternates: {
  ...
  openGraph: {
    ...
    description: 'Юридическая помощь дольщикам в Липецке: взыскание неустойки по ДДУ, расторжение договора долевого участия, возмещение строительных дефектов. 📞 +7 (4742) 20-15-25.',

...
export const metadata = {
  ...
  description: 'Помощь в оспаривании сделок с недвижимостью в Липецке: оценим основания и срок, подготовим иск или защиту, добьёмся применимых последствий. 📞 +7 (4742) 20-15-25.',
  alternates: {
    canonical: 'https://dejure-help.ru/grazhdanam/yurist-po-nedvizhimosti/osparivanie-sdelok-s-nedvizhimostyu/'
  },
  openGraph: {
    title: 'Оспаривание сделок с недвижимостью в Липецке | Де-Юре',
    description: 'Признание недействительными договоров купли-продажи, дарения и ренты в Липецке: защита добросовестных покупателей, возврат квартир, обеспечительные меры. 📞 +7 (4742) 20-15-25.',

...
export default function SporyUKClient() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'Сначала запросите протокол и бюллетени, проверьте кворум, порядок уведомления и свои права на обжалование. Собственник может обратиться в районный суд в течение шести месяцев со дня, когда узнал или должен был узнать о решении. До подачи иска нужно заблаговременно письменно уведомить других собственников о намерении оспорить решение.'
    },
    {
      q: 'Можно ли взыскать с УК моральный вред и штраф 50%?',
      a: 'Да, если спор связан с услугой для личных нужд и применим Закон о защите прав потребителей. Можно заявить компенсацию морального вреда и расходы на представителя. Штраф 50% взыскивается при удовлетворении требований, которые исполнитель не выполнил добровольно; его окончательный размер определяет суд.'
    }
  ];
  ...
  const situations = [
    ...
    },
    {
      ...
      title: <>Холодные батареи, слабый <br />напор воды, перебои со светом</>,
      desc: 'Организуем официальную фиксацию параметров качества коммунальных услуг и снизим плату через претензии и суд.'
    },
    {
      tag: 'Отказ в ремонте',
      title: <>УК не ремонтирует <br />протекающую крышу, швы <br />или подвал</>,
    ...
    },
    {
      ...
      title: <>УК не предоставляет <br />финансовые отчёты <br />и сметы расходов</>,
  ...
  const helpActions = [
    ...
    {
      title: <>Жалобы в ГЖИ и другие компетентные органы</>,
      desc: 'Инициируем проверку Государственной жилищной инспекции Липецкой области, а при наличии оснований обращаемся в Роспотребнадзор, прокуратуру или иной компетентный орган.'
    },
    {
    ...
    <main>
      ...
      <section className="section bg-white" id="situations" style={{ padding: '80px 0' }}>
        <div className="container">
          ...
          {/* CTA-плашка с атрибуцией cta_source = housing_uk_banner */}
          <div 
      ...
      <section className="section" style={{ padding: '80px 0', background: 'var(--gradient-cream)' }}>
        <div className="container">
          <div style={{ maxWidth: '750px', marginBottom: '48px' }}>
            ...
            <p style={{ fontSize: '16px', color: 'var(--color-deep-blue)', opacity: 0.9, fontWeight: 500, margin: 0, lineHeight: 1.6 }}>
              Выстраиваем строгую доказательную базу с фиксацией фактов <br />ненадлежащего оказания услуг и заставляем УК устранять нарушения.
            </p>
          </div>

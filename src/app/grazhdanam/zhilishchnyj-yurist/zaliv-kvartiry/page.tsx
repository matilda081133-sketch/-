...
export const metadata: Metadata = {
  ...
  description: 'Поможем зафиксировать залив, установить ответственного, оценить и взыскать ущерб или защититься от завышенных требований. Юристы в Липецке. 📞 +7 (4742) 20-15-25.',
  alternates: {

...
export default function ZalivClient() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'Ответственность зависит от причины аварии и принадлежности оборудования. За ненадлежащее содержание общего имущества, как правило, отвечает управляющая организация; за внутриквартирное оборудование собственника — собственник. Границу ответственности по радиаторам, запорной арматуре и изменённым сетям определяют по устройству системы, документам и заключению специалиста.'
    },
    {
    ...
    },
    {
      ...
      a: 'Проверьте причину аварии и границу ответственности по документам и техническим данным. Порыв на стояке или гидроудар сами по себе не доказывают отсутствие вины конкретного лица: может потребоваться строительно-техническое исследование. Поможем установить ответственного и оспорить завышенные или неверно адресованные требования.'
    }
  ];
  ...
  const helpActions = [
    ...
    {
      title: <>Исковое заявление и расчёт требований</>,
      desc: 'Составляем исковое заявление и рассчитываем подтверждённый ущерб и расходы. В споре с управляющей организацией при наличии оснований дополнительно заявляем компенсацию морального вреда, неустойку и штраф по Закону о защите прав потребителей.'
    },
    {

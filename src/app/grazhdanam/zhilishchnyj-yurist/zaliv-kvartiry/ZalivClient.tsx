...
export default function ZalivClient() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'Да. Все расходы на проведение независимой экспертизы, составление сметы, юридические услуги и госпошлину в полном объёме взыскиваются с виновной стороны в судебном порядке.'
    },
    {
  ...
  const situations = [
    ...
    },
    {
      ...
      desc: 'Проведём независимую судебную экспертизу с учётом реальных рыночных цен на стройматериалы и работы.'
    },
    {
      ...
      <section className="section" style={{ padding: '80px 0', background: 'var(--gradient-cream)' }}>
        <div className="container">
          <div style={{ maxWidth: '750px', marginBottom: '48px' }}>
            ...
            <p style={{ fontSize: '16px', color: 'var(--color-deep-blue)', opacity: 0.9, fontWeight: 500, margin: 0, lineHeight: 1.6 }}>
              Обеспечиваем полное юридическое и экспертное сопровождение на каждом этапе разбирательства.
            </p>
          </div>

...
export default function VselenieClient() {
  const [ctaSource, setCtaSource] = useState('housing_vselenie_form_direct');
  ...
  const faqs = [
    {
      q: 'Что делать, если совладелец поменял замки и не даёт ключи?',
      a: 'Не пытайтесь взломать дверь силой без фиксации правового статуса. Необходимо зафиксировать факт чинения препятствий (обращение в полицию/участковому, свидетели, видеозапись, письменная претензия) и обратиться в суд с иском о вселении, обязании выдать ключи и не чинить препятствий.'
    },
    {
      q: 'Можно ли вселиться в квартиру, если у меня маленькая доля?',
      a: 'Суд оценивает возможность совместного проживания, планировку квартиры (наличие изолированных комнат), сложившийся порядок пользования и нуждаемость каждого собственника в жилье. Если доля незначительна и выделить комнату невозможно, может встать вопрос о компенсации.'
    },
    {
      q: 'Как суд определяет порядок пользования жилым помещением?',
      a: 'При отсутствии соглашения суд определяет порядок пользования с учётом планировки, сложившегося порядка, размера долей и интересов всех собственников. Конкретная комната может быть предоставлена одному из них, если это возможно; точного соответствия площади комнаты размеру доли закон не требует. Кухня, санузел и коридор обычно остаются в общем пользовании.'
    },
    {
      q: 'Может ли наниматель по соцнайму вселиться обратно?',
      a: 'Да, если он включён в договор социального найма или ордер, а его выезд носил временный или вынужденный характер (например, из-за конфликта). Главное — доказать, что выезд не был добровольным и постоянным.'
    },
    {
      q: 'Как исполняется решение суда о вселении?',
      a: 'После вступления решения суда в силу получается исполнительный лист и передаётся судебным приставам. Пристав с понятыми обеспечивает вскрытие/замену замка, передачу ключей взыскателю и официальное составление акта о вселении.'
    },
    {
      q: 'Можно ли взыскать компенсацию, если меня не пускали в жильё?',
      a: 'Да. Если один собственник единолично пользовался всей квартирой и препятствовал второму совладельцу, с него можно взыскать плату за фактическое пользование долей за весь доказанный период чинения препятствий.'
    }
  ];
  ...
  const jsonLdGraph = {
    ...
    '@graph': [
      ...
      },
      {
        ...
        name: 'Вселение и устранение препятствий в пользовании квартирой в Липецке',
        serviceType: 'Юридическая помощь по вселению и определению порядка пользования жильём',
  ...
  const situations = [
    {
      tag: 'Смена замков',
      title: 'Сменили замки во входной двери и не передают дубликат',
      desc: 'Зафиксируем факт чинения препятствий, направим досудебную претензию и добьёмся принудительной выдачи ключей.'
    },
    {
      tag: 'Конфликт совладельцев',
      title: <>Второй собственник не пускает <br />в квартиру и угрожает</>,
      desc: 'Защитим законное право собственности, организуем фиксацию правонарушений и подадим иск о вселении.'
    },
    {
      tag: 'Раздел комнат',
      title: 'Нужно выделить конкретную комнату для проживания',
      desc: 'Определим порядок пользования жилым помещением в суде с закреплением изолированных комнат за каждым собственником.'
    },
    {
      tag: 'Развод супругов',
      title: 'Бывший супруг препятствует проживанию и пользованию вещами',
      desc: 'Пресечём самоуправство, обеспечим законный доступ в жилое помещение и защитим имущественные права доверителя.'
    },
    {
    ...
    {
      tag: 'Встречный иск',
      title: 'В ответ на требование о вселении вам предъявили иск о выселении',
      desc: 'Выстроим доказательственную базу сохранения права пользования и докажем вынужденный характер отсутствия.'
    }
  ];

  const helpActions = [
    {
      title: <>Правовой анализ документов и объекта</>,
      desc: 'Проверяем основания возникновения права, размер долей, технический паспорт, число и метраж изолированных комнат.'
    },
    {
      title: <>Фиксация чинения препятствий</>,
      desc: 'Организуем обращение к участковому уполномоченному полиции, собираем свидетельские показания, видеозаписи и переписку.'
    },
    {
      title: <>Досудебная претензия и переговоры</>,
      desc: 'Направляем письменное требование о предоставлении ключей и предлагаем согласовать порядок пользования комнатами.'
    },
    {
      title: <>Иск о вселении и порядке пользования</>,
      desc: 'Формулируем комплексные исковые требования о вселении, обязании выдать ключи и закреплении конкретных жилых комнат.'
    },
    {
      title: <>Судебное представительство</>,
      desc: 'Участвуем во всех заседаниях районного суда, опровергаем доводы ответчика о добровольном отказе от проживания.'
    },
    {
      title: <>Исполнение решения с приставами</>,
      desc: 'Получаем исполнительный лист, возбуждаем исполнительное производство и сопровождаем фактическое вселение с приставом.'
    }
  ];
  ...
  return (
    <main>
      ...
      {/* ═══ 1. ПЕРВЫЙ ЭКРАН ═══ */}
      <div onClickCapture={() => handleCtaClick('housing_vselenie_hero', 'Обсудить вселение в квартиру')}>
        <MilitaryHero 
          breadcrumbs={
            <>
              ...
              <span style={{ color: 'var(--color-text-main)' }}>Вселение и устранение препятствий</span>
            </>
          }
          ...
          primaryCtaText="Обсудить вселение в квартиру"
          primaryCtaLink="#form"
          primaryCtaAnalytics="housing_vselenie_consultation_click"
          ...
          rightContent={
            <div style={{ display: 'flex', justifyContent: 'center', position: 'relative', width: '100%' }}>
              ...
              <svg style={{ position: 'absolute', top: '40%', left: '85%', transform: 'translate(-50%, -50%)', width: '600px', height: '600px', opacity: 0.09, zIndex: 0, pointerEvents: 'none' }} viewBox="0 0 24 24" fill="none" stroke="var(--color-primary)" strokeWidth="0.6">
                <path d="M21 2l-2 2m-1.5 1.5L4 19l-2 3 3-2 13.5-13.5z M14.5 5.5l4 4"/>
              </svg>
                  ...
                  <div className="doc-sheet doc-sheet-3">
                    <div style={{ padding: '35px 25px', position: 'relative', height: '100%', display: 'flex', flexDirection: 'column' }}>
                      <div style={{ position: 'absolute', top: '25px', left: '25px', width: '85px', height: '25px', border: '1.5px solid rgba(23, 50, 77, 0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', transform: 'rotate(-5deg)' }}>
                        <span style={{ fontSize: '4.5px', fontWeight: 'bold', color: 'rgba(23,50,77,0.5)', fontFamily: 'var(--font-serif)' }}>АКТ О ВСЕЛЕНИИ (ФССП)</span>
                      </div>
                    ...
                    <div style={{ padding: '28px 22px', position: 'relative', height: '100%', display: 'flex', flexDirection: 'column' }}>
                      ...
                      <div style={{ marginTop: 'auto', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', paddingTop: '8px', borderTop: '1px dashed rgba(23,50,77,0.15)' }}>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '3px' }}>
                          <div style={{ fontSize: '5px', color: 'rgba(23,50,77,0.6)', fontFamily: 'var(--font-sans)' }}>Истец (собственник):</div>
                    ...
                    <div style={{ padding: '26px 22px', position: 'relative', height: '100%', display: 'flex', flexDirection: 'column' }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid rgba(23,50,77,0.2)', paddingBottom: '10px', marginBottom: '14px' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '3px', alignItems: 'flex-end' }}>
                          <span style={{ fontSize: '6px', fontWeight: 'bold', color: 'var(--color-deep-blue)', letterSpacing: '0.05em' }}>ВСЕЛЕНИЕ В КВАРТИРУ</span>
                      ...
                      <div className="doc-map-box" style={{ 
                        ...
                        <div style={{ fontSize: '7px', fontWeight: 'bold', color: 'var(--color-deep-blue)', marginBottom: '4px' }}>ТРЕБОВАНИЯ В СУД:</div>
                        <div style={{ fontSize: '6px', color: 'var(--color-text-secondary)', lineHeight: 1.4 }}>
                          1. Вселить истца в жилое помещение<br/>
                          2. Обязать ответчика выдать дубликат ключей<br/>
                          3. Обязать не чинить препятствий в пользовании
                        </div>
                      </div>
                      ...
                      <div style={{ marginTop: 'auto', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', paddingTop: '8px', borderTop: '1px solid rgba(23,50,77,0.15)' }}>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
                          ...
                          <div style={{ fontSize: '5px', color: 'rgba(23,50,77,0.6)', fontFamily: 'var(--font-sans)' }}>Защита права пользования жильём</div>
                        </div>
          ...
          trustItems={[
            { text: 'Зафиксируем факт чинения препятствий' },
            { text: 'Добьёмся судебного решения о вселении' },
            { text: 'Сопроводим фактический въезд с приставами' }
          ]}
        />
      </div>
      ...
      <section className="section bg-white" id="situations" style={{ padding: '80px 0' }}>
        <div className="container">
          ...
          {/* CTA-плашка с атрибуцией cta_source = housing_vselenie_banner */}
          <div 
          ...
          >
            <div style={{ flex: '1 1 300px' }}>
              ...
              <p style={{ margin: '0', fontSize: '15px', color: 'rgba(255,255,255,0.85)', lineHeight: 1.5, maxWidth: '640px' }}>
                Самовольное вскрытие замков может привести к встречным заявлениям и осложнить доказывание. Безопаснее зафиксировать право на жильё и факт недопуска, обратиться в суд, а после решения провести вселение с участием судебного пристава.
              </p>
            </div>
      ...
      <section className="section" style={{ padding: '80px 0', background: 'var(--gradient-cream)' }}>
        <div className="container">
          <div style={{ maxWidth: '850px', marginBottom: '48px' }}>
            ...
            <p style={{ fontSize: '16px', color: 'var(--color-deep-blue)', opacity: 0.9, fontWeight: 500, margin: 0, lineHeight: 1.6 }}>
              Обеспечиваем комплексную защиту: от официальной <br />фиксации нарушений до реального получения ключей.
            </p>
          </div>
      ...
      {/* ═══ 4. ПРАКТИКА ═══ */}
      <CasesBlock 
        title={<>Практика по вселению и устранению <br />препятствий в пользовании жильём</>}
        showDemoWarning={false}
        resultLabel="Ключевой результат"
        cases={[
          {
            category: "ВСЕЛЕНИЕ СОБСТВЕННИКА",
            title: "Вселили собственника 1/2 доли и обязали выдать дубликаты ключей",
            problem: "После развода бывшая жена сменила замок в трёхкомнатной квартире и отказывалась пускать доверителя, утверждая, что он проживает у родителей.",
            action: "Зафиксировали обращения в полицию о чинении препятствий, доказали отсутствие другого жилья в собственности и заявили иск о вселении и передаче ключей.",
            result: "Суд обязал ответчицу передать комплект ключей и не чинить препятствий в пользовании жильём. Доверитель вселился с участием судебного пристава.",
            isDemo: false
          },
          {
            category: "ПОРЯДОК ПОЛЬЗОВАНИЯ",
            title: "Определили порядок пользования двухкомнатной квартирой между наследниками",
            problem: "Брат и сестра унаследовали квартиру по 1/2 доле. Брат занял обе комнаты и препятствовал сестре в проживании.",
            action: "Проанализировали планировку, доказали возможность выделения изолированных комнат (18 м² и 14 м²) и заявили требование об определении порядка пользования.",
            result: "Суд закрепил за доверительницей отдельную комнату, обязал освободить её от чужих вещей и передать ключи от входной двери.",
            isDemo: false
          },
          {
            category: "ВЗЫСКАНИЕ КОМПЕНСАЦИИ",
            title: "Взыскали компенсацию за невозможность пользования 1/4 долей в однокомнатной квартире",
            problem: "Доверителю принадлежала 1/4 доля в однокомнатной квартире. Вселиться физически было невозможно из-за единственной жилой комнаты.",
            action: "Обосновали невозможность реального пользования и заявили иск о взыскании ежемесячной компенсации со второго собственника соразмерно рыночной аренде.",
            result: "Суд взыскал со второго собственника компенсацию за прошедшие 2 года и установил ежемесячные выплаты на будущее время.",
            isDemo: false
          }
        ]}
      />
      ...
      <ProcessBlock 
        ...
        steps={[
          ...
          { num: '03', title: 'Претензия ответчику', desc: 'Направляем письменное требование о добровольной выдаче ключей и мирном разделе комнат.' },
          { num: '04', title: 'Судебный процесс', desc: 'Представляем интересы в суде, добиваемся вынесения решения о вселении и порядке пользования.' },
          { num: '05', title: 'Вселение с приставами', desc: 'Сопровождаем процедуру принудительного вселения и вручения ключей через службу судебных приставов.' }
        ]}
      />
      ...
      <div onClickCapture={(e) => {
        ...
        if (btn) {
          ...
          if (text.includes('Получить расчёт')) {
            handleCtaClick('housing_vselenie_price_total', 'Получить расчёт стоимости');
          } else {
            handleCtaClick('housing_vselenie_price_tier', text);
          }
        }
      }}>
        <PricingBlock 
          title="Стоимость юридической помощи"
          subtitle="Судебные расходы на услуги представителя взыскиваются с ответчика."
          tiers={[
            {
              title: <>Консультация и фиксация</>,
              subtitle: 'Первичный этап',
              popular: false,
              price: 'от ХХХ ₽',
              features: [
                { name: 'Анализ документов на жилое помещение', value: '✓' },
                { name: 'Алгоритм фиксации препятствий для полиции', value: '✓' },
                { name: 'Досудебная претензия о передаче ключей', value: '✓' }
              ],
              buttonText: 'Записаться на консультацию',
              buttonHref: '#form'
            },
            {
              title: <>Иск о вселении под ключ</>,
              subtitle: 'Судебная защита',
              popular: true,
              badgeText: 'ВОСТРЕБОВАНО',
              price: 'от ХХХ ₽',
              features: [
                { name: 'Составление иска о вселении и порядке комнат', value: '✓' },
            ...
            {
              title: <>Вселение с приставами</>,
              subtitle: 'Исполнение решения',
              popular: false,
              price: 'от ХХХ ₽',
              features: [
                { name: 'Получение исполнительного листа', value: '✓' },
                { name: 'Взаимодействие с судебными приставами', value: '✓' },
                { name: 'Выезд на фактическое вселение и передачу ключей', value: '✓' }
              ],
          ...
          ctaSubtitle="Изучим ситуацию и предложим надёжный план возврата законного доступа в квартиру."
          ...
          <div className="grid grid-2" style={{ gap: '60px', alignItems: 'stretch' }}>
            <div style={{ display: 'flex', flexDirection: 'column', height: '100%', justifyContent: 'flex-start', paddingTop: 0 }}>
              ...
              <h2 style={{ fontSize: '36px', fontFamily: 'var(--font-serif)', color: 'var(--color-deep-blue)', marginBottom: '16px', lineHeight: 1.2, marginTop: 0, textWrap: 'balance' }}>
                Обсудите вселение в квартиру с юристом
              </h2>
              
              <p style={{ color: 'var(--color-deep-blue)', opacity: 0.9, fontWeight: 500, fontSize: '16px', lineHeight: 1.6, marginBottom: '24px', textWrap: 'balance' }}>
                Опишите ситуацию: кто препятствует доступу, сменили ли замки, кому принадлежит жильё и какие документы у вас есть. Юрист свяжется с вами для выработки плана.
              </p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', height: '100%', justifyContent: 'center' }}>
              <div style={{ background: 'var(--gradient-cream)', padding: '40px', borderRadius: '0', boxShadow: '0 8px 24px rgba(0,0,0,0.15)', width: '100%', border: '1px solid rgba(0,0,0,0.06)' }}>
                <ContactsForm 
                  ...
                  commentPlaceholder="Например: совладелец сменил замки, не пускает в квартиру, нужно вселиться и получить ключи…"
                  subtext="Если вы оставите заявку вечером или в выходной день, мы перезвоним в ближайший рабочий день."
                  hiddenFields={[
                    { name: 'pageId', value: 'CIV-HOUSING-VSELENIE' },
                    { name: 'pageTitle', value: 'Вселение и устранение препятствий в Липецке' },

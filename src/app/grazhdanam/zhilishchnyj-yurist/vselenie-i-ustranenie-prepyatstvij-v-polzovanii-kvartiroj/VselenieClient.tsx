...
export default function VselenieClient() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'Суд закрепляет за каждым собственником конкретные изолированные жилые комнаты соразмерно их долям, а места общего пользования (кухня, санузел, коридор) остаются в совместном пользовании.'
    },
    {
  ...
  const helpActions = [
    ...
    },
    {
      ...
      desc: 'Направляем письменное требование о предоставлении ключей и предлагаем вариант добровольного раздела комнат.'
    },
    {

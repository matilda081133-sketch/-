...
export default function VyselenieClient() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'Да, если квартира принадлежит другому супругу, бывший супруг не является собственником и право проживания не сохранено соглашением. Суд дополнительно проверяет основание вселения и обстоятельства пользования жильём: в отдельных случаях право может быть сохранено на определённый срок, а для лиц, отказавшихся от приватизации, действуют особые правила.'
    },
    {
      q: 'Чьи жилищные права требуют особой проверки перед обращением в суд?',
      a: 'Повышенной защитой могут пользоваться лица, отказавшиеся от участия в приватизации, несовершеннолетние, получатели ренты и лица с правом проживания по завещательному отказу. Но вывод зависит от основания вселения, фактического проживания, добровольности и постоянства выезда, наличия препятствий и других обстоятельств. Поэтому универсального перечня тех, кого невозможно снять с регистрационного учёта при любых условиях, нет.'
    },
    {
    ...
    },
    {
      ...
      a: 'В суд подаётся исковое заявление о признании гражданина не приобретшим право пользования жилым помещением. В суде доказывается, что человек никогда фактически не вселялся и не перевозил в квартиру личные вещи.'
    },
    {
    ...
    <main>
        ...
        <div className="container">
          <div style={{ maxWidth: '960px', marginBottom: '44px' }}>
            <h2 className="with-accent" style={{ fontSize: 'clamp(24px, 3.2vw, 36px)', fontFamily: 'var(--font-serif)', color: 'var(--color-primary)', marginBottom: '16px', marginTop: 0 }}>
              С какими спорами о выписке и выселении мы помогаем
            </h2>
      ...
      <section className="section" style={{ padding: '80px 0', background: 'var(--gradient-cream)' }}>
        <div className="container">
          <div style={{ maxWidth: '900px', marginBottom: '48px' }}>
            ...
            <p style={{ fontSize: '16px', color: 'var(--color-deep-blue)', opacity: 0.9, fontWeight: 500, margin: 0, lineHeight: 1.6 }}>
              Полностью берём на себя судебный процесс — от сбора доказательств <br />до подтверждения снятия гражданина с регистрационного учёта.
            </p>
          </div>
      ...
      <ProcessBlock 
        ...
        steps={[
          ...
          { num: '04', title: 'Судебные заседания', desc: 'Представляем вашу позицию в районном суде до вынесения решения; при необходимости готовим позицию для его обжалования.' },
          { num: '05', title: 'Выписка в МВД', desc: 'Передаём вступившее в законную силу решение суда в подразделение по вопросам миграции МВД, сопровождаем снятие гражданина с регистрационного учёта и при необходимости запрашиваем актуальную адресную справку.' }
        ]}
      />

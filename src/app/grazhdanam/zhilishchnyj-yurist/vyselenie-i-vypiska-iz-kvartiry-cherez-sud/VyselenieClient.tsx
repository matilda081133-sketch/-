...
export default function VyselenieClient() {
  ...
  const situations = [
    ...
    },
    {
      ...
      title: 'Человек незаконно проживает в квартире и отказывается освободить её',
    ...
    <main>
      ...
      <div onClickCapture={() => handleCtaClick('housing_vyselenie_hero', 'Выписать человека через суд')}>
        <MilitaryHero 
          ...
          title={<>Выселение и выписка из квартиры <br />через суд в Липецке</>}
          subtitle={
      ...
      <section className="section" style={{ padding: '80px 0', background: 'var(--gradient-cream)' }}>
        <div className="container">
          <div style={{ maxWidth: '750px', marginBottom: '48px' }}>
            ...
            <p style={{ fontSize: '16px', color: 'var(--color-deep-blue)', opacity: 0.9, fontWeight: 500, margin: 0, lineHeight: 1.6 }}>
              Полностью берём на себя судебный процесс — от сбора доказательств до получения обновлённой выписки из домовой книги.
            </p>
          </div>

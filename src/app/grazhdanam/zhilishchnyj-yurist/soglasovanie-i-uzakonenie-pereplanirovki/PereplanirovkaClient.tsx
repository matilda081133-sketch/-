...
export default function PereplanirovkaClient() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'Если работы уменьшают общее имущество или присоединяют его часть к помещению, требуется согласие всех собственников дома. Для других решений, связанных с использованием общего имущества, количество голосов зависит от предмета решения и норм ЖК РФ. Обычная перепланировка внутри квартиры, не затрагивающая общее имущество и границы других помещений, согласия всех собственников дома не требует.'
    },
    {
  ...
  const situations = [
    ...
    },
    {
      ...
      desc: 'Организуем подготовку технического плана и внесение актуальных сведений в ЕГРН, чтобы документы соответствовали фактической планировке и не препятствовали сделке, ипотеке или оформлению наследства.'
    },
    {
  ...
  const helpActions = [
    ...
    },
    {
      ...
      desc: 'Взаимодействуем с профильными проектировщиками и техническими специалистами. Если характер работ требует участия члена СРО, проверяем соответствующий допуск.'
    },
    {
      title: <>Согласование в администрации Липецка</>,
      desc: 'Формируем комплект документов и сопровождаем получение решения о согласовании через департамент жилищно-коммунального хозяйства города Липецка.'
    },
    {
      title: <>Судебное узаконение самовольных работ</>,
      desc: 'Составляем иск о сохранении помещения в перепланированном состоянии, привлекаем экспертов и доказываем наличие предусмотренных законом оснований для сохранения выполненных изменений.'
    },
    {
    ...
    },
    {
      ...
      desc: 'Кадастровый инженер подготавливает технический план, на основании которого актуальные сведения о квартире вносятся в ЕГРН.'
    }
  ];
    ...
    <main>
      ...
      <div onClickCapture={() => handleCtaClick('housing_pereplan_hero', 'Узаконить перепланировку')}>
        <MilitaryHero 
          ...
          trustItems={[
            ...
            { text: 'Организуем подготовку проектной документации у профильных специалистов' },
      ...
      <section className="section bg-white" id="situations" style={{ padding: '80px 0' }}>
        <div className="container">
          ...
          {/* CTA-плашка с атрибуцией cta_source = housing_pereplan_banner */}
          <div 
          ...
          >
            <div style={{ flex: '1 1 300px' }}>
              <h3 style={{ margin: '0 0 8px 0', fontSize: '20px', fontFamily: 'var(--font-serif)', color: 'var(--color-white)', lineHeight: 1.3 }}>
                Когда возникает риск продажи квартиры с публичных торгов
              </h3>
              <p style={{ margin: '0', fontSize: '15px', color: 'rgba(255,255,255,0.85)', lineHeight: 1.5, maxWidth: '640px' }}>
                Если суд не сохраняет помещение в изменённом состоянии, орган согласования устанавливает срок для возврата в прежнее состояние. При неисполнении этого требования он вправе обратиться в суд с иском о продаже квартиры с публичных торгов.
              </p>
            </div>

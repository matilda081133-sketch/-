...
export const metadata = {
  ...
  description: 'Проверим основания и документы, определим административный или судебный порядок оформления права на земельный участок в Липецке и сопроводим регистрацию. 📞 +7 (4742) 20-15-25.',
  alternates: {

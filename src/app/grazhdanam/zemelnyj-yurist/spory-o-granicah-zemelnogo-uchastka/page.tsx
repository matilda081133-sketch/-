...
export const metadata = {
  ...
  description: 'Юридическая помощь при наложении границ, реестровой ошибке, захвате части участка и споре с соседом в Липецке. Анализ документов, переговоры и представительство в суде. 📞 +7 (4742) 20-15-25.',
  alternates: {
  ...
  twitter: {
    ...
    title: 'Юрист по спорам о границах земельного участка в Липецке | Де-Юре',
    description: 'Юридическая помощь при наложении границ, реестровой ошибке, захвате части участка и споре с соседом в Липецке. 📞 +7 (4742) 20-15-25.',

      ...
      <section className="section bg-white" style={{ padding: '80px 0' }}>
        <div className="container">
          <div style={{ maxWidth: '750px', marginBottom: '40px' }}>
            ...
            <p style={{ fontSize: '16px', color: 'var(--color-deep-blue)', opacity: 0.9, fontWeight: 500, margin: 0, lineHeight: 1.6 }}>
              Если вопрос связан не только с расположением границы, но и с разделом участка, доступом к нему или оформлением права, может потребоваться другая услуга. Все направления помощи собраны в разделе «Земельный юрист».
            </p>
          </div>

          <div className="grid grid-3" style={{ gap: '24px', marginBottom: '40px' }}>
            {relatedServices.map((serv, i) => (
              <a key={i} href={serv.link} style={{ textDecoration: 'none', display: 'block' }}>
          ...
          <div style={{ textAlign: 'center' }}>
            <a href="/grazhdanam/zemelnyj-yurist/" style={{ fontSize: '16px', fontWeight: 600, color: 'var(--color-primary)', textDecoration: 'underline' }}>

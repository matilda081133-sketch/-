...
export const metadata: Metadata = {
  ...
  description: 'Помощь семейного юриста в Липецке: развод через суд, раздел имущества, алименты, споры о детях, отцовство, родительские права и брачный договор. 📞 +7 (4742) 20-15-25.',
  alternates: {

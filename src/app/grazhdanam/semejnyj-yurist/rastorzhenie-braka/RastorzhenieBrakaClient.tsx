...
export default function RastorzhenieBrakaClient() {
  ...
  const pricingTiers: PricingTier[] = [
    {
      title: 'Консультация по расторжению брака',
      subtitle: 'Устный разбор порядка развода и дальнейших действий.',
      price: '2 000 ₽',
      priceUnit: 'за консультацию до 1 часа',
      features: [
        { name: 'разбор обстоятельств расторжения брака', value: '' },
        { name: 'ответы на вопросы о судебном порядке', value: '' },
        { name: 'рекомендации по дальнейшим действиям', value: '' }
      ],
      exclusions: 'Изучение документов и подготовка заявления не входят.',
      buttonText: 'Записаться на консультацию',
      buttonHref: '#form'
    },
    {
      title: 'Заявление о расторжении брака',
      subtitle: 'Подготовка заявления для обращения в суд.',
      price: 'от 10 000 ₽',
      priceUnit: 'за один документ',
      features: [
        { name: 'подготовка заявления о расторжении брака', value: '' },
        { name: 'оформление одного процессуального документа', value: '' },
        { name: 'срок подготовки — от 3 рабочих дней', value: '' }
      ],
      exclusions: 'Подача заявления и представительство в суде не входят.',
      buttonText: 'Заказать заявление',
      buttonHref: '#form'
    },
    {
      title: 'Представительство по делу о разводе',
      ...
      exclusions: 'Заявление и другие письменные документы оплачиваются отдельно. Последующее заседание — от 10 000 ₽.',

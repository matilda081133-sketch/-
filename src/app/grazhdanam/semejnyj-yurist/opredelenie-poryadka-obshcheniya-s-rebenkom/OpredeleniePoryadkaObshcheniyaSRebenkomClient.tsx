...
export default function OpredeleniePoryadkaObshcheniyaSRebenkomClient() {
  ...
  const pricingTiers: PricingTier[] = [
    {
      title: 'Консультация по порядку общения',
      subtitle: 'Устный разбор ситуации и возможных вариантов действий.',
      price: '2 000 ₽',
      priceUnit: 'за консультацию до 1 часа',
      features: [
        { name: 'разбор обстоятельств общения с ребёнком', value: '' },
        { name: 'ответы на вопросы клиента', value: '' },
        { name: 'рекомендации по дальнейшим действиям', value: '' }
      ],
      exclusions: 'Изучение документов, график общения и другие документы не входят.',
      buttonText: 'Записаться на консультацию',
      buttonHref: '#form'
    },
    {
      title: 'Переговоры о порядке общения',
      subtitle: 'Участие юриста в переговорах между родителями.',
      price: 'от 15 000 ₽',
      ...
      exclusions: 'Составление соглашения и дальнейшие переговоры оплачиваются отдельно.',
      buttonText: 'Обсудить переговоры',
      buttonHref: '#form'
    },
    {
      title: 'Иск об определении порядка общения',
      ...
      exclusions: 'Сбор доказательств и представительство не входят.',
      buttonText: 'Заказать иск',
      buttonHref: '#form'
    },
    {
      title: 'Представительство в споре об общении',
      ...
      exclusions: 'Иск и другие письменные документы не входят. Последующее заседание — от 10 000 ₽.',
  ...
  return (
    <main>
      ...
      <PricingBlock
        title="Стоимость услуг по определению порядка общения"
        subtitle="Можно начать с консультации или переговоров, а при необходимости заказать иск и представительство в суде."
        pageUrl="https://dejure-help.ru/grazhdanam/semejnyj-yurist/opredelenie-poryadka-obshcheniya-s-rebenkom/"
        tiers={pricingTiers}
        ctaTitle=""

...
export const metadata: Metadata = {
  ...
  description: 'Помощь юриста по алиментам в Липецке: взыскание в долях или твёрдой сумме, изменение размера, задолженность, неустойка и представительство в суде. 📞 +7 (4742) 20-15-25.',
  alternates: {

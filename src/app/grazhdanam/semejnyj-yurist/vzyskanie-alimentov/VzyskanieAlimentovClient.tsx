...
export default function VzyskanieAlimentovClient() {
  const cases: CaseData[] = [
    {
        ...
        "title": "Увеличили алименты с 4 500 руб. до 28 000 руб. в месяц",
    ...
    },
    {
        ...
        "title": "Взыскали 850 000 рублей задолженности и 420 000 рублей неустойки",
    ...
    },
    {
        ...
        "title": "Взыскали алименты на ребёнка и ежемесячное содержание матери",
  ...
  const jsonLd = {
    ...
    '@graph': [
      ...
      {
        '@type': 'Service',
        'name': 'Взыскание алиментов в Липецке — помощь юриста | Де-Юре',
      ...
      <MilitaryHero
        ...
        title={
          <span style={{ display: 'block' }}>
            ...
            <span className="hero-title-span-mobile" style={{ display: 'block', whiteSpace: 'nowrap' }}>
              алиментов на ребёнка в Липецке
            </span>
          </span>
        }
        subtitle={
            ...
            <div>
              <div style={{ background: 'var(--color-white)', padding: '40px', border: '1px solid var(--color-border)', borderTop: '4px solid var(--color-primary)', boxShadow: '0 12px 40px rgba(23, 50, 77, 0.08)' }}>
                <ContactsForm 
                  ...
                  hiddenFields={[
                    { name: 'service', value: 'Взыскание алиментов в Липецке — помощь юриста | Де-Юре' },
                    { name: 'category', value: 'semejnyj-yurist/vzyskanie-alimentov' },

  ...
  const pricingTiers: PricingTier[] = [
    {
      ...
      subtitle: 'Подготовка заявления для бесспорного взыскания алиментов.',
      price: 'от 10 000 ₽',
      priceUnit: 'за один документ',
      features: [
        { name: 'подготовка заявления о выдаче судебного приказа', value: '' },
        { name: 'оформление одного процессуального документа', value: '' },
        { name: 'срок подготовки — от 3 рабочих дней', value: '' }
      ],
      exclusions: 'Подача заявления и исполнительное производство не входят.',
      buttonText: 'Заказать заявление',
      buttonHref: '#form'
    },
    {
      title: 'Иск о взыскании или изменении алиментов',
      subtitle: 'Подготовка искового заявления для рассмотрения спора.',
      price: 'от 10 000 ₽',
      priceUnit: 'за один документ',
      features: [
      ...
      exclusions: 'Расчёты, сбор доказательств и представительство оплачиваются отдельно.',
      buttonText: 'Заказать иск',
      buttonHref: '#form'
    },
    {
      title: 'Представительство по алиментному спору',

...
export const metadata: Metadata = {
  ...
  description: 'Юридическая помощь по брачному договору в Липецке: составление, проверка, изменение, расторжение и оспаривание. Подготовка к нотариальному удостоверению. 📞 +7 (4742) 20-15-25.',
  alternates: {

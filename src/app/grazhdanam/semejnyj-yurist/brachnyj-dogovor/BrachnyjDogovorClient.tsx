...
export default function BrachnyjDogovorClient() {
  ...
  const pricingTiers: PricingTier[] = [
    {
      title: 'Анализ проекта брачного договора',
      subtitle: 'Правовая оценка готового проекта или пакета документов.',
      price: 'от 10 000 ₽',
      priceUnit: 'за документ или пакет',
      features: [
        { name: 'правовая оценка представленного договора', value: '' },
        { name: 'проверка условий по представленным материалам', value: '' },
        { name: 'устные рекомендации по результатам анализа', value: '' }
      ],
      exclusions: 'Письменное заключение, редактирование и новый договор не входят.',
      buttonText: 'Проверить договор',
      buttonHref: '#form'
    },
    {
      title: 'Разработка брачного договора',
      subtitle: 'Подготовка индивидуального проекта договора.',
      price: 'от 30 000 ₽',
      priceUnit: 'за один сложный договор',
      features: [
        { name: 'подготовка одного проекта брачного договора', value: '' },
        { name: 'разработка условий по согласованной задаче', value: '' },
        { name: 'срок подготовки — от 10 рабочих дней', value: '' }
      ],
      exclusions: 'Нотариальный тариф, переговоры и последующие изменения оплачиваются отдельно.',
      buttonText: 'Заказать договор',
      buttonHref: '#form'
    },
    {
      title: 'Изменение проекта договора',
      subtitle: 'Анализ и внесение правок в существующий текст.',
      price: 'от 15 000 ₽',
      priceUnit: 'за один документ',
      features: [
        { name: 'анализ проекта договора', value: '' },
        { name: 'подготовка правок', value: '' },
        { name: 'редактирование одного документа', value: '' }
      ],
      exclusions: 'Разработка нового договора и нотариальные услуги не входят.',
      buttonText: 'Заказать правки',
      buttonHref: '#form'
    }
  ];
  ...
  const jsonLd = {
    ...
    '@graph': [
      ...
      {
        '@type': 'BreadcrumbList',
        '@id': 'https://dejure-help.ru/grazhdanam/semejnyj-yurist/brachnyj-dogovor/#breadcrumbs',
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 4, 'name': 'Брачный договор', 'item': 'https://dejure-help.ru/grazhdanam/semejnyj-yurist/brachnyj-dogovor/' }
        ]
      },
      {
        '@type': 'Service',
        '@id': 'https://dejure-help.ru/grazhdanam/semejnyj-yurist/brachnyj-dogovor/#service',
      ...
      {
        '@type': 'FAQPage',
        '@id': 'https://dejure-help.ru/grazhdanam/semejnyj-yurist/brachnyj-dogovor/#faq',

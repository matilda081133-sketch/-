  ...
  const cases: CaseData[] = [
    {
        ...
        "title": "Оспорили отцовство через суд и освободили мужчину от чужих алиментов",
    ...
    },
    {
        ...
        "title": "Установили отцовство и взыскали алименты при уклонении отца от ДНК",
    ...
    },
    {
        ...
        "title": "Установили факт отцовства после гибели отца и оформили выплаты",
            ...
            <div>
              <div style={{ background: 'var(--color-white)', padding: '40px', border: '1px solid var(--color-border)', borderTop: '4px solid var(--color-primary)', boxShadow: '0 12px 40px rgba(23, 50, 77, 0.08)' }}>
                <ContactsForm 
                  ...
                  hiddenFields={[
                    { name: 'service', value: 'Установление и оспаривание отцовства в Липецке | Де-Юре' },
                    { name: 'category', value: 'semejnyj-yurist/ustanovlenie-i-osparivanie-ottsovstva' },

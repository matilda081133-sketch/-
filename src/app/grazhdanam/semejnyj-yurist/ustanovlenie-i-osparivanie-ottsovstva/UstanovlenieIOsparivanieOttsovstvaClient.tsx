...
export default function UstanovlenieIOsparivanieOttsovstvaClient() {
  ...
  const pricingTiers: PricingTier[] = [
    {
      title: 'Анализ документов и перспектив дела',
      subtitle: 'Правовая оценка представленных материалов и обстоятельств.',
      price: 'от 15 000 ₽',
      priceUnit: 'за анализ дела',
      features: [
        { name: 'рассмотрение представленных документов', value: '' },
        { name: 'правовой анализ обстоятельств', value: '' },
        { name: 'оценка правовой ситуации', value: '' }
      ],
      exclusions: 'Проведение ДНК-экспертизы, письменное заключение и дальнейшая работа не входят.',
      buttonText: 'Заказать анализ',
      buttonHref: '#form'
    },
    {
      title: 'Иск об установлении или оспаривании отцовства',
      subtitle: 'Подготовка одного искового заявления.',
      price: 'от 10 000 ₽',
      priceUnit: 'за один документ',
      features: [
        { name: 'подготовка искового заявления', value: '' },
        { name: 'оформление одного процессуального документа', value: '' },
        { name: 'срок подготовки — от 3 рабочих дней', value: '' }
      ],
      exclusions: 'Ходатайства, экспертиза и представительство оплачиваются отдельно.',
      buttonText: 'Заказать иск',
      buttonHref: '#form'
    },
    {
      title: 'Представительство в суде',
      subtitle: 'Участие юриста в суде первой инстанции.',
      price: 'от 40 000 ₽',
      priceUnit: 'до 3 судебных заседаний',
      features: [
        { name: 'участие в предварительных заседаниях', value: '' },
        { name: 'участие в основных заседаниях', value: '' },
        { name: 'представление позиции клиента', value: '' }
      ],
      exclusions: 'Иск, ходатайства и экспертиза не входят. Последующее заседание — от 10 000 ₽.',
  ...
  const steps: ProcessStep[] = [
    {
      ...
      title: (
        <>
          ...
          <span className="hero-title-span-mobile" style={{ display: 'block', whiteSpace: 'nowrap' }}>необходимую процедуру</span>
        </>
      ),
      desc: 'Устанавливаем, требуется ли иск об установлении или оспаривании отцовства либо особое производство после смерти предполагаемого отца.'
    },
    {
      num: '02',
      title: (
      ...
      desc: 'Анализируем актовую запись, переписку, фотографии, переводы денег, свидетельские показания и другие подтверждения отношений.'
    },
    {
      num: '03',
      title: (
      ...
      desc: 'Составляем иск или заявление, определяем участников дела и формулируем вопросы для генетической экспертизы.'
    },
    {
      num: '04',
      title: (
        <>
          <span className="hero-title-span-mobile" style={{ display: 'block', whiteSpace: 'nowrap' }}>Сопровождаем экспертизу</span>{' '}
          <span className="hero-title-span-mobile" style={{ display: 'block', whiteSpace: 'nowrap' }}>и судебный процесс</span>
        </>
      ),
      desc: 'Заявляем ходатайства, оцениваем заключение эксперта и представляем интересы клиента в заседаниях.'
    },
    {
      num: '05',
      title: (
      ...
      desc: 'Сопровождаем изменение актовой записи ЗАГС. При необходимости отдельно решаем вопросы алиментов, наследства или пенсии по потере кормильца.'
    },
    {
      isBanner: true,
      title: 'Работаем дистанционно',
      desc: 'Первичная оценка документов и подготовка позиции могут пройти дистанционно.'
    }
  ];
  ...
  const jsonLd = {
    ...
    '@graph': [
      ...
      {
        '@type': 'BreadcrumbList',
        '@id': 'https://dejure-help.ru/grazhdanam/semejnyj-yurist/ustanovlenie-i-osparivanie-ottsovstva/#breadcrumbs',
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 4, 'name': 'Установление и оспаривание отцовства', 'item': 'https://dejure-help.ru/grazhdanam/semejnyj-yurist/ustanovlenie-i-osparivanie-ottsovstva/' }
        ]
      },
      {
        '@type': 'Service',
        '@id': 'https://dejure-help.ru/grazhdanam/semejnyj-yurist/ustanovlenie-i-osparivanie-ottsovstva/#service',
        'url': 'https://dejure-help.ru/grazhdanam/semejnyj-yurist/ustanovlenie-i-osparivanie-ottsovstva/',
        'name': 'Установление и оспаривание отцовства',
      ...
      {
        '@type': 'FAQPage',
        '@id': 'https://dejure-help.ru/grazhdanam/semejnyj-yurist/ustanovlenie-i-osparivanie-ottsovstva/#faq',
          ...
          <div className="grid grid-2" style={{ gap: '60px', alignItems: 'stretch' }}>
            <div style={{ display: 'flex', flexDirection: 'column', height: '100%', justifyContent: 'flex-start' }}>
              ...
              <h2 style={{ fontSize: '36px', fontFamily: 'var(--font-serif)', color: 'var(--color-deep-blue)', marginBottom: '16px', lineHeight: 1.2, marginTop: 0, textWrap: 'balance' }}>
                ...
                <span className="hero-title-span-mobile" style={{ display: 'block', whiteSpace: 'nowrap' }}>об отцовстве с юристом</span>
              </h2>
              <p style={{ color: 'var(--color-deep-blue)', opacity: 0.9, fontWeight: 500, fontSize: '16px', lineHeight: 1.6, marginBottom: '24px', textWrap: 'balance' }}>
                Укажите, кто записан отцом ребёнка, требуется установить или оспорить отцовство, проводился ли ДНК-тест и есть ли другие судебные требования. Юрист определит подходящую процедуру и необходимые доказательства.
              </p>

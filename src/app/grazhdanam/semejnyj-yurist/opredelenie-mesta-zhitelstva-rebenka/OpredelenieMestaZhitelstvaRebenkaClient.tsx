...
export default function OpredelenieMestaZhitelstvaRebenkaClient() {
  ...
  const pricingTiers: PricingTier[] = [
    {
      title: 'Анализ документов и перспектив спора',
      subtitle: 'Правовая оценка представленных документов и обстоятельств.',
      price: 'от 15 000 ₽',
      priceUnit: 'за анализ дела',
      features: [
        { name: 'рассмотрение представленных документов', value: '' },
        { name: 'правовой анализ обстоятельств спора', value: '' },
        { name: 'оценка правовой ситуации', value: '' }
      ],
      exclusions: 'Ознакомление с делом в суде, письменное заключение и сбор доказательств не входят.',
      buttonText: 'Заказать анализ',
      buttonHref: '#form'
    },
    {
      title: 'Иск об определении места жительства ребёнка',
      ...
      exclusions: 'Сбор доказательств, взаимодействие с опекой и представительство не входят.',
      buttonText: 'Заказать иск',
      buttonHref: '#form'
    },
    {
      title: 'Представительство в споре о ребёнке',
      ...
      exclusions: 'Иск, экспертизы и другие документы не входят. Последующее заседание — от 10 000 ₽.',
  ...
  const jsonLd = {
    ...
    '@graph': [
      ...
      {
        '@type': 'BreadcrumbList',
        '@id': 'https://dejure-help.ru/grazhdanam/semejnyj-yurist/opredelenie-mesta-zhitelstva-rebenka/#breadcrumbs',
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 4, 'name': 'Определение места жительства ребёнка', 'item': 'https://dejure-help.ru/grazhdanam/semejnyj-yurist/opredelenie-mesta-zhitelstva-rebenka/' }
        ]
      },
      {
        '@type': 'Service',
        '@id': 'https://dejure-help.ru/grazhdanam/semejnyj-yurist/opredelenie-mesta-zhitelstva-rebenka/#service',
        'url': 'https://dejure-help.ru/grazhdanam/semejnyj-yurist/opredelenie-mesta-zhitelstva-rebenka/',
        'name': 'Определение места жительства ребёнка',
      ...
      {
        '@type': 'FAQPage',
        '@id': 'https://dejure-help.ru/grazhdanam/semejnyj-yurist/opredelenie-mesta-zhitelstva-rebenka/#faq',

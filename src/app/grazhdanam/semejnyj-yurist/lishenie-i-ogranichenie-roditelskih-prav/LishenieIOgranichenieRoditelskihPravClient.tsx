...
export default function LishenieIOgranichenieRoditelskihPravClient() {
  ...
  const pricingTiers: PricingTier[] = [
    {
      title: 'Анализ оснований и документов',
      ...
      exclusions: 'Запрос документов, письменное заключение и дальнейшая работа не входят.',
      buttonText: 'Заказать анализ',
      buttonHref: '#form'
    },
    {
      title: 'Иск или возражение по родительским правам',
      subtitle: 'Подготовка одного процессуального документа.',
      price: 'от 10 000 ₽',
      priceUnit: 'за один документ',
      features: [
        { name: 'подготовка иска, заявления или отзыва', value: '' },
        { name: 'оформление одного процессуального документа', value: '' },
        { name: 'срок подготовки — от 3 рабочих дней', value: '' }
      ],
      exclusions: 'Сбор доказательств, запросы и представительство не входят.',
    ...
    },
    {
      ...
      exclusions: 'Иск, запросы и другие документы не входят. Последующее заседание — от 10 000 ₽.',
  ...
  const jsonLd = {
    ...
    '@graph': [
      ...
      {
        '@type': 'BreadcrumbList',
        '@id': 'https://dejure-help.ru/grazhdanam/semejnyj-yurist/lishenie-i-ogranichenie-roditelskih-prav/#breadcrumbs',
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 4, 'name': 'Лишение и ограничение родительских прав', 'item': 'https://dejure-help.ru/grazhdanam/semejnyj-yurist/lishenie-i-ogranichenie-roditelskih-prav/' }
        ]
      },
      {
        '@type': 'Service',
        '@id': 'https://dejure-help.ru/grazhdanam/semejnyj-yurist/lishenie-i-ogranichenie-roditelskih-prav/#service',
        'url': 'https://dejure-help.ru/grazhdanam/semejnyj-yurist/lishenie-i-ogranichenie-roditelskih-prav/',
        'name': 'Лишение и ограничение родительских прав',
      ...
      {
        '@type': 'FAQPage',
        '@id': 'https://dejure-help.ru/grazhdanam/semejnyj-yurist/lishenie-i-ogranichenie-roditelskih-prav/#faq',

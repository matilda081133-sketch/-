  ...
  const cases: CaseData[] = [
    {
        ...
        "title": "Лишили отца прав за 5 лет неуплаты алиментов и открыли возможность усыновления",
    ...
    },
    {
        ...
        "title": "Ограничили мать в правах и спасли двоих детей от опасных условий",
    ...
    },
    {
        ...
        "title": "Отстояли права отца и доказали необоснованность обвинений матери",
            ...
            <div>
              <div style={{ background: 'var(--color-white)', padding: '40px', border: '1px solid var(--color-border)', borderTop: '4px solid var(--color-primary)', boxShadow: '0 12px 40px rgba(23, 50, 77, 0.08)' }}>
                <ContactsForm 
                  ...
                  hiddenFields={[
                    { name: 'service', value: 'Лишение и ограничение родительских прав в Липецке | Де-Юре' },
                    { name: 'category', value: 'semejnyj-yurist/lishenie-i-ogranichenie-roditelskih-prav' },

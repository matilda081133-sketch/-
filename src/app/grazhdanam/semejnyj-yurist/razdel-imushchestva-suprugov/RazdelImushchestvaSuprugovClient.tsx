...
export default function RazdelImushchestvaSuprugovClient() {
  ...
  const pricingTiers: PricingTier[] = [
    {
      title: 'Анализ документов по имуществу',
      subtitle: 'Правовая оценка документов и обстоятельств раздела.',
      price: 'от 15 000 ₽',
      priceUnit: 'за анализ дела',
      features: [
        { name: 'рассмотрение представленных документов', value: '' },
        { name: 'правовой анализ состава имущества', value: '' },
        { name: 'оценка правовой ситуации', value: '' }
      ],
      exclusions: 'Ознакомление с материалами дела в суде, письменное заключение и дальнейшая работа не входят.',
      buttonText: 'Заказать анализ',
      buttonHref: '#form'
    },
    {
      title: 'Переговоры о разделе имущества',
      subtitle: 'Участие юриста в переговорах между сторонами.',
      price: 'от 15 000 ₽',
      priceUnit: 'до 4 часов переговоров',
      features: [
        { name: 'подготовка к переговорам в пределах представленных материалов', value: '' },
        { name: 'участие юриста в переговорах', value: '' },
        { name: 'представление позиции клиента', value: '' }
      ],
      exclusions: 'Подготовка соглашения и дальнейшие переговоры оплачиваются отдельно.',
      buttonText: 'Обсудить переговоры',
      buttonHref: '#form'
    },
    {
      title: 'Иск о разделе имущества',
      ...
      exclusions: 'Оценка имущества, сбор документов и представительство не входят.',
      buttonText: 'Заказать иск',
      buttonHref: '#form'
    },
    {
      title: 'Представительство в споре о разделе',
      ...
      exclusions: 'Иск, экспертизы и другие письменные документы не входят. Последующее заседание — от 10 000 ₽.',
      buttonText: 'Обсудить ведение спора',
      buttonHref: '#form'
    }
  ];
  ...
  return (
    <main>
      ...
      <PricingBlock
        title="Стоимость услуг по разделу имущества"
        subtitle="Можно отдельно заказать анализ документов, переговоры, подготовку иска или представительство в суде."
        pageUrl="https://dejure-help.ru/grazhdanam/semejnyj-yurist/razdel-imushchestva-suprugov/"
        tiers={pricingTiers}
        ctaTitle=""

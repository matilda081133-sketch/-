...
export default function SemejnyjClient() {
  ...
  const pricingTiers: PricingTier[] = [
    {
      ...
      features: [
        { name: 'устный разбор обстоятельств семейного спора', value: '' },
        { name: 'ответы на вопросы клиента', value: '' },
        { name: 'рекомендации по дальнейшим действиям', value: '' }
      ],
      exclusions: 'Анализ документов оплачивается отдельно при необходимости.',
      buttonText: 'Записаться на консультацию',
      buttonHref: '#form'
    },
    {
      title: 'Подготовка документа по семейному делу',
      subtitle: 'Подготовка одного процессуального документа по предоставленным материалам.',
      price: 'от 10 000 ₽',
      priceUnit: 'за один документ',
      features: [
        { name: 'исковое заявление, заявление или отзыв', value: '' },
        { name: 'подготовка одного процессуального документа', value: '' },
        { name: 'срок подготовки — от 3 рабочих дней', value: '' }
      ],
      exclusions: 'Представительство и дополнительные документы не входят.',
      buttonText: 'Заказать документ',
      buttonHref: '#form'
    },
    {
      title: 'Представительство в суде первой инстанции',
      subtitle: 'Участие юриста в рассмотрении семейного спора.',
      price: 'от 40 000 ₽',
      priceUnit: 'до 3 судебных заседаний',
      features: [
        { name: 'участие в предварительных заседаниях', value: '' },
        { name: 'участие в основных заседаниях', value: '' },
        { name: 'представление позиции клиента в суде', value: '' }
      ],
      exclusions: 'Письменные документы не входят. Последующее заседание — от 10 000 ₽.',
  ...
  return (
    <main>
      ...
      {/* ═══ БЛОК 7а: ПРОМО-КАРТОЧКА «ПОДГОТОВКА ДОКУМЕНТА» (ТЁМНАЯ СИНЯЯ) ═══ */}
          ...
          <div style={{ maxWidth: '620px', margin: '0 auto', textAlign: 'center' }}>
            <div style={{
              ...
              <h3 style={{
                ...
                Подготовка документа по&nbsp;семейному делу
              </h3>
              <p style={{
                color: 'var(--color-deep-blue)',
                opacity: 0.8,
                ...
                Подготовка одного процессуального документа по&nbsp;предоставленным материалам.
              </p>
              ...
              <ul style={{
                ...
                {[
                  'исковое заявление, заявление или отзыв',
                  'подготовка одного процессуального документа',
                  'срок подготовки — от 3 рабочих дней'
                ].map((item, idx) => (
                  <li key={idx} style={{ display: 'flex', alignItems: 'center', gap: '12px', fontSize: '15px', color: 'var(--color-deep-blue)' }}>
                    <div style={{ width: '6px', height: '6px', minWidth: '6px', background: 'var(--color-gold)', borderRadius: '50%', flexShrink: 0 }}></div>
                    <span>{item}</span>
                  </li>
                ))}
              ...
              <p style={{
                ...
                Представительство и дополнительные документы не&nbsp;входят.
              </p>

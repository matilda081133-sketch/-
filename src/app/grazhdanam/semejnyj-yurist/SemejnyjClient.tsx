  ...
  const cases: CaseData[] = [
    {
        ...
        "title": "Разделили ипотечную квартиру и бизнес без ущемления прав доверительницы",
    ...
    },
    {
        ...
        "title": "Взыскали алименты в твёрдой денежной сумме с предпринимателя",
    ...
    },
    {
        ...
        "title": "Отстояли право проживания двоих детей с матерью",
            ...
            >
              <div>
                ...
                <p style={{ 
                  ...
                  Опишите ваш семейный вопрос. Юрист компании «Де-Юре» детально изучит обстоятельства и предложит законный план действий.
                </p>
              </div>
              <a 
                href="#form" 
            ...
            <div>
              <div style={{ background: 'var(--color-white)', padding: '40px', border: '1px solid var(--color-border)', borderTop: '4px solid var(--color-primary)', boxShadow: '0 12px 40px rgba(23, 50, 77, 0.08)' }}>
                <ContactsForm 
                  ...
                  hiddenFields={[
                    { name: 'service', value: 'Семейный юрист в Липецке — помощь по семейным спорам | Де-Юре' },
                    { name: 'category', value: 'semejnyj-yurist' },

...
export default function GrazhdanamClient() {
  ...
  const allDirections = [
    // Группа 1
    { id: 1, group: 'group1', title: 'Семейный юрист', desc: 'Алименты, расторжение брака через суд, раздел имущества супругов, установление и оспаривание отцовства, споры о детях, брачные договоры.', link: '/grazhdanam/semejnyj-yurist/' },
    { id: 2, group: 'group1', title: 'Наследственный юрист', desc: 'Вступление в наследство через суд, восстановление срока принятия наследства, оспаривание завещания, признание наследника недостойным.', link: '/grazhdanam/nasledstvennyj-yurist/' },
    { id: 3, group: 'group1', title: 'Жилищный юрист', desc: 'Выселение и выписка через суд, залив квартиры, споры с управляющими компаниями и ЖКХ, раздел порядка оплаты коммунальных услуг, узаконение перепланировки.', link: '/grazhdanam/zhilishchnyj-yurist/' },
    { id: 4, group: 'group1', title: 'Юрист по недвижимости', desc: 'Сопровождение сделок с недвижимостью, проверка документов и рисков, споры с застройщиками по ДДУ, признание прав на недвижимость.', link: '/grazhdanam/yurist-po-nedvizhimosti/' },
    ...
    { id: 6, group: 'group2', title: 'Банкротство физических лиц', desc: 'Оценка оснований для банкротства, подготовка заявления и документов, сопровождение процедуры, взаимодействие с финансовым управляющим.', link: '/grazhdanam/bankrotstvo-fizicheskih-lic/' },
    { id: 7, group: 'group2', title: 'Кредитный юрист', desc: 'Споры с банками и коллекторами, отмена судебного приказа, проверка требований по кредиту, оспаривание незаконных начислений.', link: '/grazhdanam/kreditnyj-yurist/' },
    { id: 8, group: 'group2', title: 'Взыскание долгов', desc: 'Взыскание долгов по договорам и распискам, возврат займов, взыскание неосновательного обогащения, подготовка претензий и исков.', link: '/grazhdanam/vzyskanie-dolgov/' },
    { id: 9, group: 'group2', title: 'Юрист по исполнительному производству', desc: 'Обжалование действий и бездействия приставов (ФССП), возврат незаконно списанных средств, снятие ареста со счетов и имущества.', link: '/grazhdanam/yurist-po-ispolnitelnomu-proizvodstvu/' },

    // Группа 3
    { id: 10, group: 'group3', title: 'Автоюрист', desc: 'Лишение водительских прав и оставление места ДТП, споры по ОСАГО и КАСКО, взыскание ущерба после ДТП, оспаривание виновности в аварии.', link: '/grazhdanam/avtoyurist/' },
    { id: 11, group: 'group3', title: 'Трудовой юрист', desc: 'Незаконное увольнение и сокращение, восстановление на работе, взыскание задолженности по заработной плате, производственные травмы.', link: '/grazhdanam/trudovoj-yurist/' },
    { id: 12, group: 'group3', title: 'Адвокат по уголовным делам', desc: 'Защита при задержании, обыске и допросе, участие на следствии и в суде. Защита по мошенничеству, имущественным и экономическим преступлениям.', link: '/grazhdanam/advokat-po-ugolovnym-delam/' },
    ...
    { id: 14, group: 'group3', title: 'Миграционный юрист', desc: 'Отмена запрета на въезд в РФ, обжалование депортации и административного выдворения, получение РВП и ВНЖ, сопровождение миграционных споров.', link: '/grazhdanam/migracionnyj-yurist/' }
  ];
    ...
    <main>
      ...
      <MilitaryHero
        ...
        primaryCtaSubtext={
          <>
            Или позвоните:{' '}
            <a href="tel:+74742201525" style={{ color: 'var(--color-deep-blue)', textDecoration: 'none', fontWeight: 600 }} data-analytics="click_citizens_phone" data-placement="hero">
              +7 (4742) 20-15-25
            </a>
          </>
        }
      ...
      <TeamCarousel 
        filterSlugs={['bobkin-arkadiy-evgenevich', 'konopkin-dmitriy-sergeevich', 'smolyaninova-marina-valerevna', 'gusev-oleg-yurevich']} 
        showDisclaimer={true} 
      />

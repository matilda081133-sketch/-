        ...
        tiers={[
          {
            ...
            subtitle: 'Устный разбор заключения, процедуры освидетельствования и возможных способов обжалования.',
            popular: false,
            price: '2 000 ₽',
            priceUnit: 'за консультацию до 1 часа',
            features: [
              { name: 'Уточнение обстоятельств освидетельствования', value: 'Включено' },
              { name: 'Обсуждение заключения и имеющихся медицинских документов', value: 'Включено' },
              { name: 'Рекомендации по возможному порядку действий', value: 'Включено' }
            ],
            exclusions: 'Углублённый медицинско-правовой анализ полного архива, письменное заключение и подготовка жалобы не входят.',
            buttonText: 'Оценить порядок действий',
            buttonHref: '#form'
          },
          {
            title: 'Жалоба в вышестоящую ВВК',
            subtitle: 'Подготовка одной мотивированной жалобы по предоставленным материалам.',
            popular: false,
            price: 'от 5 000 ₽',
            priceUnit: 'за один документ',
            features: [
              { name: 'Изучение материалов, необходимых для жалобы', value: 'Включено' },
              { name: 'Описание юридически значимых нарушений и требований', value: 'Включено' },
              { name: 'Подготовка текста; срок — от 3 рабочих дней', value: 'Включено' }
            ],
            exclusions: 'Медицинское обследование, адвокатские запросы, получение медкарты, подача и сопровождение пересмотра не входят.',
            buttonText: 'Заказать жалобу',
            buttonHref: '#form'
          },
          {
            title: 'Административный иск по заключению ВВК',
            subtitle: 'Подготовка одного административного искового заявления.',
            popular: false,
            price: 'от 10 000 ₽',
            priceUnit: 'за один процессуальный документ',
            features: [
              { name: 'Подготовка административного иска по переданным материалам', value: 'Включено' },
              { name: 'Формирование правовой позиции', value: 'Включено' },
              { name: 'Срок подготовки — от 3 рабочих дней', value: 'Включено' }
            ],
            exclusions: 'Подача, пошлина, ходатайства, экспертизы и представительство не входят.',
            buttonText: 'Заказать административный иск',
            buttonHref: '#form'
          },
          {
            title: 'Представительство в суде по ВВК',
            subtitle: 'Участие юриста в суде первой инстанции при оспаривании заключения.',
            popular: false,
            price: 'от 40 000 ₽',
            ...
            exclusions: 'Иск, ходатайства, медицинские исследования, экспертизы и последующие заседания не входят. Последующее заседание — от 10 000 ₽.',

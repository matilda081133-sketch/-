  ...
  return (
    <main>
      ...
      <PricingBlock 
        ...
        subtitle="Стоимость зависит от выбранной судебной процедуры, имеющихся официальных сведений и объёма доказательств. До подготовки заявления необходимо определить юридическую цель обращения, сроки и подсудность."
        tiers={[
          {
            title: 'Консультация по выбору процедуры',
            subtitle: 'Устный разбор ситуации и различий между признанием безвестно отсутствующим и объявлением умершим.',
            price: '2 000 ₽',
            priceUnit: 'за консультацию до 1 часа',
            features: [
              { name: 'уточнение обстоятельств исчезновения и имеющегося статуса', value: '' },
              { name: 'обсуждение юридической цели обращения', value: '' },
              { name: 'рекомендации по ближайшим действиям', value: '' }
            ],
            exclusions: 'Углублённый анализ материалов, запросы, определение окончательной доказательственной позиции и заявление в суд не входят.',
            buttonText: 'Разобрать ситуацию',
            buttonHref: '#form'
          },
          {
            title: 'Заявление в суд',
            subtitle: 'Подготовка заявления о признании безвестно отсутствующим или об объявлении умершим.',
            price: 'от 10 000 ₽',
            priceUnit: 'за один процессуальный документ',
            features: [
              { name: 'выбор вида заявления по предоставленным материалам', value: '' },
              { name: 'подготовка заявления с указанием юридической цели', value: '' },
              { name: 'срок подготовки — от 3 рабочих дней', value: '' }
            ],
            exclusions: 'Адвокатские запросы, получение доказательств, подача, пошлина, ходатайства и представительство не входят.',
            buttonText: 'Заказать заявление',
            buttonHref: '#form'
          },
          {
            title: 'Представительство в суде',
            subtitle: 'Участие юриста в особом производстве в суде первой инстанции.',
            price: 'от 40 000 ₽',
            priceUnit: 'до 3 судебных заседаний',
            features: [
              { name: 'участие в судебных заседаниях', value: '' },
              { name: 'представление позиции заявителя', value: '' },
              { name: 'информирование о ходе дела', value: '' }
            ],
            exclusions: 'Заявление, запросы, ходатайства, получение решения с отметкой и последующие заседания не входят. Последующее заседание — от 10 000 ₽.',

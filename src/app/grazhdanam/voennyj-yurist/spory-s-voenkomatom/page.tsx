          ...
          <div className="grid grid-2" style={{ gap: '28px', marginBottom: '32px' }}>
            ...
            <div style={{
              ...
              <h3 style={{ fontSize: '20px', fontFamily: 'var(--font-serif)', color: 'var(--color-deep-blue)', margin: 0, paddingBottom: '12px', borderBottom: '1px solid rgba(23, 50, 77, 0.1)' }}>
                <span style={{ display: 'inline-block' }}>Оспариваемые решения</span> <br />
                <span style={{ display: 'inline-block' }}>и воинский учёт</span>
              </h3>
            ...
            <div style={{
              ...
              <h3 style={{ fontSize: '20px', fontFamily: 'var(--font-serif)', color: 'var(--color-deep-blue)', margin: 0, paddingBottom: '12px', borderBottom: '1px solid rgba(23, 50, 77, 0.1)' }}>
                <span style={{ display: 'inline-block' }}>Подтверждающие документы</span> <br />
                <span style={{ display: 'inline-block' }}>и переписка</span>
              </h3>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '20px' }}>
                <li style={{ display: 'flex', gap: '14px', alignItems: 'flex-start' }}>

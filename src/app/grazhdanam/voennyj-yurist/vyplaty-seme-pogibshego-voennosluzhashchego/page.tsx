...
export const metadata = {
  ...
  description: 'Помощь семье погибшего военнослужащего: проверка права каждого заявителя, федеральных, страховых и региональных выплат, документов и обжалование отказа. 📞 +7 (4742) 20-15-25.',
  alternates: {
        ...
        tiers={[
          {
            ...
            subtitle: 'Устный разбор статуса заявителя, имеющихся документов и ближайших действий.',
            popular: false,
            price: '2 000 ₽',
            priceUnit: 'за консультацию до 1 часа',
            features: [
              { name: 'Уточнение круга заявителей и известных обстоятельств', value: 'Включено' },
              { name: 'Обсуждение возможных оснований выплат', value: 'Включено' },
              { name: 'Рекомендации по дальнейшим действиям', value: 'Включено' }
            ],
            exclusions: 'Проверка права каждого заявителя по всем видам выплат, анализ большого комплекта документов и письменный перечень не входят.',
            buttonText: 'Разобрать ситуацию',
            buttonHref: '#form'
          },
          {
            title: 'Заявление или жалоба по выплате',
            subtitle: 'Один документ для назначения выплаты, получения ответа или обжалования отказа.',
            popular: false,
            price: 'от 5 000 ₽',
            ...
            features: [
              ...
              { name: 'Подготовка заявления или жалобы; срок — от 3 рабочих дней', value: 'Включено' }
            ],
            exclusions: 'Получение документов, несколько заявлений для разных получателей, подача и сопровождение рассмотрения не входят.',
            buttonText: 'Заказать обращение',
            buttonHref: '#form'
          },
          {
            title: 'Документ для обращения в суд',
            subtitle: 'Один процессуальный документ по спору о выплате или для установления юридически значимого факта.',
            popular: false,
            price: 'от 10 000 ₽',
            priceUnit: 'за один процессуальный документ',
            features: [
              { name: 'Определение применимого вида судебного обращения', value: 'Включено' },
              { name: 'Подготовка иска, административного иска или заявления', value: 'Включено' },
              { name: 'Срок подготовки — от 3 рабочих дней', value: 'Включено' }
            ],
            exclusions: 'Сбор доказательств, подача, пошлина и представительство не входят.',
            buttonText: 'Заказать документ в суд',
            buttonHref: '#form'
          },
          {
            title: 'Представительство в суде',
            subtitle: 'Участие юриста в первой инстанции по спору о выплате или установлению юридически значимого факта.',
            popular: false,
            price: 'от 40 000 ₽',
            priceUnit: 'до 3 судебных заседаний',
            features: [
              { name: 'Участие в предварительных и основных заседаниях', value: 'Включено' },
              { name: 'Представление позиции заявителя', value: 'Включено' },
              { name: 'Информирование о движении дела', value: 'Включено' }
            ],
            exclusions: 'Заявление, иные письменные документы и последующие заседания не входят. Последующее заседание — от 10 000 ₽.',

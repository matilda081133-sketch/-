  ...
  return (
    <main>
      ...
      <PricingBlock 
        ...
        ctaTitle="Уточнить стоимость"
        tiers={[
          {
            name: 'Консультация и проверка права',
            price: 'ХХХ ₽',
            period: '',
            description: 'Первичный разбор ситуации и определение ближайшего порядка действий',
            features: [
              'Первичный разбор статуса заявителя',
              'Анализ возможных видов выплат',
              'Изучение имеющихся документов',
              'Определение ближайшего порядка действий'
            ],
            cta: 'Записаться на консультацию',
            popular: false
          },
          {
            name: 'Оформление выплат',
            price: 'ХХХ ₽',
            period: '',
            description: 'Комплексное сопровождение подачи заявлений и получения выплат',
            features: [
              'Проверка полного комплекта документов',
              'Подготовка заявлений и запросов',
              'Помощь в получении недостающих документов',
              'Сопровождение подачи в ведомства'
            ],
            cta: 'Оформить сопровождение',
            popular: false
          },
          {
            name: 'Обжалование отказа',
            price: 'ХХХ ₽',
            period: '',
            description: 'Досудебная и судебная защита прав получателей выплат',
            features: [
              'Правовой анализ отказа или задержки',
              'Подготовка жалобы или иска в суд',
              'Представительство в ведомствах и суде',
              'Сопровождение обжалования в объёме договора'
            ],
            cta: 'Обсудить обжалование',
            popular: false
          }
        ]}
      />

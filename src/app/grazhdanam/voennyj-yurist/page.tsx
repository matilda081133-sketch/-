...
export const metadata = {
  ...
  description: 'Юридическая помощь военнослужащим, призывникам и их близким в Липецке: ВВК, выплаты, споры с военкоматом, защита по уголовным делам. Работа по России. 📞 +7 (4742) 20-15-25.',
  alternates: {
      ...
      <section style={{ background: 'var(--color-deep-blue)', padding: '64px 0 56px', position: 'relative', overflow: 'hidden' }}>
        <div className="container">
          ...
          <div style={{ borderTop: '1px solid rgba(255,255,255,0.15)', paddingTop: '28px', display: 'flex', alignItems: 'center', gap: '24px', flexWrap: 'wrap' }}>
            ...
            <a href="tel:+74742201525" className="btn-urgent-call" style={{ padding: '14px 28px', fontSize: '15px' }} data-analytics="military_urgent_call_click">
              Позвонить адвокату
            </a>
        ...
        tiers={[
          {
            ...
            features: [
              { name: 'Уточнение обстоятельств и срочности', value: 'Включено' },
              { name: 'Ответы на вопросы клиента', value: 'Включено' },
              { name: 'Рекомендации по дальнейшим действиям', value: 'Включено' }
            ],
            exclusions: 'Углублённый анализ документов, письменные выводы и подготовка обращений не входят.',
            buttonText: 'Записаться на консультацию',
            buttonHref: '#form'
          },
          {
            title: 'Жалоба или заявление в военный орган',
            subtitle: 'Подготовка одного обращения по предоставленным клиентом сведениям и документам.',
            popular: false,
            price: 'от 5 000 ₽',
            priceUnit: 'за один документ',
            features: [
              { name: 'Изучение материалов, необходимых для документа', value: 'Включено' },
              { name: 'Определение адресата и правовой позиции', value: 'Включено' },
              { name: 'Подготовка текста; срок — от 3 рабочих дней после получения необходимых сведений', value: 'Включено' }
            ],
            exclusions: 'Подача, дополнительные запросы, сбор документов и представительство не входят.',
            buttonText: 'Заказать документ',
            buttonHref: '#form'
          },
          {
            title: 'Представительство в ведомстве или комиссии',
            subtitle: 'Личное участие юриста в одном согласованном мероприятии.',
            popular: false,
            price: 'от 15 000 ₽',
            priceUnit: 'до 4 часов участия',
            features: [
              { name: 'Подготовка в пределах переданных материалов', value: 'Включено' },
              { name: 'Участие в согласованном ведомстве или комиссии', value: 'Включено' },
              { name: 'Представление позиции доверителя в пределах полномочий', value: 'Включено' }
            ],
            exclusions: 'Письменные документы, повторный выезд, дорога и ожидание сверх 4 часов не входят.',
            buttonText: 'Обсудить представительство',
            buttonHref: '#form'
          },
          {
            title: 'Представительство в суде первой инстанции',
            subtitle: 'Участие юриста в рассмотрении военного или связанного с ним спора.',
            popular: false,
            price: 'от 40 000 ₽',
            priceUnit: 'до 3 судебных заседаний',
            features: [
              { name: 'Участие в предварительных и основных заседаниях', value: 'Включено' },
              { name: 'Представление согласованной позиции клиента', value: 'Включено' },
              { name: 'Информирование о движении дела в пределах поручения', value: 'Включено' }
            ],
            exclusions: 'Иск, жалобы, ходатайства, экспертизы и иные письменные документы не входят. Последующее заседание — от 10 000 ₽.',

            ...
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              <div className="grid grid-2" style={{ gap: '0', borderLeft: '1px solid rgba(23, 50, 77, 0.1)', borderTop: '1px solid rgba(23, 50, 77, 0.1)', flex: 1 }}>
                {member.process.map((step, i) => (
                  <div key={i} className="usp-card" style={{ padding: '30px 24px', borderRight: '1px solid rgba(23, 50, 77, 0.1)', borderBottom: '1px solid rgba(23, 50, 77, 0.1)', background: 'rgba(255, 255, 255, 0.85)', position: 'relative', display: 'flex', flexDirection: 'column', gap: '6px' }}>
                    <div className="usp-accent"></div>

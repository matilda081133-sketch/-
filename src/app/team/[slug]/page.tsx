      ...
      <section className="section" style={{ background: 'var(--color-white)' }}>
        <div className="container">
          <div className="grid grid-2" style={{ gap: '80px' }}>
            ...
            {/* Experience */}
            <div>
              <h2 style={{ fontSize: '32px', color: 'var(--color-deep-blue)', fontFamily: 'var(--font-serif)', marginBottom: '30px' }}>Профессиональный опыт</h2>
              <div style={{ background: 'var(--color-cream)', padding: '30px', borderLeft: '4px solid var(--color-primary)' }}>
                <ul style={{ paddingLeft: '20px', color: 'var(--color-deep-blue)', fontSize: '15px', lineHeight: 1.6, margin: 0, display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
              ...
              <div>
                <h2 style={{ fontSize: '24px', color: 'var(--color-deep-blue)', fontFamily: 'var(--font-serif)', marginBottom: '20px' }}>Образование и профессиональный статус</h2>
        ...
        <div className="container">
          ...
          <div className="grid grid-3" style={{ gap: '30px' }}>
            {member.process.map((step, i) => (
              <div key={i} style={{ background: 'var(--color-white)', padding: '24px', border: '1px solid var(--color-border)' }}>
                <div style={{ fontSize: '14px', fontWeight: 600, color: 'var(--color-primary)', marginBottom: '12px' }}>Этап {step.step}</div>

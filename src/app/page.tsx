      ...
      },
      {
        ...
        'mainEntity': [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'До начала работы изучим документы, оценим перспективы и определим результат, которого будем добиваться. Стратегию, состав работ и стоимость зафиксируем в договоре.'
            }
          },
          {
            '@type': 'Question',

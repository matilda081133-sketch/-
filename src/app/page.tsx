  ...
  return (
    <main>
      ...
      <TeamCarousel 
        ...
        bgClass="bg-white"
        id="advocates"
        customDisclaimer="Представленные адвокаты не являются сотрудниками ЮК «Де-Юре» и осуществляют адвокатскую деятельность самостоятельно. ЮК взаимодействует с ними на основании соглашений о сотрудничестве. Адвокатская помощь оказывается по отдельному соглашению между адвокатом и доверителем."
      />

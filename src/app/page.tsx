...
export default function Home() {
  return (
    <main>
          ...
          <div className="main-usp-grid" style={{ 
            ...
            {[
              ...
              },
              {
                ...
                desc: "Если для решения задачи требуется адвокатский статус, ЮК может подключить независимого адвоката соответствующей специализации. Условия его участия согласуются отдельно; адвокатская помощь оказывается на основании соглашения между адвокатом и доверителем."
              },
              {
                tag: "Анализ",
      ...
      {/* 5. TEAM - БЛОК 2: НЕЗАВИСИМЫЕ АДВОКАТЫ */}
      <TeamCarousel 
        customSectionLabel="АДВОКАТСКАЯ ПОМОЩЬ"
        customTitle="Адвокаты, с которыми сотрудничает ЮК «Де-Юре»"
        customSubtitle="Когда для решения задачи требуется адвокатский статус, ЮК может рекомендовать или подключить независимого адвоката соответствующей специализации."
        filterSlugs={[

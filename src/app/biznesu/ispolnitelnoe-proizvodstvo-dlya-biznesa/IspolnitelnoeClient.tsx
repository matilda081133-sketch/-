  ...
  return (
    <main>
      ...
      <PricingBlock
        ...
        ctaButtonLink="#form"
        disclaimer="Стоимость определяется после уточнения роли компании (взыскатель или должник) и изучения документов. Состав услуг, цена и порядок оплаты фиксируются в договоре до начала работы. Оплата вознаграждения исполнителя не включает государственные пошлины и установленный законом исполнительский сбор."
      />

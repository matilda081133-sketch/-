...
export default function ZashchitaPriObyskeClient() {
  const obyskSituations = [
    ...
    const firstMinutesActions = [
    {
      num: '01',
      title: 'Уведомить руководство и связаться с адвокатом',
      desc: 'Назначить одного координатора со стороны компании и исключить хаотичные указания разным сотрудникам. Передать адвокату адрес, наименование органа и данные должностных лиц.'
    },
    {
      num: '02',
      title: 'Проверить предъявленные документы и данные должностных лиц',
      desc: 'Ознакомиться с предъявленными постановлениями и служебными удостоверениями; точную правовую оценку оснований выполняет адвокат.'
    },
    {
      num: '03',
      title: 'Не препятствовать законным действиям',
      desc: 'Не вступать в физические конфликты с сотрудниками правоохранительных органов, действовать спокойно и фиксировать ход мероприятия.'
    },
    {
      num: '04',
      title: 'Не скрывать, не удалять и не изменять документы и данные',
      desc: 'Не обсуждать версии между собой и не давать универсальных указаний. Каждому участнику разъясняются его процессуальный статус и права.'
    },
    {
      num: '05',
      title: 'Фиксировать изъятие, упаковку и содержание протокола',
      desc: 'Сопоставлять фактически изымаемые предметы и документы с описанием, упаковкой и сведениями, вносимыми в процессуальный протокол.'
    },
    {
      num: '06',
      title: 'Определить критичные для работы компании системы и данные',
      desc: 'Установить критичные системы и носители, по которым необходимо заявить применимые ходатайства о копировании информации для сохранения бизнес-процессов.'
    }
  ];
    ...
    {
      num: '01',
      title: 'Основание и пределы действия',
      desc: 'Каким документом оформлено мероприятие, какие помещения и объекты указаны, кто его проводит и какие процессуальные решения предъявлены участникам.'
    },
    {
      num: '02',
      title: 'Статус присутствующих',
      desc: 'Кто представляет компанию, кто участвует со стороны правоохранительных органов и специалистов, какие действия предлагаются сотрудникам.'
    },
    {
      num: '03',
      title: 'Документы и предметы',
      desc: 'Что обнаружено и изымается, как это описывается, упаковывается и соотносится с предметом мероприятия.'
    },
    {
      num: '04',
      title: 'Электронные носители и информация',
      desc: 'Какая техника и данные затронуты, участвует ли специалист, заявляются ли применимые ходатайства о копировании информации и как результат отражается в протоколе.'
    },
    {
      num: '05',
      title: 'Протокол и приложения',
      desc: 'Соответствует ли запись фактическому ходу действия, внесены ли заявления, замечания и перечень изъятого, получена ли копия предусмотренных документов.'
    }
  ];
  ...
  const processSteps = [
    ...
    },
    {
      ...
      desc: 'Контролируем перемещение оперативной группы по кабинетам, добиваемся точной детальной описи изымаемых носителей.'
    },
    {
      num: '04',
  ...
  const practiceCases: CaseData[] = [
    ...
    const faqs = [
    {
      q: 'Что сообщить адвокату, если обыск уже начался?',
      a: 'Назовите адрес, наименование компании и органа, данные контактного лица, кто находится на месте и какие документы предъявлены. Если безопасно и допустимо, сохраните реквизиты документа, но не задерживайте обращение ради полного пересказа.'
    },
    {
      q: 'Обязаны ли ждать адвоката до начала обыска?',
      a: 'Универсально обещать приостановку мероприятия до прибытия адвоката нельзя. Нужно заявить о желании получить юридическую помощь и действовать с учётом конкретной процедуры и указаний подключившегося адвоката.'
    },
    {
      q: 'Можно ли не пускать сотрудников правоохранительных органов в офис?',
      a: 'Оценка зависит от полномочий, предъявленных документов и характера действия. Не следует физически препятствовать законным действиям; основания и замечания должен оценить адвокат.'
    },
    {
      q: 'Чем обыск отличается от выемки?',
      a: 'При выемке обычно речь идёт об определённых предметах или документах, а обыск направлен на их обнаружение. Конкретное основание и порядок определяются процессуальными документами и законом.'
    },
    {
      q: 'Что делать, если изымают компьютеры или сервер?',
      a: 'Нужно зафиксировать, что именно изымается, как описывается и упаковывается, и обсудить с адвокатом применимые ходатайства о копировании информации и сохранении критичных данных. Возможность копирования и изъятия зависит от обстоятельств и норм УПК РФ.'
    },
    {
      q: 'Могут ли во время обыска опрашивать сотрудников?',
      a: 'Сначала важно определить, какое действие предлагают конкретному человеку и в каком статусе. Интересы компании и сотрудника могут различаться, поэтому общая инструкция для всех небезопасна.'
    },
    {
      q: 'Что указывать в замечаниях к протоколу?',
      a: 'В замечаниях фиксируют существенные расхождения между фактическим ходом мероприятия и его описанием. Формулировки лучше согласовать с участвующим адвокатом, не заменяя их эмоциональной оценкой.'
    },
    {
      q: 'Что делать после окончания обыска?',
      a: 'Сохраните полученные документы, перечень изъятого и внутреннюю хронологию событий, определите затронутые системы и сотрудников. Затем нужно оценить протокол, риски и дальнейшие действия.'
    },
    {
      q: 'Можно ли вернуть изъятые документы и технику?',
      a: 'Порядок зависит от процессуального статуса имущества, оснований изъятия и дальнейших решений по делу. Сначала анализируются протокол, перечень и документы, после чего определяется допустимый способ обращения.'
    },
    {
      q: 'Когда эта страница не подходит?',
      a: 'Если компания получила только запрос или вызов и обыск не проводится, нужна услуга по проверке ОБЭП. Для личного задержания, допроса или обыска дома нужна срочная B2C-помощь адвоката.'
    }
  ];
    ...
    },
    {
      ...
      desc: 'Защита руководителей и учредителей по ст. 159, 160, 201 УК РФ при уголовных обвинениях.',
    ...
    },
    {
      ...
      desc: 'Превентивная проверка договоров, хозяйственных операций и рисков уголовного преследования.',
      link: '/biznesu/ugolovno-pravovaya-zashchita-biznesa/ugolovno-pravovoj-audit-biznesa/'
    },
    {
      title: 'Защита по налоговым преступлениям',
      desc: 'Защита при передаче материалов проверок ФНС в Следственный комитет по ст. 199 УК РФ.',
  ...
  return (
    <main>
      ...
      {/* ═══ БЛОК 3: ЧТО ВАЖНО СДЕЛАТЬ В ПЕРВЫЕ МИНУТЫ (#URGENT) ═══ */}
        ...
        <div className="container">
          <div style={{ maxWidth: '820px', marginBottom: '36px' }}>
            ...
            <p style={{ fontSize: '16px', color: '#E8ECF1', lineHeight: 1.65, margin: 0 }}>
              В срочной ситуации задача компании — не конфликтовать с должностными лицами, быстро связаться с адвокатом и сохранить точную информацию о происходящем. Конкретный порядок зависит от предъявленных документов, вида мероприятия и статуса участников.
            </p>
          </div>

          <div className="grid grid-3" style={{ gap: '20px', marginBottom: '36px' }}>
            {firstMinutesActions.map((action, idx) => (
              <div
                key={idx}
              ...
              >
                <div style={{ color: 'var(--color-gold)', fontSize: '12px', fontWeight: 700, letterSpacing: '0.08em' }}>
                  ДЕЙСТВИЕ {action.num}
                </div>
                <h3 style={{ fontSize: '17px', color: '#FFFFFF', margin: 0, fontFamily: 'var(--font-serif)', lineHeight: 1.35 }}>
                  {action.title}
                </h3>
        ...
        <div className="container">
          <div style={{ maxWidth: '750px', marginBottom: '48px' }}>
            ...
            <p style={{ fontSize: '16px', color: 'var(--color-deep-blue)', opacity: 0.9, fontWeight: 500, margin: 0, lineHeight: 1.6, textWrap: 'balance' }}>
              Зафиксированные нарушения можно использовать при обжаловании действий и оценке допустимости доказательств. Правовые последствия зависят от характера нарушения, материалов дела и решения уполномоченного органа или суда.
            </p>
          </div>
          ...
          <div className="grid grid-2" style={{ gap: '60px', alignItems: 'stretch' }}>
            <div style={{ display: 'flex', flexDirection: 'column', height: '100%', justifyContent: 'flex-start' }}>
              ...
              <p style={{ color: 'var(--color-deep-blue)', opacity: 0.9, fontWeight: 500, fontSize: '16px', lineHeight: 1.6, marginBottom: '24px', textWrap: 'balance' }}>
                Если обыск или выемка уже начались — немедленно звоните дежурному юристу. Если следственные действия завершились, оставьте контакты: специалист свяжется с вами, уточнит обстоятельства и при необходимости организует подключение адвоката.
              </p>

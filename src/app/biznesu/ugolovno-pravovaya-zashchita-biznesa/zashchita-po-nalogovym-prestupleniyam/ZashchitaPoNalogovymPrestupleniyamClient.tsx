  ...
  const faqs = [
    {
      ...
      a: 'Нет. Налоговая недоимка и решение инспекции сами по себе не означают наличия состава преступления. При решении вопроса о возбуждении дела оценивается наличие достаточных данных, указывающих на признаки преступления. Для привлечения конкретного лица к ответственности необходимо доказать предусмотренный законом размер недоимки, прямой умысел и роль этого лица.'
    },
    {
      q: 'В какой момент налоговая инспекция передаёт материалы в Следственный комитет?',
      a: 'Согласно пункту 3 статьи 32 НК РФ материалы направляются в следственные органы при наличии совокупности предусмотренных законом условий, включая неуплату в установленный 75-дневный срок и размер недоимки, позволяющий предполагать наличие признаков преступления. После выявления этих обстоятельств материалы направляются в течение 10 дней. Само направление материалов не означает автоматического возбуждения уголовного дела.'
    },
    {

      ...
      },
      {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Компания не является обвиняемым по уголовному делу, но её интересы могут представляться в предусмотренном законом процессуальном статусе. Защита директора осуществляется отдельно. При расхождении позиций или риске конфликта интересов необходимо участие разных независимых адвокатов.'
            }
          },
          {
            '@type': 'Question',

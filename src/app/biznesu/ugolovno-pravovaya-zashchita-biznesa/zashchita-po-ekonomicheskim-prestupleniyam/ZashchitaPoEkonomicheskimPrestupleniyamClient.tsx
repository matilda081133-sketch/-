...
export default function ZashchitaPoEkonomicheskimPrestupleniyamClient() {
  ...
  const processSteps = [
    ...
    },
    {
      ...
      desc: 'Независимые адвокаты, подключённые к делу, заявляют обоснованные ходатайства о назначении экспертиз, вызове ключевых свидетелей и приобщении документов защиты.'
    },
    {
      num: '04',
    ...
    },
    {
      ...
      desc: 'Последовательно отстаиваем выбранную правовую позицию, заявляем предусмотренные законом ходатайства и используем доступные основания для прекращения дела, изменения квалификации или вынесения оправдательного приговора.'
    }
  ];
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'Компания не является обвиняемым по уголовному делу, но её интересы могут представляться в предусмотренном законом процессуальном статусе. Защита директора осуществляется отдельно. При расхождении позиций или риске конфликта интересов необходимо участие разных независимых адвокатов.'
    },
    {

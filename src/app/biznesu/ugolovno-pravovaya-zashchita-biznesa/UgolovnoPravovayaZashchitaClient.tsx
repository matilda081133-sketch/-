  ...
  const faqs = [
    {
      ...
      a: 'Обратиться можно на любом этапе: превентивно до проверки, сразу после получения запроса, при вызове сотрудников, во время обыска или после возбуждения дела. Чем раньше подключены специалисты, тем больше времени остаётся на анализ документов, определение статуса участников и подготовку правовой позиции.'
    },
    {

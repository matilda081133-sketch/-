        ...
        <div className="container">
          <div style={{ maxWidth: '800px', marginBottom: '40px' }}>
            ...
            <p style={{ fontSize: '15px', color: 'var(--color-text-secondary)', margin: 0 }}>
              Если ситуация уже перешла в стадию взаимодействия с органами:
            </p>
          </div>
          ...
          <div className="grid grid-3" style={{ gap: '20px' }}>
            ...
            >
              <div style={{ fontSize: '16px', fontWeight: 600, color: 'var(--color-deep-blue)' }}>
                Защита бизнеса при проверке ОБЭП
              </div>
              <p style={{ fontSize: '13.5px', color: 'var(--color-text-secondary)', margin: 0, lineHeight: 1.5 }}>
                Поступил запрос или вызов на опрос. Контроль законности действий полиции.
              </p>
            ...
            >
              ...
              <p style={{ fontSize: '13.5px', color: 'var(--color-text-secondary)', margin: 0, lineHeight: 1.5 }}>
                Срочный выезд адвоката, фиксация нарушений и сохранение техники.
              </p>
              <div style={{ color: 'var(--color-primary)', fontSize: '13px', fontWeight: 600, marginTop: 'auto' }}>
                Подробнее →
              </div>
            ...
            >
              ...
              <p style={{ fontSize: '13.5px', color: 'var(--color-text-secondary)', margin: 0, lineHeight: 1.5 }}>
                Все направления правовой помощи и координация адвокатов.
              </p>
              <div style={{ color: 'var(--color-primary)', fontSize: '13px', fontWeight: 600, marginTop: 'auto' }}>
                На страницу хаба →
              </div>

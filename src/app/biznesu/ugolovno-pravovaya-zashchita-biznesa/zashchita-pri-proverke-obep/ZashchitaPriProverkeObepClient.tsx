...
export default function ZashchitaPriProverkeObepClient() {
  ...
  const urgentRisks = [
    {
      ...
      desc: 'Объяснения, данные на стадии проверки, фиксируют первоначальную версию событий и могут использоваться при проведении дальнейших процессуальных действий.'
    },
    {
  ...
  const obepContours = [
    ...
    {
      num: '06',
      title: 'Подготовка позиции по материалу проверки',
  ...
  const pricingTiers: PricingTier[] = [
    ...
    },
    {
      ...
      features: [
        ...
        { name: 'Подготовка позиции и документов к итоговому процессуальному решению', value: 'Включено' }
      ],
        ...
        <div className="container">
          <div style={{ maxWidth: '800px', marginBottom: '36px' }}>
            ...
            <p style={{ fontSize: '16px', color: '#E8ECF1', lineHeight: 1.65, margin: 0 }}>
              Доследственная проверка длится от 3 до 30 дней. Сведения и объяснения, полученные в этот период, могут учитываться при принятии процессуального решения по материалу проверки.
            </p>
          </div>

...
export default function OsparivanieReshenijFnsClient() {
  const situations = [
    ...
    {
      tag: 'Уголовный риск',
      title: 'Риск передачи материалов в следственные органы',
      desc: 'Если через 75 дней после вступления решения в силу недоимка не погашена, а её размер и обстоятельства позволяют предполагать признаки налогового преступления, ФНС направляет материалы в следственные органы. Согласуем налоговую и уголовно-правовую позицию заранее, чтобы снизить риски для руководителей и собственников.',

...
export const metadata: Metadata = {
  ...
  description: 'Разработаем договор под задачу бизнеса или проверим проект контрагента: выявим риски, предложим правки, подготовим протокол разногласий. Работаем в Липецке и дистанционно. 📞 +7 (4742) 20-15-25.',
  alternates: {
  ...
  openGraph: {
    ...
    description: 'Подготовим договор под сделку, проверим условия и приложения, объясним риски и предложим рабочую редакцию. 📞 +7 (4742) 20-15-25.',

...
export const metadata: Metadata = {
  ...
  description: 'Поможем поставщику или покупателю в споре по договору поставки: оценим документы, подготовим претензию или защиту и представим бизнес в арбитражном суде. 📞 +7 (4742) 20-15-25.',
  alternates: {

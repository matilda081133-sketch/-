...
export const metadata: Metadata = {
  ...
  description: 'Договорный юрист для бизнеса в Липецке: разработка и экспертиза договоров, аудит договорной работы, урегулирование договорных споров. Изучим задачу и предложим формат помощи. 📞 +7 (4742) 20-15-25.',
  alternates: {
    canonical: 'https://dejure-help.ru/biznesu/dogovornoe-pravo/'
  },
  openGraph: {
    title: 'Договорный юрист для бизнеса — Де-Юре',
    description: 'Разработка и проверка договоров, аудит договорной работы и защита бизнеса в спорах с контрагентами. 📞 +7 (4742) 20-15-25.',

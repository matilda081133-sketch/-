...
export const metadata: Metadata = {
  ...
  description: 'Комплексное представление интересов кредитора в банкротстве компании: стратегия участия, собрания кредиторов, судебные заседания и контроль процедуры. Де-Юре, Липецк. 📞 +7 (4742) 20-15-25.',
  robots: {
    index: true,
    follow: true,
  },

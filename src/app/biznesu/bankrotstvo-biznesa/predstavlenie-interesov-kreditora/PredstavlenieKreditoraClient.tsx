...
export default function PredstavlenieKreditoraClient() {
  const situations = [
    ...
    },
    {
      ...
      desc: 'Оформим статус залогового кредитора, подготовим положение о торгах и добьёмся распределения выручки в предусмотренном законом размере с учётом вида обеспеченного требования и расходов процедуры.'
    },
    {

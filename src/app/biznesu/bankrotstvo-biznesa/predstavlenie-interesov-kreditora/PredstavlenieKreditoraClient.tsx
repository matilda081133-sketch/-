  ...
  return (
    <>
      ...
      <SpecialistBlock
        ...
        position="Специалист по арбитражным процессам и защите прав кредиторов, куратор направления"
        imageUrl="/images/nacheshnikov.jpg"
        ...
        description={[
          <span key="1" style={{ color: 'var(--color-deep-blue)', display: 'block' }}>
            Главная ошибка кредитора в банкротстве — заявить требования и пассивно ждать распределения средств. Без инициативы кредиторов конкурсная масса быстро растворяется в расходах управляющего.
          </span>,
          <span key="2" style={{ color: 'var(--color-deep-blue)', display: 'block', marginTop: '12px' }}>
            Владимир Викторович разрабатывает наступательную стратегию: отсекает фиктивные долги аффилированных лиц, оспаривает вывод активов должника и привлекает бенефициаров к субсидиарной ответственности.
          </span>
        ]}
        buttonText="Обсудить дело с куратором"
        buttonHref="#form"
      />

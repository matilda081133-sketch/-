  ...
  return (
    <>
      ...
      <SpecialistBlock
        ...
        position="Специалист по надзору за банкротными процедурами, куратор направления"
        imageUrl="/images/nacheshnikov.jpg"
        ...
        description={[
          <span key="1" style={{ color: 'var(--color-deep-blue)', display: 'block' }}>
            Жалоба на арбитражного управляющего — это не жалоба в госорган, а жесткий процессуальный спор в арбитражном суде. Судья требует исчерпывающих доказательств прямого нарушения прав заявителя.
          </span>,
          <span key="2" style={{ color: 'var(--color-deep-blue)', display: 'block', marginTop: '12px' }}>
            Владимир Викторович лично формирует доказательственную базу нарушений, пресекает незаконные торги через принятие обеспечительных мер и добивается реального взыскания убытков с недобросовестных управляющих.
          </span>
        ]}
        buttonText="Обсудить нарушения АУ с куратором"
        buttonHref="#form"
      />

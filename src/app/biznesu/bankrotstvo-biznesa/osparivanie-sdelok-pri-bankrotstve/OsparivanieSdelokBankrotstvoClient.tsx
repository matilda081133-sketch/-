  ...
  return (
    <>
          ...
          <div style={{
            ...
            <div style={{ maxWidth: '680px' }}>
              <strong style={{ display: 'block', fontSize: '16px', color: '#FFFFFF', marginBottom: '4px' }}>
                Банкротство продавца не означает автоматической недействительности ранее совершенных договоров
              </strong>
      ...
      <SpecialistBlock
        ...
        position="Специалист по банкротным спорам и оспариванию сделок, куратор направления"
        imageUrl="/images/nacheshnikov.jpg"
        ...
        description={[
          <span key="1" style={{ color: 'var(--color-deep-blue)', display: 'block' }}>
            Обособленные споры по сделкам требуют не просто юридического анализа договоров, но глубокой экономической экспертизы рыночности условий и платежеспособности должника на дату операции.
          </span>,
          <span key="2" style={{ color: 'var(--color-deep-blue)', display: 'block', marginTop: '12px' }}>
            Владимир Викторович лично руководит проведением независимой оценки, формирует контрдоводы против претензий управляющего и представляет интересы сторон в Арбитражном суде Липецкой области.
          </span>
        ]}

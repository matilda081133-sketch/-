      ...
      <section className="section" id="urgent" style={{ background: 'var(--color-deep-blue)', color: '#FFFFFF', padding: '80px 0' }}>
        <div className="container">
          ...
          <div style={{
            ...
            <strong style={{ color: '#FFFFFF' }}>Важно:</strong> Субсидиарная ответственность, установленная судом, как правило, не прекращается после личного банкротства гражданина. Возможность освобождения от конкретного обязательства зависит от основания ответственности и обстоятельств дела. Попытки вывести имущество, переписать доли или изменить документы задним числом создают риск экспертизы и уголовно-правовые последствия. Законный путь защиты — доказывание добросовестности и обоснованности решений в арбитражном суде.
          </div>

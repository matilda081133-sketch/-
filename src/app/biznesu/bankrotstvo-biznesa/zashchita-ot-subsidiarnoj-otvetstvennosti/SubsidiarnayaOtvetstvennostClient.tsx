  ...
  return (
    <>
      ...
      <SpecialistBlock
        ...
        position="Специалист по защите контролирующих лиц в арбитражных спорах, куратор направления"
        imageUrl="/images/nacheshnikov.jpg"
        ...
        description={[
          <span key="1" style={{ color: 'var(--color-deep-blue)', display: 'block' }}>
            Субсидиарная ответственность — сложнейшая категория арбитражных дел. Здесь стандартных шаблонов не существует: требуется детальный экономический анализ кризиса предприятия.
          </span>,
          <span key="2" style={{ color: 'var(--color-deep-blue)', display: 'block', marginTop: '12px' }}>
            Владимир Викторович лично руководит подготовкой отзывов, восстанавливает первичные доказательства разумности действий руководства и отстаивает интересы доверителей во всех инстанциях.
          </span>
        ]}

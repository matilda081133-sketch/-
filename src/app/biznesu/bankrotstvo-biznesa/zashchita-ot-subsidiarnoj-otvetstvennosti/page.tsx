...
export const metadata: Metadata = {
  ...
  description: 'Проверим основания привлечения к субсидиарной ответственности, соберём доказательства и представим директора, собственника или иное КДЛ в суде. Де-Юре, Липецк. 📞 +7 (4742) 20-15-25.',
  robots: {
    index: true,
    follow: true,
  },

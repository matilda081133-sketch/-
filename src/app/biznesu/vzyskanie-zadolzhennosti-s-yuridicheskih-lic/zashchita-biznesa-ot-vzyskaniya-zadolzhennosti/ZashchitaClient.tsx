...
export default function ZashchitaClient() {
  ...
  const situations = [
    ...
    {
      tag: 'Суд / Иск',
      title: 'Иск уже подан в арбитражный суд',
    ...
    {
      tag: 'Блокировка',
      title: 'Арестованы банковские счета компании',
    ...
    {
      tag: 'Ст. 333 ГК РФ',
      title: 'Несоразмерные штрафы и неустойка',
    ...
    {
      tag: 'Встречный иск',
      title: 'Есть встречные претензии к кредитору',
    ...
    {
      tag: 'Урегулирование',
      title: 'Необходима рассрочка или мировое соглашение',
  ...
  const urgentItems = [
    {
      title: 'Срок на подачу отзыва на иск истекает',
    ...
    {
      title: 'Наложен арест на расчётные счета компании',
    ...
    {
      title: 'Кредитор подал публикацию на Федресурс о банкротстве',
  ...
  const routes = [
    {
      tag: 'Претензия',
      title: 'Досудебный контррасчёт и переговоры',
    ...
    {
      tag: 'Арбитраж',
      title: 'Судебная защита и встречный иск',
    ...
    {
      tag: 'Рассрочка',
      title: 'Мировое соглашение и судебная рассрочка',
  ...
  const cases: CaseData[] = [
    {
      category: 'Поставка / Снижение требований на 1,6 млн ₽',
    ...
    {
      category: 'Подряд / Ст. 333 ГК РФ / Снижение на 1,75 млн ₽',
    ...
    {
      category: 'Урегулирование / Мировое соглашение на 5,6 млн ₽',
      ...
      <MilitaryHero
        ...
        superTitle={
          <span style={{ whiteSpace: 'normal', display: 'inline-block', lineHeight: 1.4 }}>
            <span style={{ display: 'inline-block' }}>Защита бизнеса от взыскания •</span> <br />
        ...
        <div className="container">
          <div style={{ maxWidth: '780px', marginBottom: '48px', textAlign: 'left' }}>
            <h2 className="with-accent" style={{ fontFamily: 'var(--font-serif)', fontSize: 'clamp(28px, 4vw, 42px)', color: 'var(--color-deep-blue)', marginBottom: '16px', marginTop: 0, lineHeight: 1.2, textAlign: 'left' }}>
              <span style={{ display: 'inline-block' }}>В какой ситуации</span> <br /><span style={{ display: 'inline-block' }}>вам нужна защита</span>
            </h2>

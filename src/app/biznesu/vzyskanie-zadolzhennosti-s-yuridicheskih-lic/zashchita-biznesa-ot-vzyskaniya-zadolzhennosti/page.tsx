...
export const metadata: Metadata = {
  ...
  description: 'Проверим требования кредитора, расчёт долга и доказательства, подготовим ответ на претензию или отзыв на иск, представим интересы бизнеса в суде. 📞 +7 (4742) 20-15-25.',
  robots: {
    index: true,
    follow: true,
  },

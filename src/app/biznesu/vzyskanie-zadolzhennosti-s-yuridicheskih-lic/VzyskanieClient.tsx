...
export default function VzyskanieClient() {
  ...
  const urgentItems = [
    ...
    },
    {
      ...
      desc: 'Сообщение о ликвидации или намерении обратиться с заявлением о банкротстве требует проверить срок и порядок предъявления требований: ликвидационной комиссии либо в деле о банкротстве.'
    },
    {
    ...
    const routes: { tag: string; title: React.ReactNode; desc: string; route: string }[] = [
    {
      ...
      title: (
        <span>
          <span style={{ display: 'inline-block' }}>Долг подтверждён, должник</span> <br />
          <span style={{ display: 'inline-block' }}>работает</span>
        </span>
      ),
    ...
    },
    {
      ...
      title: (
        <span>
          <span style={{ display: 'inline-block' }}>Должник признаёт долг, но</span> <br />
          <span style={{ display: 'inline-block' }}>просит время</span>
        </span>
      ),
    ...
    },
    {
      ...
      title: (
        <span>
          <span style={{ display: 'inline-block' }}>Есть спор об исполнении</span> <br />
          <span style={{ display: 'inline-block' }}>обязательств</span>
        </span>
      ),
  ...
  const stages: { num: string; stage: React.ReactNode; works: React.ReactNode; label?: string; result: string }[] = [
    ...
    {
      num: '04',
      stage: <>Исполнение<br />решения суда</>,
      works: 'Получаем исполнительный лист, определяем оптимальный порядок предъявления (в банк должника либо в ФССП) и контролируем фактическое поступление средств.',
  ...
  const claims: { tag: string; title: React.ReactNode; desc: string }[] = [
    {
      tag: 'Поставка',
      title: <>Неоплата<br />поставленного товара</>,
      desc: 'Договоры поставки, разовые отгрузки по счетам-договорам, товарным накладным и УПД.'
    },
    {
      tag: 'Подряд',
      title: <>Долги по договорам<br />подряда и субподряда</>,
    ...
    {
      tag: 'Санкции',
      title: <>Договорная неустойка<br />и проценты</>,
  ...
  return (
    <main style={{ position: 'relative', overflowX: 'hidden' }}>
      ...
      <MilitaryHero
        ...
        superTitle={
          <span style={{ whiteSpace: 'normal', display: 'inline-block', lineHeight: 1.4 }}>
            <span style={{ display: 'inline-block' }}>Взыскание задолженности для бизнеса •</span> <br />
        ...
        <div className="container">
          <div style={{ maxWidth: '820px', marginBottom: '48px', textAlign: 'left' }}>
            ...
            <h2 className="with-accent" style={{ fontSize: 'clamp(28px, 4vw, 42px)', fontFamily: 'var(--font-serif)', color: 'var(--color-deep-blue)', marginBottom: '16px', marginTop: 0, lineHeight: 1.2 }}>
              <span style={{ display: 'inline-block' }}>Не каждый долг нужно</span> <br />
              <span style={{ display: 'inline-block' }}>взыскивать одинаково</span>
            </h2>
            <p style={{ fontSize: '16px', color: 'var(--color-text-secondary)', fontWeight: 400, lineHeight: 1.6, margin: 0, textAlign: 'left', textWrap: 'balance' }}>
      ...
      {/* ═══ БЛОК 7: С КАКИМИ ДЕНЕЖНЫМИ ТРЕБОВАНИЯМИ РАБОТАЕМ (ШАБЛОН «МОДЕЛЬ РАБОТЫ») ═══ */}
          ...
          <div className="grid grid-2" style={{ gap: '48px', alignItems: 'center' }}>
            <div>
              ...
              <h2 className="with-accent" style={{ fontSize: 'clamp(26px, 3.5vw, 36px)', fontFamily: 'var(--font-serif)', color: 'var(--color-primary)', marginBottom: '16px', marginTop: 0, lineHeight: 1.25 }}>
                <span style={{ display: 'inline-block' }}>Обсудить взыскание</span> <br />
                <span style={{ display: 'inline-block' }}>долга в офисе</span>
              </h2>

...
export const metadata: Metadata = {
  ...
  description: 'Проверим долг и финансовое состояние должника, проведём претензионную работу, представим интересы в суде и согласуем действия до фактического взыскания. 📞 +7 (4742) 20-15-25.',
  robots: {
    index: true,
    follow: true,
  },
      ...
      },
      {
        ...
        'mainEntity': [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Да. Объём работы зависит от исполнительного документа и текущей стадии. Если основная задача связана с действиями банка, приставов или розыском имущества должника, её передаём в направление «Исполнительное производство для бизнеса».'
            }
          },
          {
            '@type': 'Question',

...
export const metadata: Metadata = {
  ...
  description:
    'Юридическое сопровождение строительства и реконструкции для бизнеса в Липецке: аудит проекта, договоры, проектная документация, разрешение, контроль изменений, ввод и регистрация объекта.',
  alternates: {

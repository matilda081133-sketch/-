...
export const metadata: Metadata = {
  ...
  description: 'Юридическая помощь бизнесу по коммерческой недвижимости, земле и строительству в Липецке: сделки, аренда, сопровождение проектов и строительные споры. 📞 +7 (4742) 20-15-25.',
  alternates: {

  ...
  return (
    <main>
      ...
      <PricingBlock
        ...
        subtitle="Прозрачные тарифы. Судебные расходы могут быть взысканы с другой стороны в порядке и размере, определённых судом. При частичном удовлетворении требований расходы распределяются пропорционально."
        tiers={pricingTiers}
      />

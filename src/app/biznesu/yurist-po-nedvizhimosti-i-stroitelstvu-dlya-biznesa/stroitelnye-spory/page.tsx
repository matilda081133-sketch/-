...
export const metadata: Metadata = {
  ...
  description:
    'Юрист по строительным спорам в Липецке: неоплата и приёмка работ, КС-2/КС-3, недостатки, сроки, неустойка, возврат аванса, экспертиза, претензия и арбитражный суд.',
  alternates: {

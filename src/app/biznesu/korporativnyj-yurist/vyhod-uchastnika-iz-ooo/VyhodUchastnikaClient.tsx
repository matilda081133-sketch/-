...
export default function VyhodUchastnikaClient() {
  const situations = [
    ...
    },
    {
      ...
      desc: 'Оформляем выход и контролируем внесение записи в ЕГРЮЛ. Выход прекращает корпоративные права участника, но сам по себе не освобождает бывшего руководителя или контролирующее лицо от ответственности за действия, совершённые до выхода. Выход из ООО не является способом автоматического снятия субсидиарной или иной ответственности.'
    },
    {

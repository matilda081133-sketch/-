...
export default function VzyskanieStoimostiDoliClient() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'Бухгалтерский баланс учитывает основные средства по остаточной стоимости с учётом амортизации, а недвижимость и землю — по исторической стоимости приобретения. По общему правилу расчёт производится по данным бухгалтерской отчётности общества. Согласно механизму, действующему с 28 декабря 2025 года, если общество или вышедший участник не согласны с таким расчётом, до окончания установленного срока выплаты можно заявить об определении стоимости чистых активов с учётом рыночной стоимости активов и обязательств. При возникновении спора размер выплаты может подтверждаться независимой оценкой и судебной экспертизой.'
    },
    {
      q: 'Какой срок исковой давности по спорам о выплате действительной стоимости доли?',
      a: 'Срок исковой давности составляет 3 года со дня, когда общество должно было выплатить действительную стоимость доли (по общему правилу — по истечении 3 месяцев со дня выхода участника). Определением ВС РФ № 305-ЭС23-28956 подтверждено: удержание не может продолжаться бессрочно и прекращается, если кредитор в разумный срок не обратился в суд.'
    },
    {
      q: 'Можно ли взыскать проценты за задержку выплаты стоимости доли?',
      a: 'Да. За весь период просрочки выплаты подлежат начислению и взысканию проценты за пользование чужими денежными средствами по ст. 395 ГК РФ по ключевой ставке Банка России. При этом общество вправе ходатайствовать о снижении суммы по ст. 333 ГК РФ при доказанности её явной несоразмерности.'
    }
  ];
      ...
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
                    "@type": "ListItem",
                    "position": 4,
                    "name": "Взыскание действительной стоимости доли",
      ...
      <MilitaryHero
        breadcrumbs={
          <>
            ...
            <span style={{ margin: '0 8px', opacity: 0.5 }}>/</span>
            <span style={{ color: 'var(--color-text-main)' }}>Взыскание действительной стоимости доли</span>
          </>
        }
        superTitle={

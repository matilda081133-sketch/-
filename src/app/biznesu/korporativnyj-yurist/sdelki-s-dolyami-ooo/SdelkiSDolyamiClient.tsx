...
export default function SdelkiSDolyamiClient() {
  ...
  return (
    <>
        ...
        <div className="container">
          <div className="text-center" style={{ maxWidth: '800px', margin: '0 auto 50px auto' }}>
            <h2 className="section-title" style={{ marginBottom: '16px' }}>
              Какие сделки с долями ООО мы сопровождаем
            </h2>
            <p className="section-subtitle" style={{ color: 'var(--color-text-secondary)', margin: '0 auto' }}>
              Обеспечиваем полную юридическую чистоту при любом формате передачи прав на долю в компании.
            </p>
          </div>
      ...
      {/* ═══ БЛОК 5: КЕЙСЫ ═══ */}
      <CasesBlock
        title="Примеры сопровождения сделок с долями"
        cases={practiceCases}
      ...
      <section className="section bg-light" id="process">
        <div className="container">
          <div className="text-center" style={{ maxWidth: '800px', margin: '0 auto 50px auto' }}>
            <h2 className="section-title" style={{ marginBottom: '16px' }}>
              Порядок сопровождения сделки с долей
            </h2>
            <p className="section-subtitle" style={{ color: 'var(--color-text-secondary)', margin: '0 auto' }}>
              Четкая и быстрая процедура от предварительного аудита до получения выписки ЕГРЮЛ.
            </p>
          </div>
            ...
            >
              <div>
                <h3 style={{ color: 'var(--color-white)', fontSize: '22px', marginBottom: '8px' }}>
                  Планируете продажу, покупку или дарение доли ООО?
                </h3>
                <p style={{ color: 'rgba(255, 255, 255, 0.8)', fontSize: '15px', margin: 0 }}>
                  Проверим устав на ограничения и организуем сделку у нотариуса без очередей и рисков.
                </p>
              </div>
      ...
      <section className="section bg-light">
        <div className="container">
          <div className="text-center" style={{ maxWidth: '800px', margin: '0 auto 40px auto' }}>
            ...
            <p className="section-subtitle" style={{ color: 'var(--color-text-secondary)', margin: '0 auto' }}>
              Юридические услуги для участников и руководителей ООО в Липецке.
            </p>
          </div>
      ...
      <ContactsForm
        title="Проверьте сделку до обращения к нотариусу"
        subtitle="Оставьте заявку на подготовку документов. Проверим устав, подготовим договор и организуем сделку под ключ."
        hiddenFields={[{ name: 'service', value: 'Сделки с долями ООО' }]}
      />

...
export default function KorporativnyeSporyClient() {
  const situations = [
    ...
    },
    {
      ...
      desc: 'Личный конфликт или равные доли (50/50) не являются достаточным основанием сами по себе: необходимо доказать, что действия конкретного участника причиняют существенный вред обществу либо систематически блокируют его работу.'
    }
  ];
  ...
  const helpBlocks = [
    ...
    {
      title: <><span style={{ display: 'inline-block' }}>Оспаривание решений</span> <br /><span style={{ display: 'inline-block' }}>и сделок общества</span></>,
      desc: 'Признаём недействительными решения органов общества и спорные сделки: по общим основаниям ст. 170 ГК РФ (мнимость, притворность) и специальным нормам ст. 61.2, 61.3 Закона о банкротстве.'
    },
    {

...
export default function SoprovozhdenieSokrashcheniyaClient() {
  ...
  {
    "q": "Кого нельзя увольнять по сокращению?",
    "a": "Перечень зависит от статуса работника. В частности, по сокращению нельзя увольнять беременную женщину, женщину с ребёнком до трёх лет, одинокую мать или иного одинокого родителя, воспитывающего ребёнка до 16 лет либо ребёнка-инвалида до 18 лет, а также другие категории, указанные в статье 261 ТК РФ. Увольнение по инициативе работодателя во время отпуска или временной нетрудоспособности также запрещено, кроме прямо установленных исключений. Статус и документы каждого работника нужно проверять отдельно."
  },
  {
      ...
      <MilitaryHero
        ...
        subtitle={
          <span style={{ display: 'inline-block', maxWidth: '750px', textWrap: 'balance' }}>
            Проверим риски до начала процедуры, подготовим документы и уведомления, проконтролируем вакансии, гарантии и выплаты, а при оспаривании защитим позицию работодателя.
          </span>
        }
        ...
        <div className="container">
          <div style={{ maxWidth: '780px', marginBottom: '48px', textAlign: 'left' }}>
            ...
            <p style={{ fontSize: '16px', color: 'var(--color-text-secondary)', fontWeight: 400, lineHeight: 1.6, margin: 0, textAlign: 'left', textWrap: 'balance' }}>
              Безопаснее подключить юриста до утверждения нового штатного расписания и вручения уведомлений. Но мы можем вступить в работу и после начала процедуры, чтобы проверить уже совершённые действия и снизить оставшиеся риски.
            </p>
          </div>

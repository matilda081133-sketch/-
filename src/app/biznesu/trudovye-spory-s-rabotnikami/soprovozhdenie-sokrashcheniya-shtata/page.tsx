...
export const metadata: Metadata = {
  ...
  description: "Помогаем работодателям провести сокращение штата по закону: оцениваем процедуру, готовим документы, уведомления и защищаем при оспаривании. ЮК «Де-Юре». 📞 +7 (4742) 20-15-25.",
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    ...
    description: "Правовая проверка процедуры, категорий работников, вакансий, уведомлений и выплат при сокращении численности или штата. 📞 +7 (4742) 20-15-25.",

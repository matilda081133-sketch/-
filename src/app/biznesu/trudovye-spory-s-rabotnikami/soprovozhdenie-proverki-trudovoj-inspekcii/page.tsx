...
export const metadata: Metadata = {
  ...
  description: "Помогаем работодателям при проверках ГИТ: оцениваем риски, готовим документы и объяснения, сопровождаем инспекцию и обжалуем штрафы. ЮК «Де-Юре». 📞 +7 (4742) 20-15-25.",
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    ...
    description: "Анализ запроса и рисков, подготовка документов и объяснений, взаимодействие с инспекцией труда, обжалование предписаний и штрафов. 📞 +7 (4742) 20-15-25.",

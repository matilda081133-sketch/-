...
export default function SoprovozhdenieProverkiGitClient() {
  ...
  const faqs = [
  {
    "q": "Когда нужно обращаться к юристу?",
    "a": "Сразу после получения любого документа ГИТ или сведений о назначенном мероприятии. Важно зафиксировать дату получения и не пропустить указанный срок. Чем раньше начата проверка материалов, тем меньше риск противоречивых ответов и неполного комплекта документов."
  },
  {
    "q": "Какие документы направить для первичной оценки?",
    "a": "Сам документ ГИТ со всеми приложениями и сведениями о способе и дате получения. Дополнительный комплект зависит от предмета: юрист запросит только необходимые кадровые, расчётные и локальные документы."
  },
  {
    "q": "В какой срок можно обжаловать предписание трудовой инспекции?",
    "a": "Жалоба на предписание контрольного органа по статье 40 Закона № 248-ФЗ подаётся в течение 10 рабочих дней с момента его получения; для иных решений и действий действует общий срок 30 календарных дней с момента, когда компания узнала или должна была узнать о нарушении своих прав. Судебный маршрут и необходимость обязательного досудебного обжалования нужно определять по конкретному документу и статусу заявителя."
  },
  {
  ...
  {
    "q": "Юрист может присутствовать при проверке?",
    "a": "Формат участия зависит от вида мероприятия и согласованного объёма помощи. Юрист может подготовить представителей работодателя, сопровождать передачу документов и участвовать во взаимодействии с инспекцией, когда это допустимо и необходимо."
  }
];
        ...
        <div className="container">
          <div style={{ maxWidth: '780px', marginBottom: '48px', textAlign: 'left' }}>
            ...
            <p style={{ fontSize: '16px', color: 'var(--color-text-secondary)', fontWeight: 400, lineHeight: 1.6, margin: 0, textAlign: 'left', textWrap: 'balance' }}>
              Передайте юристу документ ГИТ сразу после получения: вид мероприятия, предмет контроля и срок ответа определяют, какие действия нужны в первую очередь.
            </p>
          </div>
          ...
          <div style={{
            ...
            <p style={{ margin: '0 0 28px 0', fontSize: '15px', color: 'rgba(255, 255, 255, 0.85)', lineHeight: 1.6, maxWidth: '820px' }}>
              Анализируем законность требований инспекции, выстраиваем доказательную позицию работодателя и проверяем обязательные точки контроля:
            </p>

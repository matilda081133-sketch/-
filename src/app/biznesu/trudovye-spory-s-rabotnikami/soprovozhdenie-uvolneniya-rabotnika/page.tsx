...
export const metadata: Metadata = {
  ...
  description: "Помогаем работодателям законно уволить работника: оцениваем основание и риски, готовим документы, сопровождаем переговоры и защищаем в споре. ЮК «Де-Юре». 📞 +7 (4742) 20-15-25.",
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    ...
    description: "Проверим основание и документы, поможем провести сложное увольнение и защитить позицию работодателя при оспаривании. 📞 +7 (4742) 20-15-25.",

  ...
  },
  {
    "text": "Куратор — Марина Валерьевна Смольянинова"
      ...
      />
            ...
            {/* ═══ БЛОК: КОГДА РАБОТОДАТЕЛЮ СТОИТ ПОДКЛЮЧИТЬ ЮРИСТА (СИТУАЦИИ) ═══ */}
        ...
        <div className="container">
          <div style={{ maxWidth: '820px', marginBottom: '48px', textAlign: 'left' }}>
            ...
            <h2 className="with-accent" style={{
              ...
              <span style={{ display: 'inline-block' }}>Когда работодателю стоит</span> <br />
              <span style={{ display: 'inline-block' }}>подключить трудового юриста</span>
            </h2>
            <p style={{
              fontSize: '16px',
              ...
              Подключаемся на любой стадии: от подготовки кадрового решения до конфликта, проверки или судебного спора.
            </p>
          </div>
          ...
          <div className="grid grid-3" style={{ gap: '24px' }}>
            {situations.map((sit, idx) => (
              ...
              >
                ...
                >
                  <span>Защитить интересы компании</span>

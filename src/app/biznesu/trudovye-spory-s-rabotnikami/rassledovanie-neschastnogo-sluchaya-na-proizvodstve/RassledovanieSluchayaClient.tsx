    ...
    },
    {
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Акт Н-1 утверждает работодатель (его представитель) и при наличии заверяет печатью. Один экземпляр в течение трёх календарных дней после завершения расследования выдают пострадавшему, а при смертельном случае — лицам, состоявшим на иждивении, либо близким родственникам по их требованию. Второй экземпляр хранится у работодателя 45 лет."
          }
        }
      ]
    }

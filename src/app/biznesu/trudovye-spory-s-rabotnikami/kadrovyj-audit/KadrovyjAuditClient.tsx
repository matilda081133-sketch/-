...
export default function KadrovyjAuditClient() {
  ...
  {
    "q": "Как обеспечивается конфиденциальность информации?",
    "a": "До начала работы согласуем состав документов и защищённый способ передачи. Обязанности по конфиденциальности фиксируются в договоре; отдельное соглашение о неразглашении можно заключить по соглашению сторон."
  },
  {
    "q": "Сколько времени занимает проведение кадрового аудита?",
    "a": "Срок зависит от численности компании, периода проверки, объёма документов, выбранного участка и необходимости интервью с ответственными сотрудниками. Срок фиксируется после первичной оценки задачи и согласования состава аудита."
  },
  {
    "q": "Какие документы потребуются для кадрового аудита?",
    "a": "Перечень зависит от цели, структуры и деятельности компании. Обычно сначала нужны организационные сведения, локальные акты и выборка кадровых документов. Не следует отправлять полный архив до согласования состава и защищённого способа передачи."
  },
  {
      ...
      <MilitaryHero
        ...
        subtitle={
          <span style={{ display: 'inline-block', maxWidth: '750px', textWrap: 'balance' }}>
            Проверим кадровые документы и трудовые процессы, выявим юридические риски, расставим их по приоритету и подготовим понятный план исправлений.
          </span>
        }

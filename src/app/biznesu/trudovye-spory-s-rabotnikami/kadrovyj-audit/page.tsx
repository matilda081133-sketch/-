...
export const metadata: Metadata = {
  ...
  description: "Проводим независимый кадровый аудит для работодателей: выявляем нарушения в договорах и локальных актах, оцениваем риски и даём рекомендации. ЮК «Де-Юре». 📞 +7 (4742) 20-15-25.",
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "Кадровый аудит организации в Липецке | Де-Юре",
    description: "Проверка трудовых договоров, локальных актов и кадровых процедур с перечнем рисков и рекомендациями по устранению нарушений. 📞 +7 (4742) 20-15-25.",

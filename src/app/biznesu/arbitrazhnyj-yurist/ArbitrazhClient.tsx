...
export default function ArbitrazhClient() {
        ...
        'mainEntity': [
                    {
                              ...
                              "acceptedAnswer": {
                                        "@type": "Answer",
                                        "text": "С экономическими спорами, связанными с деятельностью компаний и предпринимателей: договорными, долговыми, корпоративными, налоговыми, строительными и другими делами, отнесёнными к компетенции арбитражных судов. Предметные категории подробно раскрываются в соответствующих разделах сайта."
                              }
                    },
                    {
                              "@type": "Question",
                              ...
                              "acceptedAnswer": {
                                        "@type": "Answer",
                                        "text": "Да. До обращения в суд можно проверить требования, договор и доказательства, обязательный досудебный порядок, подсудность и возможные процессуальные риски. После анализа станет понятно, требуется ли иск или возможен другой способ урегулирования."
                              }
                    },
                    {
                              "@type": "Question",
                              ...
                              "acceptedAnswer": {
                                        "@type": "Answer",
                                        "text": "Да. Состав работы зависит от роли. Для истца обычно проверяются требования и доказательства перед обращением в суд. Для ответчика работа начинается с анализа иска, приложений, определения суда и ближайших процессуальных дат."
                              }
                    },
                    {
                              "@type": "Question",
                              ...
                              "acceptedAnswer": {
                                        "@type": "Answer",
                                        "text": "Можно передать материалы на анализ на любой стадии. Юрист проверит, какие действия уже совершены, какие документы находятся в деле и что ещё возможно сделать с учётом текущей процессуальной ситуации."
                              }
                    },
                    {
                              "@type": "Question",
                              ...
                              "acceptedAnswer": {
                                        "@type": "Answer",
                                        "text": "Обычно нужны договор и приложения, документы об исполнении, претензии и ответы, деловая переписка, расчёты, а по начавшемуся делу — иск, определения, отзывы, решения и другие судебные материалы. Окончательный перечень определяется после уточнения задачи."
                              }
                    },
                    {
                              "@type": "Question",
                              "name": "Можно ли поручить только подготовку отдельного документа?",
                              "acceptedAnswer": {
                                        "@type": "Answer",
                                        "text": "Да, если отдельная работа имеет смысл в конкретной ситуации. До подготовки иска, отзыва, ходатайства или жалобы юрист изучит достаточный объём материалов и поймет процессуальную задачу документа."
                              }
                    },
                    {
                              "@type": "Question",
                              ...
                              "acceptedAnswer": {
                                        "@type": "Answer",
                                        "text": "Да. Можно согласовать отдельную роль внешнего специалиста: анализ позиции, подготовку процессуальных документов, участие в заседаниях, второе мнение или комплексное ведение дела."
                              }
                    },
                    {
                              "@type": "Question",
                              ...
                              "acceptedAnswer": {
                                        "@type": "Answer",
                                        "text": "Значительную часть анализа, подготовки документов и коммуникации можно организовать дистанционно через систему «Мой Арбитр» и онлайн-заседания. Необходимость личного участия зависит от суда, стадии и согласованного объёма работы."
                              }
                    },
                    {
                              "@type": "Question",
                              ...
                              "acceptedAnswer": {
                                        "@type": "Answer",
                                        "text": "Единого срока нет. Продолжительность зависит от категории и сложности спора, количества участников, объёма доказательств, экспертизы, процессуального поведения сторон и обжалования."
                              }
                    },
                    {
                              "@type": "Question",
                              ...
                              "acceptedAnswer": {
                                        "@type": "Answer",
                                        "text": "От объёма материалов, предмета и цены спора, текущей стадии, количества требований и участников, числа заседаний, необходимости экспертизы и командировок. Стоимость этапа фиксируется в договоре до начала работы."
                              }
                    },
                    {
                              "@type": "Question",
                              "name": "Можно ли взыскать расходы на юриста с оппонента?",
                              "acceptedAnswer": {
                                        "@type": "Answer",
                                        "text": "Заявление о судебных расходах подаётся после вынесения решения в пользу доверителя. Суд взыскивает расходы на представителя с проигравшей стороны с учётом принципа разумности."
                              }
                    },
                    {
                              "@type": "Question",
                              "name": "Какой результат вы ставите целью по арбитражному делу?",
                              "acceptedAnswer": {
                                        "@type": "Answer",
                                        "text": "После анализа материалов определяем достижимую цель: взыскать долг, отбить необоснованные требования, снизить сумму взыскания, сохранить актив или отменить неблагоприятный судебный акт. Выстраиваем позицию и процессуальные действия так, чтобы добиться этого результата с учётом доказательств и стадии дела."
                              }
                    }
          ]
      }
  ...
  const faqs = [
    ...
    {
      q: 'Какой результат вы ставите целью по арбитражному делу?',
      a: 'После анализа материалов определяем достижимую цель: взыскать долг, отбить необоснованные требования, снизить сумму взыскания, сохранить актив или отменить неблагоприятный судебный акт. Выстраиваем позицию и процессуальные действия так, чтобы добиться этого результата с учётом доказательств и стадии дела.'
    }
  ];
        ...
        <div className="container">
          <div style={{ maxWidth: '1000px', marginBottom: '36px' }}>
            ...
            <p style={{ color: 'rgba(255,255,255,0.85)', fontSize: '16px', marginBottom: '40px', maxWidth: '720px', lineHeight: 1.6 }}>
              Пропуск процессуального срока может ограничить возможность представить доказательства или обжаловать судебный акт. Проверим ближайшие даты и определим, какие действия нужно выполнить сейчас.
            </p>
          </div>
          ...
          <div style={{
            ...
            <div className="stages-header-row" style={{
              ...
              <div className="stages-subtitle-right" style={{
                ...
                Определяем правовую позицию: проверяем основания требований и возражений, доказательства, необходимые ходатайства и порядок дальнейшей защиты.
              </div>
            </div>

...
export default function ArbitrazhClient() {
  ...
  const cases: CaseData[] = [
    {
      category: (
        <>
          Строительный подряд •<br />АС Липецкой области
        </>
      ),
    ...
    },
    {
      category: (
        <>
          Апелляционное обжалование •<br />19 ААС Воронеж
        </>
      ),
  ...
  return (
    <main style={{ position: 'relative', overflowX: 'hidden' }}>
              ...
              >
                ...
                <div style={{ marginTop: '20px' }}>
                  {item.link.startsWith('/') ? (
                    ...
                    >
                      <span>{item.btnText ? item.btnText.replace(/\s*→$/, '') : 'Подробнее'}</span>
            ...
            <div className="stages-header-row" style={{
              ...
              <div style={{ flex: '1 1 auto', minWidth: '280px' }}>
                <h3 style={{ fontSize: 'clamp(19px, 2.2vw, 24px)', fontFamily: 'var(--font-serif)', color: '#FFFFFF', margin: 0, lineHeight: 1.25 }}>
                  ...
                  <span style={{ display: 'inline-block' }}>и процессуальной защиты</span>
                </h3>
              </div>
              <div className="stages-subtitle-right" style={{
                ...
                <span style={{ display: 'block', color: 'rgba(255, 255, 255, 0.7)' }}>
                  <span style={{ display: 'inline-block' }}>проверка оснований, ходатайства об исключении</span> <br className="hidden-mobile" />
                  <span style={{ display: 'inline-block' }}>доказательств или обжалование.</span>
                </span>
              </div>
            </div>
      ...
      <TeamCarousel
        customSectionLabel="Судебная практика ЮК «Де-Юре»"
        customTitle="Командное ведение арбитражных споров"
        customSubtitle="К ведению арбитражных дел подключаются профильные процессуалисты и отраслевые эксперты с учётом предмета спора: строительные юристы, специалисты по договорному праву, налоговые консультанты и эксперты по банкротству. Состав команды и распределение задач согласуются после первичного аудита материалов."
        filterSlugs={[
          ...
          <div style={{ marginBottom: '36px' }}>
            ...
            <div style={{
              ...
              <h2 className="with-accent" style={{ fontFamily: 'var(--font-serif)', fontSize: 'clamp(24px, 3.5vw, 34px)', color: 'var(--color-deep-blue)', margin: 0, lineHeight: 1.25, flex: '1 1 480px', minWidth: '280px' }}>
                Представительство в арбитражном<br />суде Липецкой области
              </h2>
              <p style={{
                flex: '0 1 440px',
                minWidth: '280px',

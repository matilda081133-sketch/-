...
export default function IskArbitrazhClient() {
        ...
        'mainEntity': [
                    {
                              ...
                              "acceptedAnswer": {
                                        "@type": "Answer",
                                        "text": "Для большинства денежных требований по коммерческим договорам в арбитражном процессе действует обязательный досудебный порядок. Иск может быть подан по истечении 30 календарных дней со дня направления претензии, если иной срок или порядок не установлены законом или договором."
                              }
                    },
                    {
                              "@type": "Question",
                              "name": "Как правильно рассчитать госпошлину в арбитражный суд?",
                              "acceptedAnswer": {
                                        "@type": "Answer",
                                        "text": "Госпошлина рассчитывается от цены иска по прогрессивной шкале, установленной статьёй 333.21 Налогового кодекса РФ. В цену иска входят сумма основного долга, неустойка, штрафы и проценты."
                              }
                    },
                    {
                              "@type": "Question",
                              "name": "В какой арбитражный суд подавать иск?",
                              "acceptedAnswer": {
                                        "@type": "Answer",
                                        "text": "По общему правилу иск подаётся по месту нахождения или жительства ответчика (ст. 35 АПК РФ). Однако стороны могут согласовать в договоре договорную подсудность (например, Арбитражный суд Липецкой области)."
                              }
                    },
                    {
                              "@type": "Question",
                              ...
                              "acceptedAnswer": {
                                        "@type": "Answer",
                                        "text": "Иск можно подать в электронном виде через систему «Мой Арбитр» или на бумаге. До подачи другим участникам направляются копии иска и отсутствующих у них документов способом, позволяющим подтвердить отправку. В суд прикладываются доказательства направления."
                              }
                    },
                    {
                              "@type": "Question",
                              "name": "Что делать, если суд оставил иск без движения?",
                              "acceptedAnswer": {
                                        "@type": "Answer",
                                        "text": "Суд указывает причины в определении (нехватка документа, ошибка в пошлине, отсутствие доказательства направления иска ответчику) и даёт срок на устранение. Юристы оперативно устраняют замечания, чтобы иск был принят к производству."
                              }
                    },
                    {
                              "@type": "Question",
                              "name": "Можно ли взыскать расходы на подготовку иска с ответчика?",
                              "acceptedAnswer": {
                                        "@type": "Answer",
                                        "text": "Да. Расходы на юридические услуги по составлению претензии, иска и сбору доказательств взыскиваются с проигравшей стороны в составе судебных расходов после завершения процесса."
                              }
                    }
          ]
      }
  ...
  const situations = [
    {
      ...
      title: 'Неоплата поставки или услуг',
      desc: 'Контрагент получил товар или принял работы по актам, но задерживает или отказывается перечислять оплату.'
    },
    {
      tag: 'Срыв сроков',
      title: 'Нарушение сроков поставки',
      desc: 'Поставщик или подрядчик сорвал сроки исполнения обязательств. Рассчитаем и взыщем неустойку и штрафы.'
    },
    {
      tag: 'Некачественный товар',
      title: 'Поставка брака или недоделки',
      desc: 'Поставлен некачественный товар или выполнены работы с дефектами. Требуем устранения, замены либо возврата денег.'
    },
    {
      tag: 'Неотработанный аванс',
      title: 'Невозврат аванса при расторжении',
      desc: 'Договор расторгнут в одностороннем порядке, но исполнитель отказывается возвращать неотработанный аванс.'
    },
    {
  ...
  const urgentItems = [
    ...
    },
    {
      title: (
        <span>
          <span style={{ display: 'inline-block' }}>Контрагент начал</span> <br />
          <span style={{ display: 'inline-block' }}>ликвидацию</span>
        </span>
      ),
      desc: 'Проверим запись в ЕГРЮЛ, срок предъявления требований ликвидатору и необходимость обращения в суд. Если введена процедура банкротства, направим в раздел «Банкротство бизнеса».'
    },
    {
      title: (
        <span>
    ...
    },
    {
      ...
      desc: 'Смена директора или участников вместе с прекращением платежей и выводом активов может указывать на рост риска неисполнения будущего решения.'
    },
    {
      title: (
        <span>
  ...
  const stages = [
    ...
    },
    {
      ...
      result: 'Иск зарегистрирован в системе суда; получение определения контролируем и при необходимости устраняем указанные судом недостатки.'
    }
  ];
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'Иск можно подать в электронном виде через систему «Мой Арбитр» или на бумаге. До подачи другим участникам направляются копии иска и отсутствующих у них документов способом, позволяющим подтвердить отправку. В суд прикладываются доказательства направления.'
    },
    {
  ...
  return (
    <main style={{ position: 'relative', overflowX: 'hidden' }}>
      ...
      <MilitaryHero
        ...
        afterTrustContent={
          <p style={{ fontSize: '15px', color: 'var(--color-deep-blue)', opacity: 0.9, margin: '16px 0 24px 0', lineHeight: 1.5, fontWeight: 500, maxWidth: '860px' }}>
        ...
        <div className="container">
          <div style={{ maxWidth: '820px', marginBottom: '48px', textAlign: 'left' }}>
            ...
            <p style={{ fontSize: '16px', color: 'var(--color-deep-blue)', opacity: 0.9, fontWeight: 500, margin: 0, lineHeight: 1.6 }}>
              Проверяем требования АПК РФ, чтобы подать полный комплект документов и снизить риск оставления иска без движения или возврата заявления.
            </p>
          </div>

...
export default function ZashchitaOtvetchikaClient() {
  const jsonLd = {
    ...
    '@graph': [
      ...
      },
      {
        ...
        'description': 'Срочный анализ иска и материалов дела, подготовка мотивированного отзыва, возражения, ходатайства и экспертизы, представление интересов ответчика в арбитражном суде.'
      },
      {
        '@type': 'FAQPage',
  ...
  const urgentItems = [
    {
      title: (
        <span>
          <span style={{ display: 'inline-block' }}>Риск взыскания</span> <br />
          <span style={{ display: 'inline-block' }}>завышенной неустойки</span>
        </span>
      ),
      desc: 'Подготовим мотивированное заявление по статье 333 ГК РФ, контррасчёт и доказательства несоразмерности неустойки последствиям нарушения.'
    },
    {
      title: (
        <span>
      ...
      desc: 'Вступившее в силу решение о взыскании при наличии установленных законом признаков задолженности может стать основанием для обращения кредитора с заявлением о банкротстве после соблюдения предусмотренной процедуры.'
    },
    {
      title: (
        <span>
      ...
      desc: 'При последующем банкротстве действия руководителя могут оцениваться отдельно. Личная ответственность возможна только при наличии специальных оснований и доказательств.'
    }
  ];
  ...
  const stages = [
    ...
    },
    {
      ...
      result: 'Поданы обоснованный встречный иск и необходимые ходатайства; вопрос их принятия и назначения экспертизы разрешает суд'
    },
    {
      num: '04',
    ...
    },
    {
      ...
      works: 'Добиваемся отказа в необоснованных требованиях, снижения суммы взыскания или согласования приемлемых условий мирового соглашения.',
      result: 'Судебный акт либо утверждённое судом мировое соглашение; дальнейшие действия определены по содержанию принятого акта.'
    }
  ];
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'Да, мировое соглашение можно заключить на любой стадии арбитражного процесса. Соглашение утверждает суд. При нарушении его условий взыскатель вправе получить исполнительный лист на принудительное исполнение.'
    },
    {
  ...
  return (
    <main style={{ position: 'relative', overflowX: 'hidden' }}>
      ...
      <MilitaryHero
        ...
        trustItems={[
          { text: 'Срочно проверяем иск и материалы дела.' },
          { text: 'Готовим отзыв, доказательства и ходатайства.' },
        ...
        <div className="container">
          <div style={{ maxWidth: '800px', marginBottom: '36px' }}>
            ...
            <p style={{ color: 'rgba(255,255,255,0.85)', fontSize: '16px', marginBottom: '40px', maxWidth: '720px', lineHeight: 1.6 }}>
              Игнорирование судебных определений повышает риск рассмотрения дела без доказательств и возражений ответчика, а также принятия обеспечительных мер при наличии оснований.
            </p>
          </div>
          ...
          <div className="urgent-bar-row" style={{ borderTop: '1px solid rgba(255,255,255,0.15)', paddingTop: '28px', display: 'flex', alignItems: 'center', gap: '16px', flexWrap: 'nowrap' }}>
            ...
            <a href="#form" className="btn btn-urgent-outline" style={{ padding: '12px 22px', fontSize: '14.5px', whiteSpace: 'nowrap', flexShrink: 0 }}>

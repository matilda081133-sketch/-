...
export default function ZashchitaOtvetchikaClient() {
  ...
  const cases: CaseData[] = [
    ...
    },
    {
      ...
      title: 'Встречный иск подрядчика: отказ истцу и взыскание 3,4 млн ₽',
      problem: 'Заказчик подал иск о взыскании штрафа за срыв сроков строительства на 5,2 млн ₽.',
      action: 'Доказали вину заказчика в непредоставлении стройплощадки и подали встречный иск об оплате выполненных работ.',
      result: 'В иске заказчика отказано полностью. Встречный иск удовлетворён на сумму 3,4 млн ₽.'
    },
    {
  ...
  return (
    <main style={{ position: 'relative', overflowX: 'hidden' }}>
      ...
      {/* ═══ БЛОК 6: КЕЙСЫ ═══ */}
      <CasesBlock
        title="Примеры защиты ответчиков из практики"
          ...
          <div className="grid grid-2" style={{ gap: '48px', alignItems: 'center' }}>
            <div>
              ...
              <p style={{ fontSize: '15.5px', color: 'var(--color-deep-blue)', opacity: 0.9, lineHeight: 1.6, marginBottom: '24px' }}>
                Встретимся в офисе либо проведём срочный экспресс-аудит иска онлайн.
              </p>
        ...
        <div className="container">
          <div className="grid grid-2" style={{ gap: '60px', alignItems: 'stretch' }}>
            <div>
              ...
              <h2 style={{ fontSize: 'clamp(28px, 4vw, 40px)', fontFamily: 'var(--font-serif)', color: 'var(--color-deep-blue)', lineHeight: 1.25, marginBottom: '20px', marginTop: 0 }}>
                Поручите защиту бизнеса судебным юристам
              </h2>
              <p style={{ fontSize: '16px', color: 'var(--color-text-secondary)', lineHeight: 1.6, marginBottom: '32px' }}>
                Укажите номер дела или наименование суда. Срочно перезвоним вам в рабочее время и согласуем план действий.
              </p>
            </div>
            <div style={{ background: '#FFFFFF', border: '1px solid var(--color-border)', boxShadow: '0 12px 40px rgba(23, 50, 77, 0.08)', padding: '40px' }}>
              <ContactsForm hiddenFields={[{ name: 'service', value: 'zashchita-otvetchika-v-arbitrazhe' }]} />
            </div>
          </div>
        </div>
      </section>

...
export default function ZashchitaOtvetchikaClient() {
  ...
  const urgentItems = [
    ...
    },
    {
      title: (
        <span>
          <span style={{ display: 'inline-block' }}>Рассмотрение дела</span> <br />
          <span style={{ display: 'inline-block' }}>без позиции ответчика</span>
        </span>
      ),
      desc: 'Если ответчик не представит отзыв и доказательства, суд вправе рассмотреть дело по имеющимся материалам. Неоспоренные обстоятельства могут быть оценены не в пользу ответчика.'
    },
    {
      title: (
        <span>

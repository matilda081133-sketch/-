    ...
    <header className={`site-header ${isScrolled ? 'scrolled' : ''}`}>
      <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <Link href="/" style={{ display: 'flex', alignItems: 'center', textDecoration: 'none' }}>
          {isScrolled ? (
            <img src="images/logo_ref_1.jpg" alt="Де-Юре" style={{ height: '50px', width: 'auto', mixBlendMode: 'multiply', filter: 'contrast(1.2)' }} />
          ) : (
            <img src="images/logo_ref_1.jpg" alt="Де-Юре" style={{ height: '50px', width: 'auto', mixBlendMode: 'screen', filter: 'invert(1) brightness(1.5) contrast(1.2)' }} />
          )}
        </Link>

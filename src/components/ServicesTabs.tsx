...
export default function ServicesTabs() {
  ...
  const b2cServices = [
    ...
    { title: "Взыскание долгов", desc: "Помощь взыскателю по расписке, договору займа или без расписки: оценка доказательств, досудебная работа, суд и передача решения на исполнение.", href: "/grazhdanam/vzyskanie-dolgov/" }
  ];

...
// We need to inject the shadow into the card. The card might have `className="card"` or `border: '1px solid var(--color-border)'`.
// Let's add it via a style tag injection to ensure ALL cards in CasesBlock get it.
if (!casesCode.includes('.cases-card-custom-shadow')) {
  ...
  if (!casesCode.includes('cases-card-custom-shadow')) {
      // Fallback if classname wasn't matched
...
// 2. ProcessBlock.tsx (Center alignment)
...
// 3. PricingBlock.tsx (Center alignment)
...
// Left align and replace Remote Help block
            ...
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 24px 0', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  <li style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
                    ...
                    <span style={{ fontSize: '16px', color: 'var(--color-text-main)', textAlign: 'left' }}>Провести первичную консультацию</span>
                  </li>
                  <li style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
                    <div style={{ color: 'var(--color-primary)', marginTop: '2px' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg></div>
                    <span style={{ fontSize: '16px', color: 'var(--color-text-main)', textAlign: 'left' }}>Изучить документы</span>
                  </li>
                  <li style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
                    <div style={{ color: 'var(--color-primary)', marginTop: '2px' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg></div>
                    <span style={{ fontSize: '16px', color: 'var(--color-text-main)', textAlign: 'left' }}>Подготовить обращения и жалобы</span>
                  </li>
                  <li style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
                    <div style={{ color: 'var(--color-primary)', marginTop: '2px' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg></div>
                    <span style={{ fontSize: '16px', color: 'var(--color-text-main)', textAlign: 'left' }}>Определить порядок дальнейших действий</span>
                  </li>
              </ul>

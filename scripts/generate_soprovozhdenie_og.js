...
const ogList = [
  {
    fileName: 'yuridicheskoe-soprovozhdenie-biznesa-og.jpg',
    category: 'ЮРИДИЧЕСКИЙ АУТСОРСИНГ • ЛИПЕЦК',
    lines: ['Юридическое сопровождение', 'бизнеса в Липецке'],
    bullets: [
      'Регулярная правовая поддержка компании и усиление юриста',
      'Единое окно для обращений руководителя и подразделений',
      'Договоры, претензии, согласованные сроки и профильные юристы'
    ]
  },
  {
    fileName: 'yuridicheskij-audit-biznesa-og.jpg',
    category: 'ПРАВОВОЙ АУДИТ • ЛИПЕЦК',
    lines: ['Юридический аудит', 'бизнеса в Липецке'],
    bullets: [
      'Комплексная и модульная проверка правовых рисков компании',
      'Анализ договоров, корпоративной структуры, кадров и активов',
      'Письменный отчёт, шкала критичности и план устранения рисков'
    ]
  }
];

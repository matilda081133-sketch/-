...
const item = {
  fileName: 'razblokirovka-raschetnogo-scheta-po-115-fz-og.jpg',
  category: 'БАНКОВСКИЙ КОМПЛАЕНС • ЛИПЕЦК',
  lines: ['Разблокировка расчётного счёта', 'по 115-ФЗ в Липецке'],
  bullets: [
    'Анализ запроса банка, уведомлений и оснований ограничений',
    'Мотивированные пояснения, пакет документов и пересмотр в банке',
    'Обращение в Банк России, МВК и судебное обжалование'
  ]
};

...
const newTitle = `title={<><span style={{ whiteSpace: 'nowrap' }}>Юрист по выплатам</span><br/>за ранение<br/>военнослужащего<br/>в Липецке</>}`;
...
console.log('Successfully updated title to force nowrap');
